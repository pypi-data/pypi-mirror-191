...
from . import common, magic, server
...
os.makedirs(common.utils.APP_TEMP_DIRECTORY, exist_ok=True)
os.makedirs(common.utils.APP_TEMP_DIRECTORY / "dags", exist_ok=True)
os.makedirs(common.utils.APP_TEMP_DIRECTORY / "executors", exist_ok=True)
