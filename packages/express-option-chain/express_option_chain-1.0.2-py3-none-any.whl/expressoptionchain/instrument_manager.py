...
class KiteInstrumentManager:
    ...
    def __init__(self, api_key, access_token, redis_instance):
        KiteInstrumentManager.db = redis_instance
        self.connector = KiteConnector(api_key, access_token)
...
if __name__ == '__main__':
    ...
    instrument_parser = KiteInstrumentManager(secrets['api_key'], secrets['access_token'], redis_instance)
