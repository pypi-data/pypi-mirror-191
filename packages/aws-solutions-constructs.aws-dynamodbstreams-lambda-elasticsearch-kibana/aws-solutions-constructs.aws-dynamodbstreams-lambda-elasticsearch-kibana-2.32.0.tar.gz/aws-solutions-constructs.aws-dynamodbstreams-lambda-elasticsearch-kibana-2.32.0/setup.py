    ...
    """
{
    ...
    "package_data": {
        "aws_solutions_constructs.aws_dynamodbstreams_lambda_elasticsearch_kibana._jsii": [
            "aws-dynamodbstreams-lambda-elasticsearch-kibana@2.32.0.jsii.tgz"
        ],
        "aws_solutions_constructs.aws_dynamodbstreams_lambda_elasticsearch_kibana": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-solutions-constructs.aws-dynamodbstreams-lambda==2.32.0",
        "aws-solutions-constructs.aws-lambda-elasticsearch-kibana==2.32.0",
        "aws-solutions-constructs.core==2.32.0",
