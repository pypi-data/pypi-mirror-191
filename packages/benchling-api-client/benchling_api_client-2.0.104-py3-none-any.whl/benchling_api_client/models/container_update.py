...
class ContainerUpdate:
    ...
    def restricted_sample_party_ids(self) -> List[str]:
        """IDs of users or teams who are restricted sample parties for the container, meaning they have access to use a restricted container. Fixed plate wells and unrestricted containers do not have restricted sample parties."""
