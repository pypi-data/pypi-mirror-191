...
ChatGPT API
    ...
    pip install openai asyncio requests tiktoken httpx[socks] OpenAIAuth==0.2.0
"""
import asyncio
import json
import os
...
# PROXY_URL = os.environ.get("PROXY_URL") or "http://yanjingang.com:8118"
...
#     """ Test """
#     # params
#     email = "xxx@xxx.com"                 # Your OpenAI email address
#     password = "xxxxxx"                   # Your OpenAI password
#     # proxy = ""                          # Use a proxy
#     # insecure_auth = True                # Use an insecure authentication method to bypass OpenAI's geo-blocking
#     # session_token = ""                  # Alternative to email and password authentication. Use this if you have Google/Microsoft account.
#     if (email is None or password is None) and session_token is None:
