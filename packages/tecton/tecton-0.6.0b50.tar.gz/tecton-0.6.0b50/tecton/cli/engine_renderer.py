...
class ThinPlanRenderingClient(BasePlanRenderingClient):
    ...
    def warnings(self) -> List[ValidationMessage]:
        # full warning messages are only used for tests, but the number of warnings
        # is used for real amplitude metrics
        return [ValidationMessage(message="")] * self.response.successful_plan_output.num_warnings
