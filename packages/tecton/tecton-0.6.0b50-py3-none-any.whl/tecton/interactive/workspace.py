...
class Workspace:
    ...
    @sdk_public_method
    def get_feature_table(self, name: str) -> Union[FeatureTable, unified_feature_view.FeatureTable]:
        """
    ...
    @sdk_public_method
    def get_transformation(self, name: str) -> Union[Transformation, unified_transformation.Transformation]:
        """
