...
class ClingoLNS:
    ...
    def solve(self, timeout, on_solution=None):
        ...
        if isinstance(solution, list) and all(isinstance(x, clingo.symbol.Symbol) for x in solution):
            ...
            solution = internal_solver.solve(assumptions=solution, modellimit=1, timelimit=time_left())
            ...
            internal_solver.solve(assumptions=solution.model.symbols, modellimit=1, timelimit=time_left())
