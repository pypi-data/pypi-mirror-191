...
TEMPLATE_TO_NAME_MAP: Dict[WorkspaceStarterTemplate, str] = {
    ...
    WorkspaceStarterTemplate.aws_api_server: "api-server",
    WorkspaceStarterTemplate.aws_ml_server: "ml-server",
}
...
def create_workspace_using_input():
    ...
    print_info("Select Template (default: aws-data-platform)")
    ...
    template: WorkspaceStarterTemplate = WorkspaceStarterTemplate.aws_dp
