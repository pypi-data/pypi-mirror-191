...
class DownloadRequest(NamedTuple):
    ...
    def __hash__(self) -> int:
        ...
        return hash(
            (self.urls_info.evg_version_id, self.urls_info.project_identifier, self.bin_suffix)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if isinstance(other, self.__class__):
            return (
                other.urls_info.evg_version_id == self.urls_info.evg_version_id
                and other.urls_info.project_identifier == self.urls_info.project_identifier
