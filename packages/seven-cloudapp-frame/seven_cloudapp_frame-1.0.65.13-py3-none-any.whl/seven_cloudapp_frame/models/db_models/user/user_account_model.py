...
class UserAccount:
    ...
    def get_field_list(self):
        return ['id', 'union_id', 'open_id', 'user_nick', 'user_nick_encrypt', 'avatar', 'user_state','full_name','telephone','sex','birthday','certificate_type','certificate_no', 'relieve_date', 'create_date','create_ip', 'modify_date','login_date','login_ip']
