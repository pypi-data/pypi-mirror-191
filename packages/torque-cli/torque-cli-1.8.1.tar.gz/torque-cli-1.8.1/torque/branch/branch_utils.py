...
from torque.environments import Environment
...
def can_temp_branch_be_deleted(environment: Environment) -> bool:
    progress = getattr(environment, "launching_progress")
