; RUN: llvm-mutate -f %s -c U4 2>&1 | filecheck %s
; CHECK:        %U3 = getelementptr
; CHECK-NOT:    %U4 = load
; CHECK-NEXT:   %nop = add i8 0, 0,
; CHECK-NOT:    %U4 = load
; CHECK-NEXT:   %U5 = fmul contract float {{(%A1|1.000000e\+00|0.000000e\+00)}}
; CHECK-NEXT:   %U6 = fadd contract float {{(%A1|1.000000e\+00|0.000000e\+00)}}
; CHECK: U4.d
