...
LOOKUPS = {
    "liveAnimal": [
        ...
        "percentageSDMethaneConversionFactorEntericFermentationIPCC2019"
    ],
...
def _should_run(cycle: dict):
    ...
    enteric_factor = safe_parse_float(_get_liveAnimal_lookup_value(
        lookup, term_id, 'percentageYmMethaneConversionFactorEntericFermentationIPCC2019', DE, NDF, ionophore
    )) / 100
    enteric_sd = safe_parse_float(_get_liveAnimal_lookup_value(
        lookup, term_id, 'percentageSDMethaneConversionFactorEntericFermentationIPCC2019', DE, NDF, ionophore
    ), None)
