...
class MessageContentType(object):
    ...
    def __init__(self, id=None, name=None, organization_id=None, schema=None, visibility=None):  # noqa: E501
    ...
    @property
    def schema(self):
        """Gets the schema of this MessageContentType.  # noqa: E501
        ...
        :return: The schema of this MessageContentType.  # noqa: E501
        :rtype: str
        """
        return self._schema
    ...
    def schema(self, schema):
        """Sets the schema of this MessageContentType.

        OPTIONAL. The base64 encoded represenation of the schema. The name of the schema should include +xml or +json and the encoded bytes attached here should be xml, json accordingly. If not supplied the system will provide a minimum schema in xml or json depending on the +xml or +json designation in the name field.   # noqa: E501

        :param schema: The schema of this MessageContentType.  # noqa: E501
        :type: str
        """
