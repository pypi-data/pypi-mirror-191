...
class DiffConvert:
    ...
    * trigger(new, *args) -- called when a trigger causes a converter to
    ...
    def __init__(self):
        ...
        # set _context_args value for this converter, which is used by
        # the split_args() method to vary the split between the
        # arguments used in the context vs those in the cmd and ext
        # elements returned by that function
        #
        ...
        self._context_args = (
            len([ i for i, v in enumerate(self.context) if v is None ])
