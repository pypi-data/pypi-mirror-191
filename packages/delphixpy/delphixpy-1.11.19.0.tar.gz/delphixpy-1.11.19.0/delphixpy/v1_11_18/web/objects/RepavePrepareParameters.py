...
class RepavePrepareParameters(TypedObject):
    ...
    *(extends* :py:class:`v1_11_18.web.vo.TypedObject` *)* The parameters to
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "ignore_masking_jobs_in_progress" == "type" or (self.ignore_masking_jobs_in_progress is not self.__undef__ and (not (dirty and not self._ignore_masking_jobs_in_progress[1]) or isinstance(self.ignore_masking_jobs_in_progress, list) or belongs_to_parent)):
