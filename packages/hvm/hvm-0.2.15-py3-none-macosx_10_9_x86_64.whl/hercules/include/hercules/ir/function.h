...
class BaseFuncNode : public HLOExprNode {
 public:
  ...
  HERCULES_DLL virtual runtime::Array<BaseExpr> GetParams() const = 0;
  HERCULES_DLL virtual runtime::Array<BaseExpr> GetDefaultParams() const = 0;
  ...
  HERCULES_DECLARE_BASE_OBJECT_INFO(BaseFuncNode, HLOExprNode);
};
...
class BaseFunc : public HLOExpr {
 public:
  HERCULES_DEFINE_OBJECT_REF_METHODS(BaseFunc, HLOExpr, BaseFuncNode);
};
...
class PrimFuncNode : public BaseFuncNode {
 public:
  ...
  HERCULES_DLL runtime::Array<BaseExpr> GetParams() const override;
  HERCULES_DLL runtime::Array<BaseExpr> GetDefaultParams() const override;
...
class PrimFunc : public BaseFunc {
 public:
   ...
   */
  HERCULES_DLL PrimFunc(runtime::Array<PrimVar> params,
                    runtime::Array<PrimExpr> default_params,
                    Stmt body,
...
class Function : public BaseFunc {
 public:
   ...
   */
  HERCULES_DLL Function(runtime::Array<BaseExpr> params,
                    runtime::Array<BaseExpr> default_params,
                    Stmt body,
                    Type ret_type,
...
class LambdaFunctionNode : public BaseFuncNode {
 public:
  ...
  HERCULES_DECLARE_FINAL_OBJECT_INFO(LambdaFunctionNode, BaseFuncNode);
};
...
class LambdaFunction : public BaseFunc {
 public:
   ...
   * \param span The span of the function.
   */
  HERCULES_DLL LambdaFunction(runtime::Array<BaseExpr> captures,
                          runtime::Array<BaseExpr> params,
                          Stmt body,
                          Type ret_type,
                          DictAttrs attrs = NullValue<DictAttrs>(),
  ...
  HERCULES_DEFINE_OBJECT_REF_METHODS(LambdaFunction, BaseFunc, LambdaFunctionNode);
