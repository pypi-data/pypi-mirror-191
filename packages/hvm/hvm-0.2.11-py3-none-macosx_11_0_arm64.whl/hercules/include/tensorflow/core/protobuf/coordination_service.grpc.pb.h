...
class CoordinationService final {
 public:
   ...
   public:
    WithCallbackMethod_RegisterWorker() {
      ::grpc::Service::MarkMethodCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::tensorflow::RegisterWorkerRequest, ::tensorflow::RegisterWorkerResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::tensorflow::RegisterWorkerRequest* request, ::tensorflow::RegisterWorkerResponse* response) { return this->RegisterWorker(context, request, response); }));}
    void SetMessageAllocatorFor_RegisterWorker(
        ::grpc::MessageAllocator< ::tensorflow::RegisterWorkerRequest, ::tensorflow::RegisterWorkerResponse>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(0);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::tensorflow::RegisterWorkerRequest, ::tensorflow::RegisterWorkerResponse>*>(handler)
    ...
    virtual ::grpc::ServerUnaryReactor* RegisterWorker(
      ::grpc::CallbackServerContext* /*context*/, const ::tensorflow::RegisterWorkerRequest* /*request*/, ::tensorflow::RegisterWorkerResponse* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithCallbackMethod_ReportErrorToAgent : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithCallbackMethod_ReportErrorToAgent() {
      ::grpc::Service::MarkMethodCallback(3,
          new ::grpc::internal::CallbackUnaryHandler< ::tensorflow::ReportErrorToAgentRequest, ::tensorflow::ReportErrorToAgentResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::tensorflow::ReportErrorToAgentRequest* request, ::tensorflow::ReportErrorToAgentResponse* response) { return this->ReportErrorToAgent(context, request, response); }));}
    void SetMessageAllocatorFor_ReportErrorToAgent(
        ::grpc::MessageAllocator< ::tensorflow::ReportErrorToAgentRequest, ::tensorflow::ReportErrorToAgentResponse>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(3);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::tensorflow::ReportErrorToAgentRequest, ::tensorflow::ReportErrorToAgentResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ~WithCallbackMethod_ReportErrorToAgent() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status ReportErrorToAgent(::grpc::ServerContext* /*context*/, const ::tensorflow::ReportErrorToAgentRequest* /*request*/, ::tensorflow::ReportErrorToAgentResponse* /*response*/) override {
    ...
    virtual ::grpc::ServerUnaryReactor* ReportErrorToAgent(
      ::grpc::CallbackServerContext* /*context*/, const ::tensorflow::ReportErrorToAgentRequest* /*request*/, ::tensorflow::ReportErrorToAgentResponse* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_RegisterWorker<WithCallbackMethod_Heartbeat<WithCallbackMethod_WaitForAllTasks<WithCallbackMethod_ReportErrorToAgent<WithCallbackMethod_ReportErrorToService<WithCallbackMethod_InsertKeyValue<WithCallbackMethod_GetKeyValue<WithCallbackMethod_DeleteKeyValue<Service > > > > > > > > CallbackService;
  ...
  template <class BaseClass>
  class WithRawCallbackMethod_ReportErrorToAgent : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawCallbackMethod_ReportErrorToAgent() {
      ::grpc::Service::MarkMethodRawCallback(3,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->ReportErrorToAgent(context, request, response); }));
    }
    ~WithRawCallbackMethod_ReportErrorToAgent() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status ReportErrorToAgent(::grpc::ServerContext* /*context*/, const ::tensorflow::ReportErrorToAgentRequest* /*request*/, ::tensorflow::ReportErrorToAgentResponse* /*response*/) override {
    ...
    WithStreamedUnaryMethod_RegisterWorker() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler<
          ::tensorflow::RegisterWorkerRequest, ::tensorflow::RegisterWorkerResponse>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::tensorflow::RegisterWorkerRequest, ::tensorflow::RegisterWorkerResponse>* streamer) {
   ...
   public:
    WithStreamedUnaryMethod_ReportErrorToAgent() {
      ::grpc::Service::MarkMethodStreamed(3,
        new ::grpc::internal::StreamedUnaryHandler<
          ::tensorflow::ReportErrorToAgentRequest, ::tensorflow::ReportErrorToAgentResponse>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::tensorflow::ReportErrorToAgentRequest, ::tensorflow::ReportErrorToAgentResponse>* streamer) {
                       return this->StreamedReportErrorToAgent(context,
                         streamer);
                  }));
    }
