...
class TupleNode : public HLOExprNode {
 public:
  ...
  HERCULES_DECLARE_FINAL_OBJECT_INFO(TupleNode, HLOExprNode);
};
...
class Tuple : public HLOExpr {
 public:
   ...
   */
  HERCULES_DLL explicit Tuple(runtime::Array<BaseExpr> fields, Span span = Span());

  HERCULES_DEFINE_OBJECT_REF_METHODS(Tuple, HLOExpr, TupleNode);
};
