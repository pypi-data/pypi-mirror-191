...
class LetStmtNode : public StmtNode {
 public:
  ...
  HERCULES_DECLARE_FINAL_OBJECT_INFO(LetStmtNode, StmtNode);
};
...
class LetStmt : public Stmt {
 public:
  HERCULES_DLL LetStmt(PrimVar var, PrimExpr value, Stmt body, Span span = Span());

  HERCULES_DEFINE_OBJECT_REF_METHODS(LetStmt, Stmt, LetStmtNode);
};
...
class AttrStmtNode : public StmtNode {
 public:
  ...
  HERCULES_DECLARE_FINAL_OBJECT_INFO(AttrStmtNode, StmtNode);
};
...
class AttrStmt : public Stmt {
 public:
  HERCULES_DLL AttrStmt(
      ObjectRef node, StringRef attr_key, BaseExpr value, Stmt body, Span span = Span());

  HERCULES_DEFINE_OBJECT_REF_METHODS(AttrStmt, Stmt, AttrStmtNode);
};
...
class SeqStmt : public Stmt {
 public:
   ...
   */
  HERCULES_DLL explicit SeqStmt(runtime::Array<Stmt> seq, Span span = Span());
...
class TryExcept : public Stmt {
 public:
  HERCULES_DLL TryExcept(Stmt body, runtime::Array<ExceptionHandler> handlers, Span span = Span());
...
class EvaluateNode : public StmtNode {
 public:
  ...
  HERCULES_DECLARE_FINAL_OBJECT_INFO(EvaluateNode, StmtNode);
};
...
class Evaluate : public Stmt {
 public:
  HERCULES_DLL explicit Evaluate(PrimExpr value, Span span = Span());

  explicit Evaluate(int value, Span span = Span()) : Evaluate(PrimExpr(value), std::move(span)) {
  }

  HERCULES_DEFINE_OBJECT_REF_METHODS(Evaluate, Stmt, EvaluateNode);
};
...
class AutoFor : public Stmt {
 public:
  ...
  HERCULES_DLL AutoFor(runtime::Array<BaseExpr> loop_vars,
                   BaseExpr container,
                   Stmt body,
                   Span span = Span());
