...
class RangeNode : public Object {
 public:
  ...
  HERCULES_DECLARE_FINAL_OBJECT_INFO(RangeNode, Object);
};
...
class Range : public ObjectRef {
 public:
   ...
   */
  HERCULES_DLL Range(PrimExpr begin, PrimExpr end);
  /*!
  ...
  // declare range.
  HERCULES_DEFINE_OBJECT_REF_METHODS(Range, ObjectRef, RangeNode);
};
