            ...
            for ann in anns:
                ...
                if ann.get('segmentation'):
                    if len(ann.get('segmentation')[0]) == 8:
                        ...
                        points3 = [[x3, y3]]
                        points4 = [[x4, y4]]
                        shape1 = {"label": name_point, "points": points1, "group_id": 0, "shape_type": "point",
                                  "flags": {}, "text": None}
                        shape2 = {"label": name_point, "points": points2, "group_id": 0, "shape_type": "point",
                                  "flags": {}, "text": None}
                        shape3 = {"label": name_point, "points": points3, "group_id": 0, "shape_type": "point",
                                  "flags": {}, "text": None}
                        shape4 = {"label": name_point, "points": points4, "group_id": 0, "shape_type": "point",
                                  "flags": {}, "text": None}
                        ...
                        # 矩形框
                        shape = {"label": name, "points": points, "group_id": 0, "shape_type": "rectangle",
                                 "flags": {}}
                        shapes.append(shape)
                else:
