            ...
            for ann in anns:
                ...
                if ann.get('segmentation'):
                    if len(ann.get('segmentation')[0]) == 8:
                        ...
                        points3 = [[x3, y3]]
                        points4 = [[x4, y4]]
                        shape1 = {"label": name, "points": points1, "group_id": 0, "shape_type": "point",
                                  "flags": {}, "text": None}
                        shape2 = {"label": name, "points": points2, "group_id": 0, "shape_type": "point",
                                  "flags": {}, "text": None}
                        shape3 = {"label": name, "points": points3, "group_id": 0, "shape_type": "point",
                                  "flags": {}, "text": None}
                        shape4 = {"label": name, "points": points4, "group_id": 0, "shape_type": "point",
                                  "flags": {}, "text": None}
