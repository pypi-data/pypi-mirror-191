...
class DingTalkPlugin(CorePluginMixin, notify.NotificationPlugin):
    ...
    def notify(self, notification, raise_exception=False):
        ...
        self._post(group, release, project)

    def _post(self, group, release, project):
        ...
        payload = f"## [Sentry]: [{group.title}>>]({issue_link}) \n\n"
        ...
        # 可选 webhook，不会 @ 成员
        if webhook_optional is not None and webhook == webhook_optional:
