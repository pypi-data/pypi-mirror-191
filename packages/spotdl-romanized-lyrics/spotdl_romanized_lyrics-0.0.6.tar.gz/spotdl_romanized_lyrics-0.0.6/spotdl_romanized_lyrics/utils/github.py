"""
Module for getting information about the current version of spotdl_romanized_lyrics
...
REPO = "spotdl_romanized_lyrics/spotify-downloader"
WEB_APP_URL = "https://github.com/spotdl_romanized_lyrics/web-ui/tree/master/dist"
...
def get_status(start: str, end: str, repo: str = REPO) -> Tuple[str, int, int]:
    ...
    - repo: the repo to check (defaults to spotdl_romanized_lyrics/spotify-downloader)
