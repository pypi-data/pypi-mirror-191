...
from spotdl_romanized_lyrics.utils.github import download_github_dir
from spotdl_romanized_lyrics.utils.config import get_spotdl_romanized_lyrics_path
from spotdl_romanized_lyrics.utils.web import (
    ALLOWED_ORIGINS,
    SPAStaticFiles,
    fix_mime_types,
    app_state,
...
def web(settings: Dict[str, Any]):
    ...
    web_app_dir = str(get_spotdl_romanized_lyrics_path().absolute())
    download_github_dir(
        "https://github.com/spotdl_romanized_lyrics/web-ui/tree/master/dist",
