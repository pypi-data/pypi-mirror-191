...
from spotdl_romanized_lyrics.utils.metadata import embed_metadata, get_song_metadata
from spotdl_romanized_lyrics.utils.search import create_empty_song, get_search_results
...
def meta(query: List[str], downloader: Downloader, **_) -> None:
    ...
    def process_file(file: Path):
        ...
        if song_meta is None or song_meta.get("lyrics") is None:
            ...
            lyrics = downloader.search_lyrics(song, romanized=False)
            if lyrics:
                song.lyrics = lyrics
