...
from spotdl_romanized_lyrics.types import Playlist, Album, Artist, Saved
from spotdl_romanized_lyrics.types.song import SongList, Song
...
def get_simple_songs(
    ...
    for request in query:
        ...
        elif request.endswith(".spotdl_romanized_lyrics"):
