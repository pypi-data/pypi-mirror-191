...
if __name__ == "__main__":
    df, x_names = make_uplift_classification(
        ...
        n_classification_informative=36,
        n_samples=100000,
        n_uplift_increase_dict={"t": 10},
        n_uplift_decrease_dict={"t": 5},
        n_uplift_increase_mix_informative_dict={"t": 3},
        n_uplift_decrease_mix_informative_dict={"t": 2},
        delta_uplift_increase_dict={"t": 0.05},
        delta_uplift_decrease_dict={"t": 0.03},
    )
