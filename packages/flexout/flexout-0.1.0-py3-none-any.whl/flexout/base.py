...
class Format:
    ...
    def open_file(self):
        filemgr.makedirs(filemgr.dirname(self.flexout.target), exist_ok=True)
        return filemgr.open_file(self.flexout.target, mode='a' if self.append else 'w', newline=self.newline, encoding=self.encoding)
