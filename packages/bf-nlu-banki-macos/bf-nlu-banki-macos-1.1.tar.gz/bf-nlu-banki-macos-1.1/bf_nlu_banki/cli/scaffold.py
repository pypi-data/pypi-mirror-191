...
from bf_nlu_banki.cli.shell import shell
from bf_nlu_banki.shared.utils.cli import print_success, print_error_and_exit
...
def print_train_or_instructions(args: argparse.Namespace) -> None:
    ...
    if should_train:
        ...
        training_result = bf_nlu_banki.train(
            DEFAULT_DOMAIN_PATH,
            DEFAULT_CONFIG_PATH,
            DEFAULT_DATA_PATH,
            DEFAULT_MODELS_PATH,
        ...
        print_success(
            ...
            "to the project directory and running 'bf_nlu_banki train'."
        )


def print_run_or_instructions(args: argparse.Namespace) -> None:
    from bf_nlu_banki.core import constants
    import questionary
    ...
    if should_run:
        ...
        if args.no_prompt:
            print(
                ...
                "run 'bf_nlu_banki shell' at any time inside "
...
def print_cancel() -> None:
    print_success("Ok. You can continue setting up by running 'bf_nlu_banki init' 🙋🏽‍♀️")
    sys.exit(0)
...
def _ask_create_path(path: Text) -> None:
    ...
    if should_create:
        ...
        print_success(
            ...
            "running 'bf_nlu_banki init' again 🙋🏽‍♀️"
        )
        sys.exit(0)
...
def run(args: argparse.Namespace) -> None:
    ...
    print_success("Welcome to bf_nlu_banki! 🤖\n")
    if args.no_prompt:
        print(
