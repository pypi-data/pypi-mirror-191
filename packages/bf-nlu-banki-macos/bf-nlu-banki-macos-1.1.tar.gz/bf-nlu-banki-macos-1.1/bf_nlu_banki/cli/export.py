...
from bf_nlu_banki.cli.arguments import export as arguments
from bf_nlu_banki.shared.constants import DOCS_URL_EVENT_BROKERS, DOCS_URL_TRACKER_STORES
from bf_nlu_banki.exceptions import PublishingError
from bf_nlu_banki.shared.exceptions import bf_nlu_bankiException
from bf_nlu_banki.core.brokers.pika import PikaEventBroker

if typing.TYPE_CHECKING:
    from bf_nlu_banki.core.brokers.broker import EventBroker
    from bf_nlu_banki.core.tracker_store import TrackerStore
    from bf_nlu_banki.core.exporter import Exporter
...
def add_subparser(
    ...
    """Add subparser for `bf_nlu_banki export`.
...
async def _export_trackers(args: argparse.Namespace) -> None:
    ...
    endpoints = bf_nlu_banki.core.utils.read_endpoints_from_path(args.endpoints)
    ...
    except bf_nlu_bankiException as e:
        bf_nlu_banki.shared.utils.cli.print_error_and_exit(str(e))


def _get_continuation_command(exporter: "Exporter", timestamp: float) -> Text:
    """Build CLI command to continue 'bf_nlu_banki export' where it was interrupted.
