...
from bf_nlu_banki.cli.arguments.default_arguments import add_endpoint_param, add_domain_param


def set_markers_arguments(parser: argparse.ArgumentParser) -> None:
    """Specifies arguments for `bf_nlu_banki evaluate markers`."""
    parser.add_argument(
        "output_filename",
        type=Path,
...
def set_markers_first_n_arguments(parser: argparse.ArgumentParser) -> None:
    """Specifies arguments for `bf_nlu_banki evaluate markers first_n`."""
    parser.add_argument(
...
def set_markers_sample_arguments(parser: argparse.ArgumentParser) -> None:
    """Specifies arguments for `bf_nlu_banki evaluate markers sample_n`."""
    parser.add_argument(
