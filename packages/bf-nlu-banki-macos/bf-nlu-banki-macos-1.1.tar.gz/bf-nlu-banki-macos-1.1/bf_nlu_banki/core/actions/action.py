...
from bf_nlu_banki.shared.core import events
...
from bf_nlu_banki.shared.core.slot_mappings import SlotMapping
from bf_nlu_banki.shared.core.slots import ListSlot
...
from bf_nlu_banki.utils.endpoints import EndpointConfig, ClientResponseError

if TYPE_CHECKING:
    from bf_nlu_banki.core.nlg import NaturalLanguageGenerator
    from bf_nlu_banki.core.channels.channel import OutputChannel
    from bf_nlu_banki.shared.core.events import IntentPrediction
...
def default_actions(action_endpoint: Optional[EndpointConfig] = None) -> List["Action"]:
    ...
    from bf_nlu_banki.core.actions.two_stage_fallback import TwoStageFallbackAction
...
def action_for_name_or_text(
    ...
    if is_form and not user_overrode_form_action:
        from bf_nlu_banki.core.actions.forms import FormAction
...
class Action:
    ...
    async def run(
        ...
        Returns:
            A list of :class:`bf_nlu_banki.core.events.Event` instances
        """
        raise NotImplementedError
...
class RemoteAction(Action):
    ...
    def _action_call_format(
        ...
        from bf_nlu_banki.shared.core.trackers import EventVerbosity
...
class ActionExecutionRejection(bf_nlu_bankiException):
...
class ActionRevertFallbackEvents(Action):
    ...
    async def run(
        ...
        """Runs action. Please see parent class for the full docstring."""
        from bf_nlu_banki.core.policies.two_stage_fallback import has_user_rephrased
...
class ActionExtractSlots(Action):
    ...
    async def _run_custom_action(
        ...
        except (bf_nlu_bankiException, ClientResponseError) as e:
            logger.warning(
