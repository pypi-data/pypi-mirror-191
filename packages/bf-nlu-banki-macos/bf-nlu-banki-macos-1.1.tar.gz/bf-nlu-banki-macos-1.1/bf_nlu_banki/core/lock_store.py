...
from bf_nlu_banki.shared.exceptions import bf_nlu_bankiException, ConnectionException
import bf_nlu_banki.shared.utils.common
from bf_nlu_banki.core.constants import DEFAULT_LOCK_LIFETIME
from bf_nlu_banki.core.lock import TicketLock
...
class LockError(bf_nlu_bankiException):
...
class RedisLockStore(LockStore):
    ...
    def __init__(
        ...
        Args:
            ...
            db: The name of the database within Redis which should be used by bf_nlu_banki
                Open Source.
...
def _load_from_module_name_in_endpoint_config(
    ...
    try:
        lock_store_class = bf_nlu_banki.shared.utils.common.class_from_module_path(
