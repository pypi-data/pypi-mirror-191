...
from bf_nlu_banki.shared.constants import DOCS_URL_RULES
from bf_nlu_banki.shared.exceptions import bf_nlu_bankiException
import bf_nlu_banki.shared.utils.io
from bf_nlu_banki.shared.core.events import LoopInterrupted, UserUttered, ActionExecuted
...
from bf_nlu_banki.core.policies.policy import SupportedData, PolicyPrediction
from bf_nlu_banki.shared.core.trackers import (
...
from bf_nlu_banki.shared.core.domain import InvalidDomain, State, Domain
from bf_nlu_banki.shared.nlu.constants import ACTION_NAME, INTENT_NAME_KEY
import bf_nlu_banki.core.test
from bf_nlu_banki.core.training.training import create_action_fingerprints, ActionFingerprint

logger = logging.getLogger(__name__)


# These are bf_nlu_banki Open Source default actions and overrule everything at any time.
...
class InvalidRule(bf_nlu_bankiException):
...
class RulePolicy(MemoizationPolicy):
    ...
    def _predicted_action_name(
        ...
        if (
            ...
            bf_nlu_banki.core.test.emulate_loop_rejection(tracker)
            predicted_action_name, prediction_source = self._predict_next_action(
                tracker, domain
            )
    ...
    def _run_prediction_on_trackers(
        ...
        pbar = tqdm(
            ...
            disable=bf_nlu_banki.shared.utils.io.is_logging_disabled(),
        )
        for tracker in pbar:
    ...
    def _predict(
        ...
        # bf_nlu_banki Open Source default actions overrule anything. If users want to achieve
