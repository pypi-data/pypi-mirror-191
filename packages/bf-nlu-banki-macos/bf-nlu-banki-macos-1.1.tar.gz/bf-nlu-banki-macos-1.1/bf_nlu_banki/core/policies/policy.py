...
from bf_nlu_banki.engine.graph import GraphComponent, ExecutionContext
...
from bf_nlu_banki.core.featurizers.tracker_featurizers import MaxHistoryTrackerFeaturizer
from bf_nlu_banki.core.featurizers.single_state_featurizer import SingleStateFeaturizer
from bf_nlu_banki.core.featurizers.tracker_featurizers import FEATURIZER_FILE
import bf_nlu_banki.utils.common
import bf_nlu_banki.shared.utils.io
from bf_nlu_banki.shared.exceptions import bf_nlu_bankiException, FileIOException
from bf_nlu_banki.shared.nlu.constants import ENTITIES, INTENT, TEXT, ACTION_TEXT, ACTION_NAME
from bf_nlu_banki.shared.core.domain import Domain, State
...
from bf_nlu_banki.shared.core.constants import USER, SLOTS, PREVIOUS_ACTION, ACTIVE_LOOP
...
class Policy(GraphComponent):
    ...
    def _create_featurizer(self) -> TrackerFeaturizer:
        ...
        featurizer_func = _get_featurizer_from_config(
            ...
            lookup_path="bf_nlu_banki.core.featurizers.tracker_featurizers",
        )
        ...
        if state_featurizer_configs:
            state_featurizer_func = _get_featurizer_from_config(
                ...
                self.__class__.__name__,
                lookup_path="bf_nlu_banki.core.featurizers.single_state_featurizer",
            )
    ...
    def _get_valid_params(func: Callable, **kwargs: Any) -> Dict:
        ...
        """
        valid_keys = bf_nlu_banki.shared.utils.common.arguments_of(func)
    ...
    def _featurize_for_training(
        ...
        **kwargs: Any,
        ...
        Args:
            training_trackers:
                the list of the :class:`bf_nlu_banki.core.trackers.DialogueStateTracker`
            domain: the :class:`bf_nlu_banki.shared.core.domain.Domain`
    ...
    def __init__(
        ...
        Args:
            ...
            diagnostic_data: Intermediate results or other information that is not
                necessary for bf_nlu_banki to function, but intended for debugging and
...
class InvalidPolicyConfig(bf_nlu_bankiException):
...
def _get_featurizer_from_config(
    ...
    featurizer_func = bf_nlu_banki.shared.utils.common.class_from_module_path(
