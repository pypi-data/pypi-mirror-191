...
class KafkaProducerInitializationError(bf_nlu_bankiException):
...
class KafkaEventBroker(EventBroker):
    ...
    def __init__(
        ...
        topic: Text = "bf_nlu_banki_core_events",
    ...
    def _publish(self, event: Dict[Text, Any]) -> None:
        ...
        headers = []
        if self.bf_nlu_banki_environment:
            headers = [
                (
                    "bf_nlu_banki_ENVIRONMENT",
                    bytes(self.bf_nlu_banki_environment, encoding=DEFAULT_ENCODING),
                )
            ]
    ...
    def bf_nlu_banki_environment(self) -> Optional[Text]:
        ...
        return os.environ.get("bf_nlu_banki_ENVIRONMENT", "bf_nlu_banki_ENVIRONMENT_NOT_SET")
