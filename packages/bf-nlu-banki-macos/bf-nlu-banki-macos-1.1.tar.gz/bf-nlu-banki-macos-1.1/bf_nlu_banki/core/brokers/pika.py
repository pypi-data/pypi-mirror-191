...
from bf_nlu_banki.shared.constants import DOCS_URL_PIKA_EVENT_BROKER
...
RABBITMQ_EXCHANGE = "bf_nlu_banki-exchange"
DEFAULT_QUEUE_NAME = "bf_nlu_banki_core_events"
...
class PikaEventBroker(EventBroker):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            raise bf_nlu_bankiException("Port could not be converted to integer.") from e
    ...
    def _get_queues_from_args(
        ...
        publish to is `queues` (as of bf_nlu_banki Open Source version 1.8.2). This method
    ...
    def _message(
        ...
        return aio_pika.Message(
            ...
            headers=headers,
            app_id=self.bf_nlu_banki_environment,
            delivery_mode=aio_pika.DeliveryMode.PERSISTENT,
        )

    @bf_nlu_banki.shared.utils.common.lazy_property
    def bf_nlu_banki_environment(self) -> Optional[Text]:
        """Get value of the `bf_nlu_banki_ENVIRONMENT` environment variable."""
        return os.environ.get("bf_nlu_banki_ENVIRONMENT")
