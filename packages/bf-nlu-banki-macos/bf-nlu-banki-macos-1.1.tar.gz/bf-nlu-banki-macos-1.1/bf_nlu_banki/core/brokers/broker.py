...
from bf_nlu_banki.shared.exceptions import ConnectionException
...
class EventBroker:
    ...
    def publish(self, event: Dict[Text, Any]) -> None:
        """Publishes a json-formatted bf_nlu_banki Core event into an event queue."""
...
async def _load_from_module_name_in_endpoint_config(
    ...
    try:
        event_broker_class = bf_nlu_banki.shared.utils.common.class_from_module_path(
            broker_config.type
        )
