...
from bf_nlu_banki.shared.core.events import ActionExecuted, Event
    ...
    def _summarize_conflicting_actions(action: Text, stories: List[Text]) -> Text:
        ...
        if len(stories) > 3:
            ...
            raise ValueError(
                ...
                "https://github.com/bf_nlu_bankiHQ/bf_nlu_banki."
            )
...
def _get_previous_event(
    ...
    if not isinstance(previous_event_name, (str, type(None))):
        ...
        raise TypeError(
            ...
            f"None, not {type(previous_event_name)}. Did you modify bf_nlu_banki source code?"
        )
