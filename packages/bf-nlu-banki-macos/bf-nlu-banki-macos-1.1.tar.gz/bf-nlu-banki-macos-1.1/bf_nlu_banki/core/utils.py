...
from bf_nlu_banki.constants import DEFAULT_SANIC_WORKERS, ENV_SANIC_WORKERS
from bf_nlu_banki.shared.constants import DEFAULT_ENDPOINTS_PATH, TCP_PROTOCOL

from bf_nlu_banki.core.lock_store import LockStore, RedisLockStore, InMemoryLockStore
from bf_nlu_banki.utils.endpoints import EndpointConfig, read_endpoint_config
from sanic import Sanic
from socket import SOCK_DGRAM, SOCK_STREAM
import bf_nlu_banki.cli.utils as cli_utils
...
def configure_file_logging(
    ...
    if log_file:
        ...
        file_handler = logging.FileHandler(
            log_file, encoding=bf_nlu_banki.shared.utils.io.DEFAULT_ENCODING
        )
...
def list_routes(app: Sanic) -> Dict[Text, Text]:
    ...
    for route in app.router.routes:
        ...
        handlers = [(list(route.methods)[0], route.name.replace("bf_nlu_banki_server.", ""))]
