...
def _create_from_endpoint_config(
    ...
    if endpoint_config is None:
        from bf_nlu_banki.core.nlg import TemplatedNaturalLanguageGenerator
        ...
        from bf_nlu_banki.core.nlg import CallbackNaturalLanguageGenerator
...
def _load_from_module_name_in_endpoint_config(
    ...
    try:
        nlg_class = bf_nlu_banki.shared.utils.common.class_from_module_path(
