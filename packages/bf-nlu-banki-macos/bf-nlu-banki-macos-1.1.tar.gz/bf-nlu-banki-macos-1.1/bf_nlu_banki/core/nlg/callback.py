...
from bf_nlu_banki.core.nlg.generator import NaturalLanguageGenerator
    ...
    async def generate(
        ...
        **kwargs: Any,
        ...
        if isinstance(response, dict) and self.validate_response(response):
            ...
            raise bf_nlu_bankiException("NLG web endpoint returned an invalid response.")
    ...
    def validate_response(content: Optional[Dict[Text, Any]]) -> bool:
        ...
        try:
            ...
            raise bf_nlu_bankiException(
                ...
                f"https://github.com/bf_nlu_bankiHQ/bf_nlu_banki/blob/main/bf_nlu_banki/core/nlg/callback.py"
            )
