...
from bf_nlu_banki.constants import NUMBER_OF_TRAINING_STORIES_FILE, PERCENTAGE_KEY
    ...
    for r in range(runs):
        ...
        for current_run, percentage in enumerate(exclusion_percentages, 1):
            for policy_config in policy_configs:
                ...
                bf_nlu_banki.model_training.train_core(
                    domain,
                    policy_config,
                    stories=story_file,
...
def do_interactive_learning(
    ...
    from bf_nlu_banki.core.training import interactive
