...
import bf_nlu_banki.core.training.story_conflict
...
from bf_nlu_banki.shared.core import constants
from bf_nlu_banki.shared.core.constants import MAPPING_CONDITIONS, ACTIVE_LOOP
from bf_nlu_banki.shared.core.events import ActionExecuted, ActiveLoop
from bf_nlu_banki.shared.core.events import UserUttered
from bf_nlu_banki.shared.core.domain import Domain
from bf_nlu_banki.shared.core.generator import TrainingDataGenerator
from bf_nlu_banki.shared.core.constants import SlotMappingType, MAPPING_TYPE
...
class Validator:
    ...
    def verify_example_repetition_in_intents(
        ...
        for example in self.intents.intent_examples:
            text = example.get(bf_nlu_banki.shared.nlu.constants.TEXT)
    ...
    def _gather_utterance_actions(self) -> Set[Text]:
        ...
        """
        domain_responses = {
            response.split(bf_nlu_banki.shared.nlu.constants.RESPONSE_IDENTIFIER_DELIMITER)[0]
    ...
    def verify_story_structure(
        ...
        conflicts = bf_nlu_banki.core.training.story_conflict.find_story_conflicts(
