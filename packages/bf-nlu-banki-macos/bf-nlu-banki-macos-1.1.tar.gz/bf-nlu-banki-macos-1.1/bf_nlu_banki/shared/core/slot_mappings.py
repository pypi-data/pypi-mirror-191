...
from bf_nlu_banki.shared.constants import DOCS_URL_SLOTS, IGNORED_INTENTS
...
class SlotMapping:
    ...
    def validate(mapping: Dict[Text, Any], slot_name: Text) -> None:
        ...
        """
        from bf_nlu_banki.shared.core.domain import InvalidDomain
    ...
    def _get_active_loop_ignored_intents(
        ...
        from bf_nlu_banki.shared.core.constants import ACTIVE_LOOP
