...
from bf_nlu_banki.shared.core.training_data.story_writer.story_writer import StoryWriter
from bf_nlu_banki.shared.core.training_data.structures import (
    StoryStep,
    Checkpoint,
    STORY_START,
    RuleStep,
...
class YAMLStoryWriter(StoryWriter):
    ...
    def process_user_utterance(
        ...
        if hasattr(user_utterance, "inline_comment"):
            ...
            # be imported but it's currently outside of `bf_nlu_banki.shared`
        ...
        if user_utterance.text and (
            ...
            result[KEY_USER_MESSAGE] = LiteralScalarString(
                bf_nlu_banki.shared.core.events.format_message(
                    user_utterance.text,
    ...
    def process_action(action: ActionExecuted) -> Optional[OrderedDict]:
        ...
        Returns:
            Dict with an action.
        """
        if action.action_name == bf_nlu_banki.shared.core.constants.RULE_SNIPPET_ACTION_NAME:
            return None
    ...
    def process_rule_step(self, rule_step: RuleStep) -> OrderedDict:
        ...
        if normal_events and not (
            ...
            == bf_nlu_banki.shared.core.constants.RULE_SNIPPET_ACTION_NAME
        ):
