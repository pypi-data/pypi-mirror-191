...
class EventTypeError(bf_nlu_bankiCoreException, ValueError):
    """Represents an error caused by a bf_nlu_banki Core event not being of the expected
    type.
...
class StoryGraph:
    ...
    def fingerprint(self) -> Text:
        ...
        return bf_nlu_banki.shared.utils.io.deep_container_fingerprint(stories_as_yaml)
