...
import bf_nlu_banki.shared.core.training_data.structures
import bf_nlu_banki.shared.utils.io
from bf_nlu_banki.shared.constants import DOCS_URL_STORIES
from bf_nlu_banki.shared.core.events import UserUttered, Event
...
class StoryStepBuilder:
    ...
    def _generate_checkpoint_name_for_or_statement(self, events: List[Event]) -> str:
        ...
        hashed_id = bf_nlu_banki.shared.utils.io.get_text_hash(unique_id)[
            :GENERATED_HASH_LENGTH
        ]
