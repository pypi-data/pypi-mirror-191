...
if typing.TYPE_CHECKING:
    from bf_nlu_banki.engine.graph import GraphSchema, GraphModelConfiguration
...
class ModelStorage(abc.ABC):
    ...
    def from_model_archive(
        ...
        Raises:
            ...
            has been created with an outdated bf_nlu_banki version.
        """
        ...
...
class ModelMetadata:
    ...
    trained_at: datetime
    bf_nlu_banki_open_source_version: Text
    model_id: Text
    domain: Domain
    ...
    def __post_init__(self) -> None:
        ...
        Raises:
            `UnsupportedModelException` if the `bf_nlu_banki_open_source_version` is lower
            than the minimum compatible version
        """
        minimum_version = version.parse(MINIMUM_COMPATIBLE_VERSION)
        model_version = version.parse(self.bf_nlu_banki_open_source_version)
    ...
    def as_dict(self) -> Dict[Text, Any]:
        ...
        return {
            ...
            "bf_nlu_banki_open_source_version": self.bf_nlu_banki_open_source_version,
    ...
    def from_dict(cls, serialized: Dict[Text, Any]) -> ModelMetadata:
        ...
        """
        from bf_nlu_banki.engine.graph import GraphSchema

        return ModelMetadata(
            trained_at=datetime.fromisoformat(serialized["trained_at"]),
            bf_nlu_banki_open_source_version=serialized["bf_nlu_banki_open_source_version"],
