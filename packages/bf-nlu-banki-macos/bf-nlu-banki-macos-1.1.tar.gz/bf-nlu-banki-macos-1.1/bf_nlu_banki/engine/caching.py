...
DEFAULT_CACHE_LOCATION = Path(".bf_nlu_banki", "cache")
DEFAULT_CACHE_NAME = "cache.db"
DEFAULT_CACHE_SIZE_MB = 1000

CACHE_LOCATION_ENV = "bf_nlu_banki_CACHE_DIRECTORY"
CACHE_DB_NAME_ENV = "bf_nlu_banki_CACHE_NAME"
CACHE_SIZE_ENV = "bf_nlu_banki_MAX_CACHE_SIZE"
...
class LocalTrainingCache(TrainingCache):
    ...
    class CacheEntry(Base):
        ...
        bf_nlu_banki_version = sa.Column(sa.String(255), nullable=False)
    ...
    def _find_incompatible_cache_entries(self) -> List[LocalTrainingCache.CacheEntry]:
        ...
        return [
            ...
            > version.parse(entry.bf_nlu_banki_version)
        ]
    ...
    def _add_cache_entry(
        ...
        with self._sessionmaker.begin() as session:
            cache_entry = self.CacheEntry(
                ...
                bf_nlu_banki_version=bf_nlu_banki.__version__,
    ...
    def _cache_output_to_disk(
        ...
        with bf_nlu_banki.utils.common.TempDirectoryPath(tempfile.mkdtemp()) as temp_dir:
            ...
            output_size = bf_nlu_banki.utils.common.directory_size_in_mb(tmp_path)
            ...
            while (
                bf_nlu_banki.utils.common.directory_size_in_mb(
            ...
            output_type = bf_nlu_banki.shared.utils.common.module_path_from_instance(output)
    ...
    def _load_from_cache(
        ...
        try:
            module = bf_nlu_banki.shared.utils.common.class_from_module_path(result_type)
