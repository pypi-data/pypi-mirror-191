...
import bf_nlu_banki.nlu.utils.pattern_utils as pattern_utils
...
from bf_nlu_banki.shared.nlu.constants import TEXT, RESPONSE, ACTION_TEXT
        ...
        **kwargs: Any,
        ...
        try:
            with model_storage.read_from(resource) as model_dir:
                ...
                known_patterns = bf_nlu_banki.shared.utils.io.read_json_file(patterns_file_name)
