...
from bf_nlu_banki.utils.tensorflow.model_data import Data, FeatureArray
from bf_nlu_banki.utils.tensorflow.constants import MASK, IDS
...
def get_tag_ids(
    ...
    from bf_nlu_banki.nlu.utils.bilou_utils import bilou_tags_to_ids
    from bf_nlu_banki.shared.nlu.training_data.features import Features
