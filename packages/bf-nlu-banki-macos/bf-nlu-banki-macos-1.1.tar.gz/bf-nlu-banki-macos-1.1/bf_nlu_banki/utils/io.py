...
def configure_colored_logging(loglevel: Text) -> None:
    ...
    loglevel = loglevel or os.environ.get(
        bf_nlu_banki.shared.constants.ENV_LOG_LEVEL, bf_nlu_banki.shared.constants.DEFAULT_LOG_LEVEL
    )
...
def create_temporary_file(data: Any, suffix: Text = "", mode: Text = "w+") -> Text:
    ...
    encoding = None if "b" in mode else bf_nlu_banki.shared.utils.io.DEFAULT_ENCODING
...
def json_unpickle(
    ...
    file_content = bf_nlu_banki.shared.utils.io.read_file(file_name)
