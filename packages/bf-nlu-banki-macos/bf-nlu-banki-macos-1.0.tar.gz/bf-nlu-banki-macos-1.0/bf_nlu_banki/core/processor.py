...
from bf_nlu_banki.core.http_interpreter import bf_nlu_bankiNLUHttpInterpreter
from bf_nlu_banki.engine import loader
from bf_nlu_banki.engine.constants import PLACEHOLDER_MESSAGE, PLACEHOLDER_TRACKER
from bf_nlu_banki.engine.runner.dask import DaskGraphRunner
from bf_nlu_banki.engine.storage.local_model_storage import LocalModelStorage
from bf_nlu_banki.engine.storage.storage import ModelMetadata
from bf_nlu_banki.model import get_latest_model
from bf_nlu_banki.shared.data import TrainingType
import bf_nlu_banki.shared.utils.io
import bf_nlu_banki.core.actions.action
from bf_nlu_banki.core import jobs
from bf_nlu_banki.core.actions.action import Action
...
from bf_nlu_banki.engine.runner.interface import GraphRunner
from bf_nlu_banki.exceptions import ActionLimitReached, ModelNotFound
...
from bf_nlu_banki.core.nlg import NaturalLanguageGenerator
from bf_nlu_banki.core.lock_store import LockStore
import bf_nlu_banki.core.tracker_store
import bf_nlu_banki.core.actions.action
import bf_nlu_banki.shared.core.trackers
...
class MessageProcessor:
    ...
    def __init__(
        ...
        tracker_store: bf_nlu_banki.core.tracker_store.TrackerStore,
        lock_store: LockStore,
        generator: NaturalLanguageGenerator,
        action_endpoint: Optional[EndpointConfig] = None,
        max_number_of_predictions: int = MAX_NUMBER_OF_PREDICTIONS,
        on_circuit_break: Optional[LambdaType] = None,
        http_interpreter: Optional[bf_nlu_bankiNLUHttpInterpreter] = None,
    ) -> None:
    ...
    async def run_action_extract_slots(
        ...
        """
        action_extract_slots = bf_nlu_banki.core.actions.action.action_for_name_or_text(
    ...
    async def get_trackers_for_all_conversation_sessions(
        ...
        return bf_nlu_banki.shared.core.trackers.get_trackers_for_conversation_sessions(tracker)
    ...
    def predict_next_with_tracker_if_should(
    ...
    ) -> Tuple[bf_nlu_banki.core.actions.action.Action, PolicyPrediction]:
        ...
        action = bf_nlu_banki.core.actions.action.action_for_index(
    ...
    ) -> Optional[bf_nlu_banki.core.actions.action.Action]:
        return bf_nlu_banki.core.actions.action.action_for_name_or_text(
    ...
    async def _run_action(
        self,
        action: bf_nlu_banki.core.actions.action.Action,
        tracker: DialogueStateTracker,
        output_channel: OutputChannel,
        nlg: NaturalLanguageGenerator,
        prediction: PolicyPrediction,
        ...
        except bf_nlu_banki.core.actions.action.ActionExecutionRejection:
            events = [
                ActionExecutionRejected(
    ...
    def _predict_next_with_tracker(
        ...
        if followup_action:
            ...
            logger.error(
                ...
                "Instead of running that, bf_nlu_banki Open Source will ignore the action "
