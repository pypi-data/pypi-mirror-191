...
from bf_nlu_banki.shared.core.training_data import loading
...
def visualize(
    ...
    """
    import bf_nlu_banki.shared.core.training_data.visualization
    ...
    if nlu_data_path is not None:
        ...
        nlu_training_data = bf_nlu_banki.shared.nlu.training_data.loading.load_data(
            nlu_data_path
        )
    else:
    ...
    bf_nlu_banki.shared.core.training_data.visualization.visualize_stories(
        story_steps,
        domain,
        output_path,
        max_history,
