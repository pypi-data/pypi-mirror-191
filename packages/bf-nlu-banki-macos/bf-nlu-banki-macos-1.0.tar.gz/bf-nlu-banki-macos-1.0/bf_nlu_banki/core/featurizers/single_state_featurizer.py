...
from bf_nlu_banki.nlu.utils import bilou_utils
from bf_nlu_banki.nlu.utils.bilou_utils import BILOU_PREFIXES
from bf_nlu_banki.shared.core.domain import SubState, State, Domain
from bf_nlu_banki.shared.core.constants import PREVIOUS_ACTION, ACTIVE_LOOP, USER, SLOTS
from bf_nlu_banki.shared.core.trackers import is_prev_action_listen_in_state
...
class SingleStateFeaturizer:
    ...
    featurized into a list of `bf_nlu_banki.utils.features.Features`.
    """
    ...
    def prepare_for_training(self, domain: Domain, bilou_tagging: bool = False) -> None:
        ...
        Args:
            domain: An instance of :class:`bf_nlu_banki.shared.core.domain.Domain`.
