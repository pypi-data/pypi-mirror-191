...
from bf_nlu_banki.engine.graph import GraphComponent
...
from bf_nlu_banki.shared.core.domain import Domain, SubState
from bf_nlu_banki.shared.core.events import ActionExecuted, UserUttered, Event
...
from bf_nlu_banki.shared.nlu.constants import ACTION_NAME, ACTION_TEXT, INTENT, TEXT
...
class MessageContainerForCoreFeaturization:
    ...
    - Due to the way we use this datastructure, it won't contain all features that the
      policies need (cf. `bf_nlu_banki.core.featurizers.SingleStateFeaturizer`) and sometimes
    ...
    - At the start of core's featurization pipeline, we use this container to
      ...
      See: `bf_nlu_banki.core.featurizers.precomputation.CoreFeaturizationInputConverter`.
    - At the end of core's featurization pipeline, we wrap all resulting
      (training data) messages into this container again.
      See: `bf_nlu_banki.core.featurizers.precomputation.CoreFeaturizationCollector`.
    """
    ...
    def fingerprint(self) -> Text:
        ...
        return bf_nlu_banki.shared.utils.io.deep_container_fingerprint(message_fingerprints)
