...
from bf_nlu_banki.core.channels.channel import OutputChannel, UserMessage
from bf_nlu_banki.core.constants import DEFAULT_REQUEST_TIMEOUT
...
from bf_nlu_banki.core.exceptions import AgentNotReady
from bf_nlu_banki.shared.constants import DEFAULT_SENDER_ID
from bf_nlu_banki.core.lock_store import InMemoryLockStore, LockStore
from bf_nlu_banki.core.nlg import NaturalLanguageGenerator, TemplatedNaturalLanguageGenerator
from bf_nlu_banki.core.policies.policy import PolicyPrediction
from bf_nlu_banki.core.processor import MessageProcessor
from bf_nlu_banki.core.tracker_store import FailSafeTrackerStore, InMemoryTrackerStore
...
from bf_nlu_banki.nlu.utils import is_url
...
def _load_and_set_updated_model(
    ...
    Args:
        ...
        model_directory: bf_nlu_banki model directory.
...
async def _update_model_from_server(model_server: EndpointConfig, agent: Agent) -> None:
    """Load a zipped bf_nlu_banki Core model from a URL and update the passed agent."""
...
async def load_agent(
    ...
    if endpoints:
        ...
        if endpoints.nlu:
            http_interpreter = bf_nlu_bankiNLUHttpInterpreter(endpoints.nlu)
...
class Agent:
    """The Agent class provides an interface for the most important bf_nlu_banki functionality.
    ...
    async def parse_message(self, message_data: Text) -> Dict[Text, Any]:
        ...
        Returns:
            ...
            Example:
                ...
                {\
                    "text": '/greet{"name":"bf_nlu_banki"}',\
                    "intent": {"name": "greet", "confidence": 1.0},\
                    "intent_ranking": [{"name": "greet", "confidence": 1.0}],\
                    "entities": [{"entity": "name", "start": 6,\
                                  "end": 21, "value": "bf_nlu_banki"}],\
                }
    ...
    def load_model_from_remote_storage(self, model_name: Text) -> None:
        ...
        from bf_nlu_banki.nlu.persistor import get_persistor
