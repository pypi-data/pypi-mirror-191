...
from bf_nlu_banki.core.channels.channel import InputChannel, OutputChannel, UserMessage
from bf_nlu_banki.shared.constants import DOCS_URL_CONNECTORS_SLACK
...
class SlackInput(InputChannel):
    ...
    def _sanitize_user_message(
        ...
        # <mailto:xyz@bf_nlu_banki.com|xyz@bf_nlu_banki.com> or
