...
import bf_nlu_banki.core.channels.channel
...
class bf_nlu_bankiChatInput(RestInput):
    """Chat input channel for bf_nlu_banki X"""
            ...
            async with session.get(
                ...
                if public_key_field in rjs:
                    ...
                    logger.error(
                        ...
                        "you use an up-to-date version of bf_nlu_banki X (>= 0.20.2). "
                        "Response was: {}"
    ...
    async def _decode_bearer_token(self, bearer_token: Text) -> Optional[Dict]:
        ...
        try:
            return bf_nlu_banki.core.channels.channel.decode_jwt(
    ...
    async def _extract_sender(self, req: Request) -> Optional[Text]:
        """Fetch user from the bf_nlu_banki X Admin API."""
        jwt_payload = None
