...
from bf_nlu_banki.shared.constants import DOCS_BASE_URL, DEFAULT_SENDER_ID
from bf_nlu_banki.core.constants import BEARER_TOKEN_PREFIX
...
class UserMessage:
    ...
    def __init__(
        ...
        Args:
            ...
            parse_data: bf_nlu_banki data about the message.
...
class InputChannel:
    ...
    def get_output_channel(self) -> Optional["OutputChannel"]:
        ...
        ``OutputChannel`` this can be used by bf_nlu_banki to send bot responses to the user
