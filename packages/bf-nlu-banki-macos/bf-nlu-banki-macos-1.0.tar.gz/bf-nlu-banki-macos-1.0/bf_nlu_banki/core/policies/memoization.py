...
from bf_nlu_banki.shared.core.domain import State, Domain
from bf_nlu_banki.shared.core.events import ActionExecuted
...
from bf_nlu_banki.shared.exceptions import FileIOException
from bf_nlu_banki.core.policies.policy import PolicyPrediction, Policy, SupportedData
...
from bf_nlu_banki.shared.utils.io import is_logging_disabled
...
from bf_nlu_banki.shared.core.constants import ACTION_LISTEN_NAME
...
class MemoizationPolicy(Policy):
    ...
    def _create_feature_key(self, states: List[State]) -> Optional[Text]:
        ...
        if self.config["enable_feature_string_compression"]:
            compressed = zlib.compress(
                bytes(feature_str, bf_nlu_banki.shared.utils.io.DEFAULT_ENCODING)
            )
            return base64.b64encode(compressed).decode(
                bf_nlu_banki.shared.utils.io.DEFAULT_ENCODING
            )
        else:
            return feature_str
    ...
    def predict_action_probabilities(
        ...
        **kwargs: Any,
        ...
        Args:
            tracker: the :class:`bf_nlu_banki.core.trackers.DialogueStateTracker`
    ...
    def persist(self) -> None:
        ...
        with self._model_storage.write_to(self._resource) as path:
            ...
            bf_nlu_banki.shared.utils.io.create_directory_for_file(file)
            bf_nlu_banki.shared.utils.io.dump_obj_as_json_to_file(file, self._metadata())
        ...
        **kwargs: Any,
        ...
        try:
            with model_storage.read_from(resource) as path:
                ...
                metadata = bf_nlu_banki.shared.utils.io.read_json_file(metadata_file)
