...
class FeatureArray(np.ndarray):
    """Stores any kind of features ready to be used by a bf_nlu_bankiModel.
...
class bf_nlu_bankiModelData:
    """Data object used for all bf_nlu_bankiModels.
    ...
    def __init__(
        ...
        """
        Initializes the bf_nlu_bankiModelData object.
    ...
    def split(
    ...
    ) -> Tuple["bf_nlu_bankiModelData", "bf_nlu_bankiModelData"]:
        ...
        Returns:
            A tuple of train and test bf_nlu_bankiModelData.
        """
    ...
    def get_signature(
        ...
        """Get signature of bf_nlu_bankiModelData.
    ...
    def _split_by_label_ids(
        ...
        Returns:
            Reorganized bf_nlu_bankiModelData
        """
        label_data = []
    ...
    def _check_label_key(self) -> None:
        ...
        if (
            ...
            raise ValueError(
                f"Key '{self.label_key}.{self.label_sub_key}' not in bf_nlu_bankiModelData."
            )
    ...
    def _convert_train_test_split(
        ...
        Returns:
            The test and train bf_nlu_bankiModelData
        """
        ...
        return (
            bf_nlu_bankiModelData(self.label_key, self.label_sub_key, data_train),
            bf_nlu_bankiModelData(self.label_key, self.label_sub_key, data_val),
        )
