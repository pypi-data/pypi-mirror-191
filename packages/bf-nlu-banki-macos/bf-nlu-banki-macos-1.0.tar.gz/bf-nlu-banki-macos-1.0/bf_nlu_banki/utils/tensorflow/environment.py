...
from bf_nlu_banki.utils.tensorflow.constants import TF_DETERMINISTIC_OPS
from bf_nlu_banki.shared.utils import io as shared_io_utils
...
def _parse_gpu_config(gpu_memory_config: Text) -> Dict[int, int]:
    ...
    try:
        ...
        raise ValueError(
            ...
            f"'{ENV_GPU_CONFIG}' at https://bf_nlu_banki.com/docs/bf_nlu_banki/tuning-your-model"
