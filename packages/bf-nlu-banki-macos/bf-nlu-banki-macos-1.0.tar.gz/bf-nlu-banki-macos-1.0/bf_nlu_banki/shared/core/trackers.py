...
from bf_nlu_banki.shared.core.slots import AnySlot, Slot

if TYPE_CHECKING:
    from bf_nlu_banki.shared.core.events import NLUPredictionData
    from bf_nlu_banki.shared.core.training_data.structures import Story
...
class DialogueStateTracker:
    ...
    def as_story(self, include_source: bool = False) -> "Story":
        """Dump the tracker as a story in the bf_nlu_banki Core story format.
    ...
    def fingerprint(self) -> Text:
        ...
        return bf_nlu_banki.shared.utils.io.get_dictionary_fingerprint(data)
