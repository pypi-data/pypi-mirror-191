...
from bf_nlu_banki.shared.constants import DOCS_URL_STORIES
from bf_nlu_banki.shared.core.constants import SHOULD_NOT_BE_SET
...
from bf_nlu_banki.shared.core.trackers import DialogueStateTracker, FrozenState
from bf_nlu_banki.shared.core.slots import Slot
...
class TrackerWithCachedStates(DialogueStateTracker):
    ...
    def past_states_for_hashing(
        ...
        Args:
            domain: a :class:`bf_nlu_banki.shared.core.domain.Domain`
