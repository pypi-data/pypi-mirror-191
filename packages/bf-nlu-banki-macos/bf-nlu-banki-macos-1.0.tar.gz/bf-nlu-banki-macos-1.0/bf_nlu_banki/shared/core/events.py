...
from bf_nlu_banki.shared.constants import DOCS_URL_TRAINING_DATA
...
from bf_nlu_banki.shared.exceptions import UnsupportedFeatureException
...
class Event(ABC):
    ...
    user with the assistant. Tells the `bf_nlu_banki.shared.core.trackers.DialogueStateTracker`
    ...
    def resolve_by_type(
        ...
        for cls in bf_nlu_banki.shared.utils.common.all_subclasses(Event):
...
class LegacyForm(ActiveLoop):
    ...
    def fingerprint(self) -> Text:
        ...
        del d["timestamp"]
        return bf_nlu_banki.shared.utils.io.get_dictionary_fingerprint(d)
