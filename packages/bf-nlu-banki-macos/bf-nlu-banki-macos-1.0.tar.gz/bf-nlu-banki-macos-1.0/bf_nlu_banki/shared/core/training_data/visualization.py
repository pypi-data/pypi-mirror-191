...
from bf_nlu_banki.shared.core.events import UserUttered, ActionExecuted, Event
from bf_nlu_banki.shared.core.generator import TrainingDataGenerator
from bf_nlu_banki.shared.core.training_data.structures import StoryGraph, StoryStep
...
def persist_graph(graph: "networkx.Graph", output_file: Text) -> None:
    ...
    template = bf_nlu_banki.shared.utils.io.read_file(visualization_html_path())
    ...
    bf_nlu_banki.shared.utils.io.write_text_file(template, output_file)
...
def visualize_stories(
    ...
    The training data parameter can be used to pass in a bf_nlu_banki NLU training
