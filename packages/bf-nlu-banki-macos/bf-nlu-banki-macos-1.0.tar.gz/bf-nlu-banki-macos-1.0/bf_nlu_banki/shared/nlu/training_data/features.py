...
from bf_nlu_banki.shared.nlu.constants import FEATURE_TYPE_SEQUENCE, FEATURE_TYPE_SENTENCE
...
class Features:
    ...
    def fingerprint(self) -> Text:
        ...
        if self.is_dense():
            ...
            f_as_text = bf_nlu_banki.shared.nlu.training_data.util.sparse_matrix_to_string(
                self.features
            )
