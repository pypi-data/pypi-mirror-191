...
DOCS_BASE_URL = "https://bf_nlu_banki.com/docs/bf_nlu_banki"
LEGACY_DOCS_BASE_URL = "https://legacy-docs-v1.bf_nlu_banki.com"
...
DOCS_URL_MIGRATION_GUIDE_MD_DEPRECATION = (
    f"{DOCS_URL_MIGRATION_GUIDE}#bf_nlu_banki-21-to-bf_nlu_banki-22"
)
DOCS_URL_TELEMETRY = DOCS_BASE_URL + "/telemetry/telemetry"
DOCS_BASE_URL_bf_nlu_banki_X = "https://bf_nlu_banki.com/docs/bf_nlu_banki-x"
DOCS_BASE_URL_ACTION_SERVER = "https://bf_nlu_banki.com/docs/action-server"

INTENT_MESSAGE_PREFIX = "/"

PACKAGE_NAME = "bf_nlu_banki"
...
# Constants for default bf_nlu_banki Open Source project layout
