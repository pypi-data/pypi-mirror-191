...
from bf_nlu_banki.core.evaluation.marker_tracker_loader import MarkerTrackerLoader
from bf_nlu_banki.core.evaluation.marker_base import Marker, OperatorMarker
from bf_nlu_banki.shared.core.domain import Domain
from bf_nlu_banki.cli import SubParsersAction
import bf_nlu_banki.cli.arguments.evaluate as arguments
...
def _run_markers(
    ...
    try:
        ...
        bf_nlu_banki.shared.utils.cli.print_error_and_exit(message=str(e))
