...
from bf_nlu_banki.nlu.featurizers.sparse_featurizer.sparse_featurizer import SparseFeaturizer
from bf_nlu_banki.nlu.utils.spacy_utils import SpacyModel
from bf_nlu_banki.shared.constants import DOCS_URL_COMPONENTS
...
from bf_nlu_banki.shared.nlu.constants import TEXT, INTENT, INTENT_RESPONSE_KEY, ACTION_NAME
...
class CountVectorsFeaturizer(SparseFeaturizer, GraphComponent):
    ...
    def _merge_new_vocabulary_tokens(
        ...
        Raises:
            bf_nlu_bankiException: if `use_shared_vocab` is set to True and there are new
        ...
        **kwargs: Any,
        ...
        try:
            with model_storage.read_from(resource) as model_dir:
                ...
                oov_words = bf_nlu_banki.shared.utils.io.read_json_file(
