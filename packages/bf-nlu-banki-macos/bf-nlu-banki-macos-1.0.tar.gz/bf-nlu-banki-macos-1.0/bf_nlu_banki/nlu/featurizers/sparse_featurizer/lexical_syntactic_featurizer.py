...
from bf_nlu_banki.nlu.tokenizers.spacy_tokenizer import POS_TAG_KEY, SpacyTokenizer
...
class LexicalSyntacticFeaturizer(SparseFeaturizer, GraphComponent):
        ...
        **kwargs: Any,
        ...
        try:
            with model_storage.read_from(resource) as model_path:
                feature_to_idx_dict = bf_nlu_banki.utils.io.json_unpickle(
    ...
    def persist(self) -> None:
        ...
        with self._model_storage.write_to(self._resource) as model_path:
            bf_nlu_banki.utils.io.json_pickle(
