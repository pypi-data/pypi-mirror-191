...
import bf_nlu_banki.utils.endpoints as endpoints_utils
...
from bf_nlu_banki.shared.nlu.constants import ENTITIES, TEXT
...
def convert_duckling_format_to_bf_nlu_banki(
...
class DucklingEntityExtractor(GraphComponent, EntityExtractorMixin):
    ...
    def _url(self) -> Optional[Text]:
        ...
        if os.environ.get("bf_nlu_banki_DUCKLING_HTTP_URL"):
            return os.environ["bf_nlu_banki_DUCKLING_HTTP_URL"]
    ...
    def process(self, messages: List[Message]) -> List[Message]:
        ...
        if self._url() is None:
            bf_nlu_banki.shared.utils.io.raise_warning(
                ...
                "file nor is `bf_nlu_banki_DUCKLING_HTTP_URL` "
        ...
        for message in messages:
            ...
            all_extracted = convert_duckling_format_to_bf_nlu_banki(matches)
            dimensions = self.component_config["dimensions"]
