...
from bf_nlu_banki.shared.nlu.training_data import util
...
from bf_nlu_banki.nlu.classifiers.diet_classifier import (
    DIET,
    LABEL_KEY,
    LABEL_SUB_KEY,
    SENTENCE,
...
from bf_nlu_banki.utils.tensorflow.model_data import bf_nlu_bankiModelData
        ...
        **kwargs: Any,
        ...
        try:
            with model_storage.read_from(resource) as model_path:
                ...
                responses = bf_nlu_banki.shared.utils.io.read_json_file(
                    model_path / f"{file_name}.responses.json"
                )
                all_retrieval_intents = bf_nlu_banki.shared.utils.io.read_json_file(
                    model_path / f"{file_name}.retrieval_intents.json"
                )
