...
from bf_nlu_banki.shared.constants import DEFAULT_NLU_FALLBACK_INTENT_NAME
...
class FallbackClassifier(GraphComponent, IntentClassifier):
    ...
    def process(self, messages: List[Message]) -> List[Message]:
        ...
        by a call to :meth:`bf_nlu_banki.nlu.components.Component.create`
        of ANY component and
        on any context attributes created by a call to
        :meth:`bf_nlu_banki.nlu.components.Component.process`
        of components previous to this one.

        Args:
            messages: List containing :class:
            `bf_nlu_banki.shared.nlu.training_data.message.Message` to process.
        """
