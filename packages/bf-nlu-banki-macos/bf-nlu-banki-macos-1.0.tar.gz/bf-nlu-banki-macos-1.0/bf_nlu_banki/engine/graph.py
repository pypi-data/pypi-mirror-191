...
from bf_nlu_banki.engine.exceptions import GraphComponentException, GraphSchemaException
    ...
    def from_dict(cls, serialized_graph_schema: Dict[Text, Any]) -> GraphSchema:
        ...
        for node_name, serialized_node in serialized_graph_schema["nodes"].items():
            try:
                serialized_node[
                    "uses"
                ] = bf_nlu_banki.shared.utils.common.class_from_module_path(
...
class GraphNode:
    ...
    def __init__(
        ...
        self._component_config: Dict[Text, Any] = bf_nlu_banki.utils.common.override_defaults(
    ...
    def _load_component(self, **kwargs: Any) -> None:
        ...
        try:
            ...
            if not isinstance(e, bf_nlu_bankiException):
    ...
    def __call__(
        ...
        if not self._eager:
            constructor_kwargs = bf_nlu_banki.shared.utils.common.minimal_kwargs(
