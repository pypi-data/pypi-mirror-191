...
class InvalidRecipeException(bf_nlu_bankiException):
...
class Recipe(abc.ABC):
    ...
    def recipe_for_name(name: Optional[Text]) -> Recipe:
        ...
        from bf_nlu_banki.engine.recipes.graph_recipe import GraphV1Recipe

        if name is None:
            bf_nlu_banki.shared.utils.io.raise_deprecation_warning(
                "From bf_nlu_banki Open Source 4.0.0 onwards it will be required to specify "
