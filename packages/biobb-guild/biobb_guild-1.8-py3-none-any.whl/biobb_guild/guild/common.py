...
def guild(algorithm, path_guild, nodes, interactome, output_path, out_log, global_log):
    if algorithm == "s":
        ...
        if len(os.listdir(rand_net))==0:
            rand_interactomes = create_randomized_networks(path_guild+"/src/create_random_networks_for_netzcore.py", interactome, path_guild+"/RandomizedNetworks/")
        run_netzcore(path_guild, nodes, interactome, path_guild+"/RandomizedNetworks/interactome.sif.", output_path+"/output_netZcore")
