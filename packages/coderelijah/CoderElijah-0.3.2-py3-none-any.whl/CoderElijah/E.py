...
def rickRoll(fileName='short', timePerLine=2, infinity="yes"):
  ...
  `infinity`:This determines whether or not the function loops forever and ever (default: "yes")'''
...
def showTextFor(fileName='help', timeToShow=10):
  '''Parameters:
  `fileName`: The name of the text file you use (leave blank for "HELP ME" in ASCII)
...
def showTextFile(fileName, startLine="", endLine=""):
  '''Show lines x-y of a text file (for titles and such)
  `fileName`: The name of the file
  `startLine`: The starting line number of your text
  `endLine`: The ending line number of your text
  Note that if `startLine` and `endLine` are left blank, it shows the whole text file.'''
  rick = open(fileName)
  contents = rick.readlines()
  if startLine == "":
    startLine = 0
...
def addStorage(fileName, store, append=''):
  ...
  `append`: Whether it erases the file or appends it (default: "w"). It is not generally recommended to change this default.'''
