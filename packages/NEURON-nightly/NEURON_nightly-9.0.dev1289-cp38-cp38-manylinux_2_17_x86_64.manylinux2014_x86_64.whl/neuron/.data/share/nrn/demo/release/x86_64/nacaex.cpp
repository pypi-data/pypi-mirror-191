...
#define _ion_ena	*(_ppvar[3].get<double*>())
#define _ion_ina	*_ppvar[4].get<double*>()
#define _ion_dinadv	*_ppvar[5].get<double*>()
...
static void nrn_alloc(Prop* _prop) {
 ...
 nrn_promote(prop_ion, 0, 1);
 	_ppvar[3] = &prop_ion->param[0]; /* ena */
 	_ppvar[4] = &prop_ion->param[3]; /* ina */
 	_ppvar[5] = &prop_ion->param[4]; /* _ion_dinadv */
