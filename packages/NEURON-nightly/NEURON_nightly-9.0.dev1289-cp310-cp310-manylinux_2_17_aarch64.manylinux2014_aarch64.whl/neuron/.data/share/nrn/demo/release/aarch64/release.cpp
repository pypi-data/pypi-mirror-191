...
/*static int _ode_matsol1(_threadargsproto_);*/
 ...
 static int release (void* _so, double* _rhs, _threadargsproto_);
...
static void _ode_matsol_instance1(_threadargsproto_) {
 _cvode_sparse_thread(&(_thread[_cvspth1].literal_value<void*>()), 4, _dlist1, _p, _ode_matsol1, _p, _ppvar, _thread, _nt);
 }
...
{
  cai = _ion_cai;
 {  sparse_thread(&(_thread[_spth1].literal_value<void*>()), 4, _slist1, _dlist1, _p, &t, dt, release, _linmat1, _p, _ppvar, _thread, _nt);
     if (secondorder) {
    int _i;
    for (_i = 0; _i < 4; ++_i) {
