...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 static double *_t_bh;
static int _reset;
static const char *modelname = "Moore-Cox sodium channel";
...
#define _linmat1  1
 ...
 static int states (void* _so, double* _rhs, _threadargsproto_);
...
static void _ode_matsol_instance1(_threadargsproto_) {
 _cvode_sparse_thread(&(_thread[_cvspth1].literal_value<void*>()), 5, _dlist1, _p, _ode_matsol1, _p, _ppvar, _thread, _nt);
 }
...
static void initmodel(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) {
  ...
  P = P0;
 {
   ...
   P = 1.0 ;
   rate ( _threadargscomma_ v * 1.0 ) ;
    _ss_sparse_thread(&(_thread[_spth1].literal_value<void*>()), 5, _slist1, _dlist1, _p, &t, dt, states, _linmat1, _p, _ppvar, _thread, _nt);
     if (secondorder) {
    int _i;
    for (_i = 0; _i < 5; ++_i) {
...
{
  ena = _ion_ena;
 {  sparse_thread(&(_thread[_spth1].literal_value<void*>()), 5, _slist1, _dlist1, _p, &t, dt, states, _linmat1, _p, _ppvar, _thread, _nt);
     if (secondorder) {
    int _i;
    for (_i = 0; _i < 5; ++_i) {
      _p[_slist1[_i]] += dt*_p[_dlist1[_i]];
