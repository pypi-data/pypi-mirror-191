...
class UnsupervisedGUI(object):
    def __init__(self,
        ...
        self.clf_slice_options = ['ALL FRAMES', 'ALL CLASSIFIERS PRESENT']
        ...
        self.dim_reduction_fit_btn = Button(self.dim_reduction_frm, text='FIT DIMENSIONALITY REDUCTION MODELS', fg='blue', command= lambda: FitDimReductionPopUp())
        self.dim_reduction_transform_btn = Button(self.dim_reduction_frm, text='TRANSFORM', fg='blue', command= lambda: TransformDimReductionPopUp())
        ...
        self.cluster_fit_btn = Button(self.clustering_frm, text='FIT CLUSTERING MODELS', fg='blue', command= lambda: FitClusterModelsPopUp())
