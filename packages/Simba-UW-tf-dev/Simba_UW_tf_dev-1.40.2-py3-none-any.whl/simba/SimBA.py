...
class loadprojectini:
    ...
    def pupMenu(self):
        ...
        button_run = Button(puptoplvl,text='RUN',font=Formats.LABELFRAME_HEADER_FORMAT.value,fg='red',command= lambda: pup_retrieval_1(self.projectconfigini,
                                                                                                                                       float(prob_pup.entry_get),
                                                                                                                                       float(prob_mom.entry_get),
                                                                                                                                       float(dist_start.entry_get),
                                                                                                                                       float(carry_frames_seconds.entry_get),
                                                                                                                                       float(smooth_factor.entry_get),
                                                                                                                                       corenest_name.entry_get,
                                                                                                                                       nest_name.entry_get,
                                                                                                                                       dam_name.entry_get,
                                                                                                                                       pup_name.entry_get,
                                                                                                                                       smooth_function.entry_get,
                                                                                                                                       int(max_time.entry_get),
                                                                                                                                       carry_classifier_name.entry_get,
                                                                                                                                       approach_classifier_name.entry_get,
