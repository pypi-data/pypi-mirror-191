...
def HDBSCANTransform(embedding_model_path: str,
    ...
    if settings['save_format'] is 'csv':
        ...
        embedding_data.to_csv(save_path)

    elif settings['save_format'] is 'parquet':
        save_path = os.path.join(save_dir, f'transformed_{input["clusterer"]["NAME"]}.parquet')
        embedding_data.to_parquet(save_path)

    timer.stop_timer()
    print(f'SIMBA COMPLETE: Fitted HDBSCAN results saved at {save_path} (elapsed time: {timer.elapsed_time_str}s)')


settings = {'feature_values': True, 'scaled_features': True, 'save_format': 'csv'}
embeccing_path = '/Users/simon/Desktop/envs/troubleshooting/unsupervised/dr_models/vibrant_davinci.pickle'
clusterer_model_path = '/Users/simon/Desktop/envs/troubleshooting/unsupervised/cluster_models/distracted_germain.pickle'
data_path = '/Users/simon/Desktop/envs/troubleshooting/unsupervised/project_folder/logs/unsupervised_data_20230210103414.pickle'
save_path = '/Users/simon/Desktop/envs/troubleshooting/unsupervised/dr_models'

_ = HDBSCANTransform(embedding_model_path=embeccing_path,
