...
class topic_modeling_preprocess():
    ...
    def __init__(self, original_data, stopwords_extension=[], lang="english"):
        ...
        self.nlp = spacy.load(topic_modeling_preprocess.LANG_SPACY_MAP[lang], disable=['parser', 'ner'])
    ...
    def remove_stopwords(self):
        ...
        self.data_words = [[word for word in simple_preprocess(str(doc), deacc=False) if (word not in self.stop_words)] for doc in self.data_words]
