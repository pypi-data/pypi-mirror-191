...
class SmarterSender:
    ...
    def query_data_lake(self, sql_query: str, args=None, paramstyle: str = "format", commit=True) -> Tuple:
        """
    ...
    def write_dataframe_to_lake(self, df, table_name: str) -> None:
        """
        ...
        Args:
         ...
         """
        self.__db.write_from_dataframe(df=df, table_name=table_name)

    def bulk_insert_to_lake(self, file_name: str, table_name: str, delimiter: str, column_names: List[str],
                            parameter_indices: List[int], batch_size: int = 1) -> None:
        """
        Runs a single bulk insert statement into the data lake from a CSV FILE.
        Args:
             :param file_name: str
        ...
        self.__db.bulk_insert(file_name=file_name,
