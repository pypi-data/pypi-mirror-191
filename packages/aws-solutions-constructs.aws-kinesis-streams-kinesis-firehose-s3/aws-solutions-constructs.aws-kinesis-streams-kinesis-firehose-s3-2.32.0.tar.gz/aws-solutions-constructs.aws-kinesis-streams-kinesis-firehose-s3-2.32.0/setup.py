    ...
    """
{
    ...
    "package_data": {
        "aws_solutions_constructs.aws_kinesis_streams_kinesis_firehose_s3._jsii": [
            "aws-kinesisstreams-kinesisfirehose-s3@2.32.0.jsii.tgz"
        ],
        "aws_solutions_constructs.aws_kinesis_streams_kinesis_firehose_s3": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-solutions-constructs.aws-kinesis-firehose-s3==2.32.0",
        "aws-solutions-constructs.aws-kinesis-streams-lambda==2.32.0",
