...
class OcbAgentSvcClient(object):
    ...
    def add_agent_dependency(self, environment_id, add_agent_dependency_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/add_agent_dependency.py.html>`__ to see an example of how to use add_agent_dependency API.
        """
    ...
    def change_agent_compartment(self, agent_id, change_agent_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/change_agent_compartment.py.html>`__ to see an example of how to use change_agent_compartment API.
        """
    ...
    def change_agent_dependency_compartment(self, agent_dependency_id, change_agent_dependency_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/change_agent_dependency_compartment.py.html>`__ to see an example of how to use change_agent_dependency_compartment API.
        """
    ...
    def change_environment_compartment(self, environment_id, change_environment_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/change_environment_compartment.py.html>`__ to see an example of how to use change_environment_compartment API.
        """
    ...
    def create_agent(self, create_agent_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/create_agent.py.html>`__ to see an example of how to use create_agent API.
        """
    ...
    def create_agent_dependency(self, create_agent_dependency_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/create_agent_dependency.py.html>`__ to see an example of how to use create_agent_dependency API.
        """
    ...
    def create_environment(self, create_environment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/create_environment.py.html>`__ to see an example of how to use create_environment API.
        """
    ...
    def delete_agent(self, agent_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/delete_agent.py.html>`__ to see an example of how to use delete_agent API.
        """
    ...
    def delete_agent_dependency(self, agent_dependency_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/delete_agent_dependency.py.html>`__ to see an example of how to use delete_agent_dependency API.
        """
    ...
    def delete_environment(self, environment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/delete_environment.py.html>`__ to see an example of how to use delete_environment API.
        """
    ...
    def get_agent(self, agent_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/get_agent.py.html>`__ to see an example of how to use get_agent API.
        """
        resource_path = "/agents/{agentId}"
        method = "GET"
    ...
    def get_agent_dependency(self, agent_dependency_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/get_agent_dependency.py.html>`__ to see an example of how to use get_agent_dependency API.
        """
        resource_path = "/agentDependencies/{agentDependencyId}"
        method = "GET"
    ...
    def get_environment(self, environment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/get_environment.py.html>`__ to see an example of how to use get_environment API.
        """
        resource_path = "/environments/{environmentId}"
        method = "GET"
    ...
    def get_plugin(self, agent_id, plugin_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/get_plugin.py.html>`__ to see an example of how to use get_plugin API.
        """
    ...
    def list_agent_dependencies(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/list_agent_dependencies.py.html>`__ to see an example of how to use list_agent_dependencies API.
        """
        resource_path = "/agentDependencies"
        method = "GET"
    ...
    def list_agents(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/list_agents.py.html>`__ to see an example of how to use list_agents API.
        """
        resource_path = "/agents"
        method = "GET"
    ...
    def list_appliance_images(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/list_appliance_images.py.html>`__ to see an example of how to use list_appliance_images API.
        """
    ...
    def list_environments(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/list_environments.py.html>`__ to see an example of how to use list_environments API.
        """
        resource_path = "/environments"
        method = "GET"
    ...
    def remove_agent_dependency(self, environment_id, remove_agent_dependency_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/remove_agent_dependency.py.html>`__ to see an example of how to use remove_agent_dependency API.
        """
    ...
    def update_agent(self, agent_id, update_agent_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/update_agent.py.html>`__ to see an example of how to use update_agent API.
        """
        resource_path = "/agents/{agentId}"
        method = "PUT"
    ...
    def update_agent_dependency(self, agent_dependency_id, update_agent_dependency_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/update_agent_dependency.py.html>`__ to see an example of how to use update_agent_dependency API.
        """
        resource_path = "/agentDependencies/{agentDependencyId}"
        method = "PUT"
    ...
    def update_environment(self, environment_id, update_environment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/update_environment.py.html>`__ to see an example of how to use update_environment API.
        """
        resource_path = "/environments/{environmentId}"
        method = "PUT"
    ...
    def update_plugin(self, agent_id, plugin_name, update_plugin_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/update_plugin.py.html>`__ to see an example of how to use update_plugin API.
        """
        resource_path = "/agents/{agentId}/plugins/{pluginName}"
        method = "PUT"
