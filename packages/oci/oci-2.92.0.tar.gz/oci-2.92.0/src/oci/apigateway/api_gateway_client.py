...
class ApiGatewayClient(object):
    ...
    def change_api_compartment(self, api_id, change_api_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/apigateway/change_api_compartment.py.html>`__ to see an example of how to use change_api_compartment API.
        """
    ...
    def change_certificate_compartment(self, certificate_id, change_certificate_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/apigateway/change_certificate_compartment.py.html>`__ to see an example of how to use change_certificate_compartment API.
        """
    ...
    def create_api(self, create_api_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/apigateway/create_api.py.html>`__ to see an example of how to use create_api API.
        """
        resource_path = "/apis"
        method = "POST"
    ...
    def create_certificate(self, create_certificate_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/apigateway/create_certificate.py.html>`__ to see an example of how to use create_certificate API.
        """
    ...
    def create_sdk(self, create_sdk_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/apigateway/create_sdk.py.html>`__ to see an example of how to use create_sdk API.
        """
        resource_path = "/sdks"
        method = "POST"
    ...
    def delete_api(self, api_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/apigateway/delete_api.py.html>`__ to see an example of how to use delete_api API.
        """
    ...
    def delete_certificate(self, certificate_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/apigateway/delete_certificate.py.html>`__ to see an example of how to use delete_certificate API.
        """
    ...
    def delete_sdk(self, sdk_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/apigateway/delete_sdk.py.html>`__ to see an example of how to use delete_sdk API.
        """
    ...
    def get_api(self, api_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/apigateway/get_api.py.html>`__ to see an example of how to use get_api API.
        """
        resource_path = "/apis/{apiId}"
        method = "GET"
    ...
    def get_api_content(self, api_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/apigateway/get_api_content.py.html>`__ to see an example of how to use get_api_content API.
        """
    ...
    def get_api_deployment_specification(self, api_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/apigateway/get_api_deployment_specification.py.html>`__ to see an example of how to use get_api_deployment_specification API.
        """
    ...
    def get_api_validations(self, api_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/apigateway/get_api_validations.py.html>`__ to see an example of how to use get_api_validations API.
        """
    ...
    def get_certificate(self, certificate_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/apigateway/get_certificate.py.html>`__ to see an example of how to use get_certificate API.
        """
        resource_path = "/certificates/{certificateId}"
        method = "GET"
    ...
    def get_sdk(self, sdk_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/apigateway/get_sdk.py.html>`__ to see an example of how to use get_sdk API.
        """
        resource_path = "/sdks/{sdkId}"
        method = "GET"
    ...
    def list_apis(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/apigateway/list_apis.py.html>`__ to see an example of how to use list_apis API.
        """
        resource_path = "/apis"
        method = "GET"
    ...
    def list_certificates(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/apigateway/list_certificates.py.html>`__ to see an example of how to use list_certificates API.
        """
        resource_path = "/certificates"
        method = "GET"
    ...
    def list_sdk_language_types(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/apigateway/list_sdk_language_types.py.html>`__ to see an example of how to use list_sdk_language_types API.
        """
    ...
    def list_sdks(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/apigateway/list_sdks.py.html>`__ to see an example of how to use list_sdks API.
        """
        resource_path = "/sdks"
        method = "GET"
    ...
    def update_api(self, api_id, update_api_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/apigateway/update_api.py.html>`__ to see an example of how to use update_api API.
        """
        resource_path = "/apis/{apiId}"
        method = "PUT"
    ...
    def update_certificate(self, certificate_id, update_certificate_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/apigateway/update_certificate.py.html>`__ to see an example of how to use update_certificate API.
        """
        resource_path = "/certificates/{certificateId}"
        method = "PUT"
    ...
    def update_sdk(self, sdk_id, update_sdk_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/apigateway/update_sdk.py.html>`__ to see an example of how to use update_sdk API.
        """
        resource_path = "/sdks/{sdkId}"
        method = "PUT"
