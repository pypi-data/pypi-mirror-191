...
class QueueClient(object):
    ...
    def delete_message(self, queue_id, message_receipt, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/queue/delete_message.py.html>`__ to see an example of how to use delete_message API.
        """
    ...
    def delete_messages(self, queue_id, delete_messages_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/queue/delete_messages.py.html>`__ to see an example of how to use delete_messages API.
        """
    ...
    def get_messages(self, queue_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/queue/get_messages.py.html>`__ to see an example of how to use get_messages API.
        """
    ...
    def get_stats(self, queue_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/queue/get_stats.py.html>`__ to see an example of how to use get_stats API.
        """
    ...
    def put_messages(self, queue_id, put_messages_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/queue/put_messages.py.html>`__ to see an example of how to use put_messages API.
        """
        resource_path = "/queues/{queueId}/messages"
        method = "POST"
    ...
    def update_message(self, queue_id, message_receipt, update_message_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/queue/update_message.py.html>`__ to see an example of how to use update_message API.
        """
        resource_path = "/queues/{queueId}/messages/{messageReceipt}"
        method = "PUT"
    ...
    def update_messages(self, queue_id, update_messages_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/queue/update_messages.py.html>`__ to see an example of how to use update_messages API.
        """
