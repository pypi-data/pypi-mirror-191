...
class UsageapiClient(object):
    ...
    def create_custom_table(self, create_custom_table_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/usageapi/create_custom_table.py.html>`__ to see an example of how to use create_custom_table API.
        """
    ...
    def create_query(self, create_query_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/usageapi/create_query.py.html>`__ to see an example of how to use create_query API.
        """
    ...
    def create_schedule(self, create_schedule_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/usageapi/create_schedule.py.html>`__ to see an example of how to use create_schedule API.
        """
    ...
    def delete_custom_table(self, custom_table_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/usageapi/delete_custom_table.py.html>`__ to see an example of how to use delete_custom_table API.
        """
    ...
    def delete_query(self, query_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/usageapi/delete_query.py.html>`__ to see an example of how to use delete_query API.
        """
    ...
    def delete_schedule(self, schedule_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/usageapi/delete_schedule.py.html>`__ to see an example of how to use delete_schedule API.
        """
    ...
    def get_custom_table(self, custom_table_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/usageapi/get_custom_table.py.html>`__ to see an example of how to use get_custom_table API.
        """
        resource_path = "/customTables/{customTableId}"
        method = "GET"
    ...
    def get_query(self, query_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/usageapi/get_query.py.html>`__ to see an example of how to use get_query API.
        """
        resource_path = "/queries/{queryId}"
        method = "GET"
    ...
    def get_schedule(self, schedule_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/usageapi/get_schedule.py.html>`__ to see an example of how to use get_schedule API.
        """
        resource_path = "/schedules/{scheduleId}"
        method = "GET"
    ...
    def get_scheduled_run(self, scheduled_run_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/usageapi/get_scheduled_run.py.html>`__ to see an example of how to use get_scheduled_run API.
        """
    ...
    def list_custom_tables(self, compartment_id, saved_report_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/usageapi/list_custom_tables.py.html>`__ to see an example of how to use list_custom_tables API.
        """
        resource_path = "/customTables"
        method = "GET"
    ...
    def list_queries(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/usageapi/list_queries.py.html>`__ to see an example of how to use list_queries API.
        """
        resource_path = "/queries"
        method = "GET"
    ...
    def list_scheduled_runs(self, schedule_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/usageapi/list_scheduled_runs.py.html>`__ to see an example of how to use list_scheduled_runs API.
        """
    ...
    def list_schedules(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/usageapi/list_schedules.py.html>`__ to see an example of how to use list_schedules API.
        """
        resource_path = "/schedules"
        method = "GET"
    ...
    def request_summarized_configurations(self, tenant_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/usageapi/request_summarized_configurations.py.html>`__ to see an example of how to use request_summarized_configurations API.
        """
    ...
    def request_summarized_usages(self, request_summarized_usages_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/usageapi/request_summarized_usages.py.html>`__ to see an example of how to use request_summarized_usages API.
        """
        resource_path = "/usage"
        method = "POST"
    ...
    def update_custom_table(self, update_custom_table_details, custom_table_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/usageapi/update_custom_table.py.html>`__ to see an example of how to use update_custom_table API.
        """
        resource_path = "/customTables/{customTableId}"
        method = "PUT"
    ...
    def update_query(self, update_query_details, query_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/usageapi/update_query.py.html>`__ to see an example of how to use update_query API.
        """
        resource_path = "/queries/{queryId}"
        method = "PUT"
    ...
    def update_schedule(self, update_schedule_details, schedule_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/usageapi/update_schedule.py.html>`__ to see an example of how to use update_schedule API.
        """
        resource_path = "/schedules/{scheduleId}"
        method = "PUT"
