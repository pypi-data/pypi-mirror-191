...
class DiscoveryClient(object):
    ...
    def change_asset_source_compartment(self, asset_source_id, change_asset_source_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/change_asset_source_compartment.py.html>`__ to see an example of how to use change_asset_source_compartment API.
        """
    ...
    def change_discovery_schedule_compartment(self, discovery_schedule_id, change_discovery_schedule_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/change_discovery_schedule_compartment.py.html>`__ to see an example of how to use change_discovery_schedule_compartment API.
        """
    ...
    def create_asset_source(self, create_asset_source_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/create_asset_source.py.html>`__ to see an example of how to use create_asset_source API.
        """
    ...
    def create_discovery_schedule(self, create_discovery_schedule_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/create_discovery_schedule.py.html>`__ to see an example of how to use create_discovery_schedule API.
        """
    ...
    def delete_asset_source(self, asset_source_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/delete_asset_source.py.html>`__ to see an example of how to use delete_asset_source API.
        """
    ...
    def delete_discovery_schedule(self, discovery_schedule_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/delete_discovery_schedule.py.html>`__ to see an example of how to use delete_discovery_schedule API.
        """
    ...
    def get_asset_source(self, asset_source_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/get_asset_source.py.html>`__ to see an example of how to use get_asset_source API.
        """
        resource_path = "/assetSources/{assetSourceId}"
        method = "GET"
    ...
    def get_discovery_schedule(self, discovery_schedule_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/get_discovery_schedule.py.html>`__ to see an example of how to use get_discovery_schedule API.
        """
        resource_path = "/discoverySchedules/{discoveryScheduleId}"
        method = "GET"
    ...
    def list_asset_source_connections(self, asset_source_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/list_asset_source_connections.py.html>`__ to see an example of how to use list_asset_source_connections API.
        """
    ...
    def list_asset_sources(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/list_asset_sources.py.html>`__ to see an example of how to use list_asset_sources API.
        """
        resource_path = "/assetSources"
        method = "GET"
    ...
    def list_discovery_schedules(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/list_discovery_schedules.py.html>`__ to see an example of how to use list_discovery_schedules API.
        """
        resource_path = "/discoverySchedules"
        method = "GET"
    ...
    def refresh_asset_source(self, asset_source_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/refresh_asset_source.py.html>`__ to see an example of how to use refresh_asset_source API.
        """
    ...
    def update_asset_source(self, asset_source_id, update_asset_source_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/update_asset_source.py.html>`__ to see an example of how to use update_asset_source API.
        """
        resource_path = "/assetSources/{assetSourceId}"
        method = "PUT"
    ...
    def update_discovery_schedule(self, update_discovery_schedule_details, discovery_schedule_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.92.0/cloudbridge/update_discovery_schedule.py.html>`__ to see an example of how to use update_discovery_schedule API.
        """
        resource_path = "/discoverySchedules/{discoveryScheduleId}"
        method = "PUT"
