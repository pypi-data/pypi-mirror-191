...
class UnicodeImmNode : public HLOExprNode {
 public:
  ::hercules::runtime::StringRef value;
...
class UnicodeImm : public HLOExpr {
 public:
  HERCULES_DLL UnicodeImm(runtime::StringRef value, Span span = Span());
...
class InitializerList : public HLOExpr {
 public:
   ...
   * \param span The source span of the expression.
   */
  HERCULES_DLL explicit InitializerList(runtime::Array<BaseExpr> fields, Span span = Span());
...
class InitializerDict : public HLOExpr {
 public:
   ...
   * \param span The source span of the expression.
   */
  HERCULES_DLL explicit InitializerDict(runtime::Map<BaseExpr, BaseExpr> fields, Span span = Span());
...
class HLOZip : public HLOExpr {
 public:
  HERCULES_DLL HLOZip(runtime::Array<BaseExpr> values, Span span = Span());
