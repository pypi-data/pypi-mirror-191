...
class StringRef : public ObjectRef {
 ...
 private:
  ...
  friend struct ::hercules::runtime::ObjectEqual;
};
...
template <>
struct hash<::hercules::runtime::StringRef> {
  std::size_t operator()(const ::hercules::runtime::StringRef& str) const {
    return ::hercules::runtime::BytesHash(str.data(), str.size());
  }
};

template <>
struct equal_to<::hercules::runtime::StringRef> {
