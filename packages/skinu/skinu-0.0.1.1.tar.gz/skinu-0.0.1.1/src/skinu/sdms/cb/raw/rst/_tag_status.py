...
class sdms_meta_info:
    ...
    _meta_collection_name = "tag_status"

    _meta_filed_dict: dict = {
        "site_id": "",
        "tag_id": "",
        "rtdb_id": "",
        "last_issue_dtmi": 190001010000,
    }
...
# class sdmsTagStatus
#
class sdmsTagStatus(sdmsBaseSingleDocument):
    ...
    def get_last_issue_dtmi(self, p_tag_id: str) -> int:
        tmp_doc_dict = self.get_as_id(p_tag_id)

        return dict_utils.get_int(tmp_doc_dict, "last_issue_dtmi")
