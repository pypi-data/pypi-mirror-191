...
class sdms_meta_info:
    ...
    _meta_scope_name = "performance_log"
    _meta_collection_name = "performance_status"

    _meta_filed_dict: dict = {
        "site_id": "",
        "equip_id": "",
        "last_issue_dth": 1900010100,
    }
...
#
# class sdmsPerformanceStatus
#
class sdmsPerformanceStatus(sdmsBaseSingleDocument):
