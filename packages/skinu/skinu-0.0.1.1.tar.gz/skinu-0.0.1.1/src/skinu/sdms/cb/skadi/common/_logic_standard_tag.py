...
class sdms_meta_info:
    ...
    _meta_collection_name = "logic_standard_tag"
    ...
    _meta_document_info_dict: dict = {
        "keyset": [
            {"id": "logic_id", "type": "str"},
            {"id": "standard_tag_id", "type": "str"},
        ],
    }
...
#
# class sdmsLogicStandardTag
#
class sdmsLogicStandardTag(sdmsBaseSingleDocument):
