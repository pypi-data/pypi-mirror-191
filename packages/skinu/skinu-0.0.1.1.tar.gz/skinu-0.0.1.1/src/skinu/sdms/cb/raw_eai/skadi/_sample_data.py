...
class sdms_meta_info:
    ...
    _meta_collection_name = "sample_data"
    _meta_recycle_collection_name = "sample_data_recy"

    _meta_filed_dict: dict = {
        "site_id": "",
        "sample_point_id": "",
        "sample_test_item_id": "",
        "sample_dth": 1900010100,
        "sample_point_name": "",
        "sample_point_description": "",
        "sample_test_item_name": "",
        "area_name": "",
        "measurement_name": "",
        "request_reason": "",
    ...
    _meta_document_info_dict: dict = {
        "keyset": [
            {"id": "sample_point_id", "type": "str"},
            {"id": "sample_test_item_id", "type": "str"},
            {"id": "sample_dth", "type": "int"},
        ],
    }
...
#
# class sdmsSampleData
#
class sdmsSampleData(sdmsBaseRecycleDocument):
