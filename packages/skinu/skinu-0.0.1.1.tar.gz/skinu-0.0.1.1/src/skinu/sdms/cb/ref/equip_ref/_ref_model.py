...
#
class sdms_meta_info:
    _meta_bucket_name = "REF"
    _meta_scope_name = "equip_ref"
    _meta_collection_name = "ref_model"
...
# class sdmsRefModel
#
class sdmsRefModel(sdmsBaseSingleDocument):
    def __init__(self, p_site_id: str = "", p_user_document_name: str = ""):
        tmp_sdms_config = sdms.sdms_get_config()
        tmp_bucket_name = sdms_meta_info._meta_bucket_name if tmp_sdms_config == None else tmp_sdms_config.bucket_name_ref
