...
class sdms_meta_info:
    ...
    _meta_collection_name = "equip_su_sd_report"

    _meta_filed_dict: dict = {
        "site_id": "",
        "equip_id": "",
        "report_order_seq": 0,
        "prop_su_sd_report_type": "",
...
#
# class sdmsEquipSuSdReport
#
class sdmsEquipSuSdReport(sdmsBaseSingleDocument):
