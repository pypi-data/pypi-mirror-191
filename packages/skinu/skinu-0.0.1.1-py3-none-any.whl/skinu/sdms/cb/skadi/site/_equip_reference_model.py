...
class sdms_meta_info:
    ...
    _meta_collection_name = "equip_reference_model"
    ...
    _meta_document_info_dict: dict = {
        "keyset": [
            ...
            {"id": "reference_model_id", "type": "str"},
        ],
    }
...
#
# class sdmsEquipReferenceModel
#
class sdmsEquipReferenceModel(sdmsBaseSingleDocument):
