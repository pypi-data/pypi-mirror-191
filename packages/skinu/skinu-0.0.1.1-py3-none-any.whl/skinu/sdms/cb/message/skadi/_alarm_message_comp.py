...
#
class sdms_meta_info:
    _meta_bucket_name = "MESSAGE"
    _meta_scope_name = "skadi"
    _meta_collection_name = "alarm_message_comp"

    _meta_filed_dict: dict = {
        "alarm_message_id": "",
        "prop_alarm_type": "",
        "prop_alarm_send_type": "",
        "receiver_list": "",
        "title": "",
        "content": "",
        "send_requested_dtmi": 19000101000,
        "send_completed_dtmi": None,
        "reference_alarm_id": "",
        "setpoint": {
            "is_upgrade": False,
            "issue_dtmi": 19000101000,
...
#
# class sdmsAlarmMessageComp
#
class sdmsAlarmMessageComp(sdmsBaseSingleDocument):
    def __init__(self, p_site_id: str = "", p_user_document_name: str = ""):
        tmp_sdms_config = sdms.sdms_get_config()
        tmp_bucket_name = sdms_meta_info._meta_bucket_name if tmp_sdms_config == None else tmp_sdms_config.bucket_name_message
