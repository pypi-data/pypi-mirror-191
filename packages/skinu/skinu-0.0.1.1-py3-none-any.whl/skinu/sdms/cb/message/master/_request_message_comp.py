...
class sdms_meta_info:
    ...
    _meta_scope_name = "master"
    _meta_collection_name = "request_message_comp"

    _meta_filed_dict: dict = {
        "message_id": "",
        "request_dtmi": 190001010000,
        "system_id": "",
        "prop_send_type": "",
        "receive_list": "",
        "send_requested_dtmi": 190001010000,
...
#
# class sdmsRequestMessage
#
class sdmsRequestMessageComp(sdmsBaseSingleDocument):
