...
class sdms_meta_info:
    ...
    _meta_collection_name = "alarm_worklog"
    _meta_recycle_collection_name = "alarm_worklog_recy"
...
#
# class sdmsAlarmWorklog
#
class sdmsAlarmWorklog(sdmsBaseRecycleDocument):
