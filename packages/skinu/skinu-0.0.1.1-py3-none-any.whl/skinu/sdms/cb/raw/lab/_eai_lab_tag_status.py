...
class sdms_meta_info:
    ...
    _meta_scope_name = "eai"
    _meta_collection_name = "eai_lab_tag_status"
...
#
# class sdmsEaiLabTagStatus
#
class sdmsEaiLabTagStatus(sdmsBaseSingleDocument):
