...
# workbook_path = os.path.join(os.path.dirname(__file__), 'diagram_test.xlsx')
# workdir = os.path.dirname(__file__)

# workbook_path = "c:\\Users\\siebb\\OneDrive - UvA\\Promotie\\2023\\Scripts\\diagram_test.xlsx"
# workdir = "c:\\Users\\siebb\\OneDrive - UvA\\Promotie\\2023\\Scripts\\"

# run_edgenerator(workbook_path, workdir)
