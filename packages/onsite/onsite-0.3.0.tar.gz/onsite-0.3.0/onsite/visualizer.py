...
from onsite.controller import ReplayInfo
...
class Visualizer():
    ...
    def _plot_warning_signal(self, observation: Observation, c='red'):
        ...
        for key, values in observation.vehicle_info.items():
            if key == 'ego':
                ...
                self.axveh.scatter(x, y, s=60, c=c, alpha=1.0, marker=(8, 1, 30), zorder=2)
    ...
    def _plot_roads(self, observation: Observation) -> None:
        ...
        if self.x_target and self.y_target:
            ...
            pathpatch_box = patches.PathPatch(path_box, facecolor='tomato', edgecolor='orangered')
