...
print("Motor de Calidad Version Release 1.7.17")
...
def validateRules(object:DataFrame,rules:dict,registerAmount:int, entity: str, project:str,country: str,domain: str,subDomain: str,segment: str,area: str,error,dataDate:str,validData:str, Data,sendEmail,email,output):
    ...
    try:
        emailData = validationData.groupBy("CARACTERISTICA_REGLA")
        if sendEmail == "YES":
            send_email(registerAmount,rulesNumber,output.get(JsonParts.Path),validationData,email)
    except:
