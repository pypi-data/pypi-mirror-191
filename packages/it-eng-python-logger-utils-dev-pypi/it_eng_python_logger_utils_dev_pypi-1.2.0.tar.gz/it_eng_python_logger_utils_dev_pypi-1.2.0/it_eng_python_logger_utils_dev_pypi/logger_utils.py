...
class LoggerHelper:
    def __init__(
        self, logger_name, basic_config_level="INFO", app_insights_token="", send_to_azure=True
    ):
            ...
            try:
                return Tracer(
                    exporter=AzureExporter(
                        connection_string="InstrumentationKey=" + self.__app_insights_token
                    ),
