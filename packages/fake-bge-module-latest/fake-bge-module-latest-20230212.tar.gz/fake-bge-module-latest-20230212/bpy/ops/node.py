...
def new_geometry_node_group_assign():
    ''' Create a new geometry node group and assign it to the active modifier :file: startup/bl_operators/geometry_nodes.py\:72 <https://projects.blender.org/blender/blender/src/branch/main/release/scripts/startup/bl_operators/geometry_nodes.py$72> _
...
def new_geometry_nodes_modifier():
    ''' Create a new modifier with a new geometry node group :file: startup/bl_operators/geometry_nodes.py\:49 <https://projects.blender.org/blender/blender/src/branch/main/release/scripts/startup/bl_operators/geometry_nodes.py$49> _
