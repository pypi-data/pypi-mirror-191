from sqlalchemy import Column, String, Integer, Date, Sequence, Boolean, Float
from sqlalchemy.ext.declarative import declarative_base

class InpSimpleJunctionAm(declarative_base()):
    __tablename__ = 'inp_simple_junction_am'
    
    id = Column(Integer, Sequence('seq_inp_simple_junction_am'), primary_key=True)
    city = Column(String)
    name = Column(String)
    ...
    proxi_road = Column(String)
    proxi_gas = Column(String)
    proxi_elec = Column(String)
    severity_imp = Column(String)
    project_id = Column(Date)
    ...
    pred_ins_date = Column(Date)
    is_pred_ins_date =  Column(String)
    enviro_imp = Column(Integer)
    lu_imp = Column(Integer)
    flood_risk = Column(Integer)
    stream_risk = Column(Integer)
    storm_sewer_risk = Column(Integer)
    groundwater_index_risk = Column(Integer)
    infiltration_risk = Column(Integer)
    inflow_risk = Column(Integer)
    basin_index_risk = Column(Integer)
    ...
    def __init__(
        ...
        self.proxi_road = proxi_road
        self.proxi_gas = proxi_gas
        self.proxi_elec = proxi_elec
        self.severity_imp = severity_imp
        ...
        self.stream_risk = stream_risk
        self.storm_sewer_risk = storm_sewer_risk
        self.groundwater_index_risk = groundwater_index_risk
        self.infiltration_risk = infiltration_risk
        self.inflow_risk = inflow_risk
        self.basin_index_risk = basin_index_risk
        self.rehab = rehab
