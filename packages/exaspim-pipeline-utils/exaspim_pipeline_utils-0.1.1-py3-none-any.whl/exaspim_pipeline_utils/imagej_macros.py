...
"subpixel_localization=[3-dimensional quadratic fit] interest_point_specification=[Comparable to Sample & small (beads)] " +
...
"process_timepoint=[All Timepoints] registration_algorithm=[Precise descriptor-based (translation invariant)] " +
...
"interest_points=beads fix_views=[Fix first view] map_back_views=[Do not map back (use this if views are fixed)] " +
