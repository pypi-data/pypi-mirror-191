...
TClient = TypeVar("TClient", bound="ServiceMixin")

"""
ServiceMixin Provides Utilities to help with a Service

ServiceMixin Class Attributes:
...
class ServiceMixin(GraphQLRootTypeDelegate):
...
def validate(
        ...
        service_schema: Type[ServiceMixin],
