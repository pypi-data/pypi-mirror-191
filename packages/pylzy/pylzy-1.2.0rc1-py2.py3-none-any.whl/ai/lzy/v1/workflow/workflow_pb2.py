...
_OPERATION = _descriptor.Descriptor(
  ...
  nested_types=[_OPERATION_SLOTDESCRIPTION, _OPERATION_PYTHONENVSPEC, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='env', full_name='ai.lzy.v1.workflow.Operation.env',
...
_OPERATION.oneofs_by_name['env'].fields.append(
  _OPERATION.fields_by_name['python'])
_OPERATION.fields_by_name['python'].containing_oneof = _OPERATION.oneofs_by_name['env']
