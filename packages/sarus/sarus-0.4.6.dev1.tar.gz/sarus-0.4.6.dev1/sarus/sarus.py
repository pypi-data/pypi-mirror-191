...
class Client:
    ...
    def save(self, wrapper: srt.DataSpecWrapper, path: str) -> None:
        ...
        python_class = mapping[type(wrapper)]
    ...
    def load(self, path: str) -> srt.DataSpecWrapper:
        ...
        if not self.context().manager().python_type(user_ds):
            python_type = data["python_type"]
            attach_properties(user_ds, properties={"python_type": python_type})
