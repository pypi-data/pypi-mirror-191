...
class PresentationDigitalDocument(BaseModel):
    """A file containing slides or used for a presentation.
    ...
    Attributes:
        ...
        hasDigitalDocumentPermission: (Optional[Union[List[Union[str, Any]], str, Any]]): A permission related to the access to this document (e.g. permission to read or write an electronic document). For a public document, specify a grantee with an Audience with audienceType equal to "public".
