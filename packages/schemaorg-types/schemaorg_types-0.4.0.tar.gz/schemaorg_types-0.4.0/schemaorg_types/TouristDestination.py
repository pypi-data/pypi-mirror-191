...
class TouristDestination(BaseModel):
    ...
    Attributes:
        ...
        includesAttraction: (Optional[Union[List[Union[str, Any]], str, Any]]): Attraction located at destination.
        touristType: (Union[List[Union[str, Any]], str, Any]): Attraction suitable for type(s) of tourist. E.g. children, visitors from a particular country, etc.
    ...
    includesAttraction: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
        description="Attraction located at destination.",
    )
    touristType: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
