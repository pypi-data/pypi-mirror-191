...
class MedicalScholarlyArticle(BaseModel):
    """A scholarly article in the medical domain.
    ...
    Attributes:
        ...
        publicationType: (Union[List[Union[str, Any]], str, Any]): The type of the medical article, taken from the US NLM MeSH publication type catalog. See also [MeSH documentation](http://www.nlm.nih.gov/mesh/pubtypes.html).
    ...
    publicationType: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
