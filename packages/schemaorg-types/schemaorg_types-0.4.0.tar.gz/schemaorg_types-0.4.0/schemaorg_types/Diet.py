...
class Diet(BaseModel):
    ...
    Attributes:
        ...
        endorsers: (Optional[Union[List[Union[str, Any]], str, Any]]): People or organizations that endorse the plan.
        dietFeatures: (Union[List[Union[str, Any]], str, Any]): Nutritional information specific to the dietary plan. May include dietary recommendations on what foods to avoid, what foods to consume, and specific alterations/deviations from the USDA or other regulatory body's approved dietary guidelines.
        physiologicalBenefits: (Union[List[Union[str, Any]], str, Any]): Specific physiologic benefits associated to the plan.
        expertConsiderations: (Union[List[Union[str, Any]], str, Any]): Medical expert advice related to the plan.
        risks: (Union[List[Union[str, Any]], str, Any]): Specific physiologic risks associated to the diet plan.
    ...
    endorsers: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
        description="People or organizations that endorse the plan.",
    )
    dietFeatures: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
    ...
    physiologicalBenefits: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
        description="Specific physiologic benefits associated to the plan.",
    )
    expertConsiderations: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
        description="Medical expert advice related to the plan.",
    )
    risks: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
