...
class MediaSubscription(BaseModel):
    ...
    Attributes:
        ...
        authenticator: (Optional[Union[List[Union[str, Any]], str, Any]]): The Organization responsible for authenticating the user's subscription. For example, many media apps require a cable/satellite provider to authenticate your subscription before playing media.
    ...
    authenticator: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
