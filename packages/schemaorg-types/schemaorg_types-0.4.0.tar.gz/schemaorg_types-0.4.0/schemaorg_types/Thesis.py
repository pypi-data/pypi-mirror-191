...
class Thesis(BaseModel):
    ...
    Attributes:
        ...
        inSupportOf: (Union[List[Union[str, Any]], str, Any]): Qualification, candidature, degree, application that Thesis supports.
    ...
    inSupportOf: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
