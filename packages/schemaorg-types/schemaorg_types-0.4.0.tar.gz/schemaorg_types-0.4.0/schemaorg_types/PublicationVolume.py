...
class PublicationVolume(BaseModel):
    ...
    Attributes:
        ...
        volumeNumber: (Union[List[Union[str, int, Any]], str, int, Any]): Identifies the volume of publication or multi-part work; for example, "iii" or "2".
    ...
    volumeNumber: Union[List[Union[str, int, Any]], str, int, Any] = Field(
        default=None,
