...
class SendAction(BaseModel):
    ...
    Attributes:
        ...
        deliveryMethod: (Optional[Union[List[Union[str, Any]], str, Any]]): A sub property of instrument. The method of delivery.
    ...
    deliveryMethod: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
