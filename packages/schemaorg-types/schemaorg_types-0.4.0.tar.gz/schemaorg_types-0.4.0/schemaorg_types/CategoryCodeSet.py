...
class CategoryCodeSet(BaseModel):
    """A set of Category Code values.
    ...
    Attributes:
        ...
        hasCategoryCode: (Optional[Union[List[Union[str, Any]], str, Any]]): A Category code contained in this code set.
    ...
    hasCategoryCode: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
