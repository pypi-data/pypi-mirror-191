...
class SellAction(BaseModel):
    ...
    Attributes:
        ...
        buyer: (Optional[Union[List[Union[str, Any]], str, Any]]): A sub property of participant. The participant/person/organization that bought the object.
        warrantyPromise: (Optional[Union[List[Union[str, Any]], str, Any]]): The warranty promise(s) included in the offer.
    ...
    buyer: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
        description="A sub property of participant. The participant/person/organization that bought the"
        "object.",
    )
    warrantyPromise: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
