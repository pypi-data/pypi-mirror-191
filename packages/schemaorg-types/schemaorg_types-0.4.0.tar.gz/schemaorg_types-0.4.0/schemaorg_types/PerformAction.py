...
class PerformAction(BaseModel):
    ...
    Attributes:
        ...
        entertainmentBusiness: (Optional[Union[List[Union[str, Any]], str, Any]]): A sub property of location. The entertainment business where the action occurred.
    ...
    entertainmentBusiness: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
