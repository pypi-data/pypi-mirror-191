...
class InteractionCounter(BaseModel):
    ...
    Attributes:
        ...
        interactionType: (Optional[Union[List[Union[str, Any]], str, Any]]): The Action representing the type of interaction. For up votes, +1s, etc. use [[LikeAction]]. For down votes use [[DislikeAction]]. Otherwise, use the most specific Action.
        interactionService: (Optional[Union[List[Union[str, Any]], str, Any]]): The WebSite or SoftwareApplication where the interactions took place.
        userInteractionCount: (Optional[Union[List[Union[str, int, Any]], str, int, Any]]): The number of interactions for the CreativeWork using the WebSite or SoftwareApplication.
    ...
    interactionType: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
    ...
    interactionService: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
