...
class MoneyTransfer(BaseModel):
    ...
    Attributes:
        ...
        beneficiaryBank: (Union[List[Union[str, Any]], str, Any]): A bank or bank’s branch, financial institution or international financial institution operating the beneficiary’s bank account or releasing funds for the beneficiary.
    ...
    beneficiaryBank: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
