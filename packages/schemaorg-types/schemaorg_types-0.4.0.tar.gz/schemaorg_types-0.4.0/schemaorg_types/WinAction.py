...
class WinAction(BaseModel):
    ...
    Attributes:
        ...
        loser: (Optional[Union[List[Union[str, Any]], str, Any]]): A sub property of participant. The loser of the action.
    ...
    loser: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
