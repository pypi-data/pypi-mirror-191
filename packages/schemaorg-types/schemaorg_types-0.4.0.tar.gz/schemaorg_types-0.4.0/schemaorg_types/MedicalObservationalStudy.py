...
class MedicalObservationalStudy(BaseModel):
    """An observational study is a type of medical study that attempts to infer the possible effect of a treatment through observation of a cohort of subjects over a period of time. In an observational study, the assignment of subjects into treatment groups versus control groups is outside the control of the investigator. This is in contrast with controlled studies, such as the randomized controlled trials represented by MedicalTrial, where each subject is randomly assigned to a treatment group or a control group before the start of the treatment.
    ...
    Attributes:
        ...
        studySubject: (Optional[Union[List[Union[str, Any]], str, Any]]): A subject of the study, i.e. one of the medical conditions, therapies, devices, drugs, etc. investigated by the study.
        studyLocation: (Optional[Union[List[Union[str, Any]], str, Any]]): The location in which the study is taking/took place.
        ...
        studyDesign: (Optional[Union[List[Union[str, Any]], str, Any]]): Specifics about the observational study design (enumerated).
    ...
    studySubject: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
    ...
    studyLocation: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
    ...
    studyDesign: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
