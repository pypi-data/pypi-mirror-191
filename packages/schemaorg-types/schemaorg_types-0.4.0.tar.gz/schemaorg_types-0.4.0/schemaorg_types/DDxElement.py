...
class DDxElement(BaseModel):
    ...
    Attributes:
        ...
        distinguishingSign: (Optional[Union[List[Union[str, Any]], str, Any]]): One of a set of signs and symptoms that can be used to distinguish this diagnosis from others in the differential diagnosis.
    ...
    distinguishingSign: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
