...
class TaxiReservation(BaseModel):
    ...
    Attributes:
        ...
        partySize: (Optional[Union[List[Union[str, int, Any]], str, int, Any]]): Number of people the reservation should accommodate.
    ...
    partySize: Optional[Union[List[Union[str, int, Any]], str, int, Any]] = Field(
        default=None,
