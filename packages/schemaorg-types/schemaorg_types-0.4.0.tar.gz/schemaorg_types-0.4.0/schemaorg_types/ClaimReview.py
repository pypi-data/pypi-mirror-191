...
class ClaimReview(BaseModel):
    ...
    Attributes:
        ...
        claimReviewed: (Union[List[Union[str, Any]], str, Any]): A short summary of the specific claims reviewed in a ClaimReview.
    ...
    claimReviewed: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
