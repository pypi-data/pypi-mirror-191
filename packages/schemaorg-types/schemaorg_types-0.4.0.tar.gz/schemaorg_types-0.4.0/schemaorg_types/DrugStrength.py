...
class DrugStrength(BaseModel):
    ...
    Attributes:
        ...
        availableIn: (Optional[Union[List[Union[str, Any]], str, Any]]): The location in which the strength is available.
        strengthValue: (Optional[Union[List[Union[str, Any, StrictInt, StrictFloat]], str, Any, StrictInt, StrictFloat]]): The value of an active ingredient's strength, e.g. 325.
        strengthUnit: (Union[List[Union[str, Any]], str, Any]): The units of an active ingredient's strength, e.g. mg.
    ...
    availableIn: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
    ...
    strengthUnit: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
