...
class BusinessAudience(BaseModel):
    ...
    Attributes:
        ...
        yearlyRevenue: (Optional[Union[List[Union[str, Any]], str, Any]]): The size of the business in annual revenue.
        numberOfEmployees: (Optional[Union[List[Union[str, Any]], str, Any]]): The number of employees in an organization, e.g. business.
        yearsInOperation: (Optional[Union[List[Union[str, Any]], str, Any]]): The age of the business.
    ...
    yearlyRevenue: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
    ...
    yearsInOperation: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
