...
class Artery(BaseModel):
    ...
    Attributes:
        ...
        arterialBranch: (Optional[Union[List[Union[str, Any]], str, Any]]): The branches that comprise the arterial structure.
        supplyTo: (Optional[Union[List[Union[str, Any]], str, Any]]): The area to which the artery supplies blood.
    ...
    arterialBranch: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
        description="The branches that comprise the arterial structure.",
    )
    supplyTo: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
