...
class Quotation(BaseModel):
    ...
    Attributes:
        ...
        spokenByCharacter: (Optional[Union[List[Union[str, Any]], str, Any]]): The (e.g. fictional) character, Person or Organization to whom the quotation is attributed within the containing CreativeWork.
    ...
    spokenByCharacter: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
