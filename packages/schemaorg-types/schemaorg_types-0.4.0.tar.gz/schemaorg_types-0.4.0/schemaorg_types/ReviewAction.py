...
class ReviewAction(BaseModel):
    ...
    Attributes:
        ...
        resultReview: (Optional[Union[List[Union[str, Any]], str, Any]]): A sub property of result. The review that resulted in the performing of the action.
    ...
    resultReview: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
