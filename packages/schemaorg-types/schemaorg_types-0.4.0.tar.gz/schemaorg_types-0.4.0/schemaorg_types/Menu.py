...
class Menu(BaseModel):
    ...
    Attributes:
        ...
        hasMenuSection: (Optional[Union[List[Union[str, Any]], str, Any]]): A subgrouping of the menu (by dishes, course, serving time period, etc.).
        hasMenuItem: (Optional[Union[List[Union[str, Any]], str, Any]]): A food or drink item contained in a menu or menu section.
    ...
    hasMenuSection: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
        description="A subgrouping of the menu (by dishes, course, serving time period, etc.).",
    )
    hasMenuItem: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
