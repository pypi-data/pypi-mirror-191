...
class PronounceableText(BaseModel):
    ...
    Attributes:
        ...
        textValue: (Union[List[Union[str, Any]], str, Any]): Text value being annotated.
        phoneticText: (Union[List[Union[str, Any]], str, Any]): Representation of a text [[textValue]] using the specified [[speechToTextMarkup]]. For example the city name of Houston in IPA: /ˈhjuːstən/.
        ...
        speechToTextMarkup: (Union[List[Union[str, Any]], str, Any]): Form of markup used. eg. [SSML](https://www.w3.org/TR/speech-synthesis11) or [IPA](https://www.wikidata.org/wiki/Property:P898).
    ...
    textValue: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
        description="Text value being annotated.",
    )
    phoneticText: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
    ...
    speechToTextMarkup: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
