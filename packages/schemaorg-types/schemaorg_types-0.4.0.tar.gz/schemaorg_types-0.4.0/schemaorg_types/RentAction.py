...
class RentAction(BaseModel):
    ...
    Attributes:
        ...
        realEstateAgent: (Optional[Union[List[Union[str, Any]], str, Any]]): A sub property of participant. The real estate agent involved in the action.
        landlord: (Optional[Union[List[Union[str, Any]], str, Any]]): A sub property of participant. The owner of the real estate property.
    ...
    realEstateAgent: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
        description="A sub property of participant. The real estate agent involved in the action.",
    )
    landlord: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
