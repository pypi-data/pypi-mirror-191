...
class MedicalConditionStage(BaseModel):
    """A stage of a medical condition, such as 'Stage IIIa'.
    ...
    Attributes:
        ...
        subStageSuffix: (Union[List[Union[str, Any]], str, Any]): The substage, e.g. 'a' for Stage IIIa.
        stageAsNumber: (Optional[Union[List[Union[str, Any, StrictInt, StrictFloat]], str, Any, StrictInt, StrictFloat]]): The stage represented as a number, e.g. 3.
    ...
    subStageSuffix: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
