...
class FlightReservation(BaseModel):
    ...
    Attributes:
        ...
        securityScreening: (Union[List[Union[str, Any]], str, Any]): The type of security screening the passenger is subject to.
        passengerSequenceNumber: (Union[List[Union[str, Any]], str, Any]): The passenger's sequence number as assigned by the airline.
        passengerPriorityStatus: (Union[List[Union[str, Any]], str, Any]): The priority status assigned to a passenger for security or boarding (e.g. FastTrack or Priority).
        boardingGroup: (Union[List[Union[str, Any]], str, Any]): The airline-specific indicator of boarding order / preference.
