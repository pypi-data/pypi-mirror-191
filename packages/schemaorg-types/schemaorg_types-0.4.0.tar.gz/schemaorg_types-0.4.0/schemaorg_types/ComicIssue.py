...
class ComicIssue(BaseModel):
    ...
    Attributes:
        ...
        variantCover: (Union[List[Union[str, Any]], str, Any]): A description of the variant cover    	for the issue, if the issue is a variant printing. For example, "Bryan Hitch    	Variant Cover" or "2nd Printing Variant".
    ...
    variantCover: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
