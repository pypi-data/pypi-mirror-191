...
class ArchiveOrganization(BaseModel):
    """An organization with archival holdings. An organization which keeps and preserves archival material and typically makes it accessible to the public.
    ...
    Attributes:
        ...
        archiveHeld: (Optional[Union[List[Union[str, Any]], str, Any]]): Collection, [fonds](https://en.wikipedia.org/wiki/Fonds), or item held, kept or maintained by an [[ArchiveOrganization]].
    ...
    archiveHeld: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
