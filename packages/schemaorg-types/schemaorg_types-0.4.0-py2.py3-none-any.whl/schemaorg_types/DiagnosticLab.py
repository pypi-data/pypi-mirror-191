...
class DiagnosticLab(BaseModel):
    ...
    Attributes:
        ...
        availableTest: (Optional[Union[List[Union[str, Any]], str, Any]]): A diagnostic test or procedure offered by this lab.
    ...
    availableTest: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
