...
class MedicalCause(BaseModel):
    ...
    Attributes:
        ...
        causeOf: (Optional[Union[List[Union[str, Any]], str, Any]]): The condition, complication, symptom, sign, etc. caused.
    ...
    causeOf: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
