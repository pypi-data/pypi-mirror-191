...
class OrderItem(BaseModel):
    ...
    Attributes:
        ...
        orderItemStatus: (Optional[Union[List[Union[str, Any]], str, Any]]): The current status of the order item.
        orderQuantity: (Optional[Union[List[Union[str, Any, StrictInt, StrictFloat]], str, Any, StrictInt, StrictFloat]]): The number of the item ordered. If the property is not set, assume the quantity is one.
        ...
        orderItemNumber: (Union[List[Union[str, Any]], str, Any]): The identifier of the order item.
    ...
    orderItemStatus: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
    ...
    orderItemNumber: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
