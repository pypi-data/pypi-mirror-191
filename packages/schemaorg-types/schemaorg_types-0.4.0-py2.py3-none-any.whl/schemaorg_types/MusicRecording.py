...
class MusicRecording(BaseModel):
    ...
    Attributes:
        ...
        recordingOf: (Optional[Union[List[Union[str, Any]], str, Any]]): The composition this track is a recording of.
        byArtist: (Optional[Union[List[Union[str, Any]], str, Any]]): The artist that performed this album or recording.
        inPlaylist: (Optional[Union[List[Union[str, Any]], str, Any]]): The playlist to which this recording belongs.
        ...
        isrcCode: (Union[List[Union[str, Any]], str, Any]): The International Standard Recording Code for the recording.
        inAlbum: (Optional[Union[List[Union[str, Any]], str, Any]]): The album to which this recording belongs.
    ...
    recordingOf: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
    ...
    inPlaylist: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
    ...
    isrcCode: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
        description="The International Standard Recording Code for the recording.",
    )
    inAlbum: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
