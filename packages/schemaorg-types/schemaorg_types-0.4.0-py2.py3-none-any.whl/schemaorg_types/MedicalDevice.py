...
class MedicalDevice(BaseModel):
    ...
    Attributes:
        ...
        postOp: (Union[List[Union[str, Any]], str, Any]): A description of the postoperative procedures, care, and/or followups for this device.
        ...
        preOp: (Union[List[Union[str, Any]], str, Any]): A description of the workup, testing, and other preparations required before implanting this device.
        ...
        procedure: (Union[List[Union[str, Any]], str, Any]): A description of the procedure involved in setting up, using, and/or installing the device.
    ...
    postOp: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
    ...
    preOp: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
    ...
    procedure: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
