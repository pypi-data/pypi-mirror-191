...
class MedicalRiskFactor(BaseModel):
    """A risk factor is anything that increases a person's likelihood of developing or contracting a disease, medical condition, or complication.
    ...
    Attributes:
        ...
        increasesRiskOf: (Optional[Union[List[Union[str, Any]], str, Any]]): The condition, complication, etc. influenced by this factor.
    ...
    increasesRiskOf: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
