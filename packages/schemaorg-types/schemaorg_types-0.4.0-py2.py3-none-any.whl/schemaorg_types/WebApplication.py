...
class WebApplication(BaseModel):
    ...
    Attributes:
        ...
        browserRequirements: (Union[List[Union[str, Any]], str, Any]): Specifies browser requirements in human-readable text. For example, 'requires HTML5 support'.
    ...
    browserRequirements: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
