...
class ExercisePlan(BaseModel):
    ...
    Attributes:
        ...
        additionalVariable: (Union[List[Union[str, Any]], str, Any]): Any additional component of the exercise prescription that may need to be articulated to the patient. This may include the order of exercises, the number of repetitions of movement, quantitative distance, progressions over time, etc.
        activityFrequency: (Union[List[Union[str, Any]], str, Any]): How often one should engage in the activity.
        repetitions: (Optional[Union[List[Union[str, Any, StrictInt, StrictFloat]], str, Any, StrictInt, StrictFloat]]): Number of times one should repeat the activity.
        intensity: (Union[List[Union[str, Any]], str, Any]): Quantitative measure gauging the degree of force involved in the exercise, for example, heartbeats per minute. May include the velocity of the movement.
        activityDuration: (Optional[Union[List[Union[str, Any]], str, Any]]): Length of time to engage in the activity.
        ...
        workload: (Optional[Union[List[Union[str, Any]], str, Any]]): Quantitative measure of the physiologic output of the exercise; also referred to as energy expenditure.
        restPeriods: (Union[List[Union[str, Any]], str, Any]): How often one should break from the activity.
    ...
    additionalVariable: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
    ...
    activityFrequency: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
    ...
    intensity: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
    ...
    activityDuration: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
    ...
    workload: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
        description="Quantitative measure of the physiologic output of the exercise; also referred to as"
        "energy expenditure.",
    )
    restPeriods: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
