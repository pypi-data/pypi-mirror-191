...
class Audiobook(BaseModel):
    ...
    Attributes:
        ...
        sponsor: (Optional[Union[List[Union[str, Any]], str, Any]]): A person or organization that supports a thing through a pledge, promise, or financial contribution. E.g. a sponsor of a Medical Study or a corporate sponsor of an event.
        character: (Optional[Union[List[Union[str, Any]], str, Any]]): Fictional person connected with a creative work.
        abridged: (Optional[Union[List[Union[str, StrictBool, Any]], str, StrictBool, Any]]): Indicates whether the book is an abridged edition.
        bookFormat: (Optional[Union[List[Union[str, Any]], str, Any]]): The format of the book.
        illustrator: (Optional[Union[List[Union[str, Any]], str, Any]]): The illustrator of the book.
        bookEdition: (Union[List[Union[str, Any]], str, Any]): The edition of the book.
        numberOfPages: (Optional[Union[List[Union[str, int, Any]], str, int, Any]]): The number of pages in the book.
        isbn: (Union[List[Union[str, Any]], str, Any]): The ISBN of the book.
        duration: (Optional[Union[List[Union[str, Any]], str, Any]]): The duration of the item (movie, audio recording, event, etc.) in [ISO 8601 date format](http://en.wikipedia.org/wiki/ISO_8601).
        readBy: (Optional[Union[List[Union[str, Any]], str, Any]]): A person who reads (performs) the audiobook.
    ...
    bookFormat: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
        description="The format of the book.",
    )
    illustrator: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
        description="The illustrator of the book.",
    )
    bookEdition: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
        description="The edition of the book.",
    )
    numberOfPages: Optional[Union[List[Union[str, int, Any]], str, int, Any]] = Field(
        default=None,
        description="The number of pages in the book.",
    )
    isbn: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
    ...
    readBy: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
