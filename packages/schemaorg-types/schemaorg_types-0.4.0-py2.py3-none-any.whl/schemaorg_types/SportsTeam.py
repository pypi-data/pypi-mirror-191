...
class SportsTeam(BaseModel):
    ...
    Attributes:
        ...
        athlete: (Optional[Union[List[Union[str, Any]], str, Any]]): A person that acts as performing member of a sports team; a player as opposed to a coach.
        ...
        coach: (Optional[Union[List[Union[str, Any]], str, Any]]): A person that acts in a coaching role for a sports team.
    ...
    athlete: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
    ...
    coach: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
