...
class PerformanceRole(BaseModel):
    ...
    Attributes:
        ...
        characterName: (Union[List[Union[str, Any]], str, Any]): The name of a character played in some acting or performing role, i.e. in a PerformanceRole.
    ...
    characterName: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
