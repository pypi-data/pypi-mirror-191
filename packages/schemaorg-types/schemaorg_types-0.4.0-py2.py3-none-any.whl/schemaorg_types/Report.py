...
class Report(BaseModel):
    ...
    Attributes:
        ...
        reportNumber: (Union[List[Union[str, Any]], str, Any]): The number or other unique designator assigned to a Report by the publishing organization.
    ...
    reportNumber: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
