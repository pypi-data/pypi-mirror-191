...
class HowToTool(BaseModel):
    ...
    Attributes:
        ...
        requiredQuantity: (Union[List[Union[str, Any, StrictInt, StrictFloat]], str, Any, StrictInt, StrictFloat]): The required quantity of the item(s).
