...
class PlayGameAction(BaseModel):
    """The act of playing a video game.
    ...
    Attributes:
        ...
        gameAvailabilityType: (Union[List[Union[str, Any]], str, Any]): Indicates the availability type of the game content associated with this action, such as whether it is a full version or a demo.
    ...
    gameAvailabilityType: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
