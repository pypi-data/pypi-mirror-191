...
class OwnershipInfo(BaseModel):
    ...
    Attributes:
        ...
        ownedThrough: (Optional[Union[List[Union[datetime, str, Any]], datetime, str, Any]]): The date and time of giving up ownership on the product.
        ownedFrom: (Optional[Union[List[Union[datetime, str, Any]], datetime, str, Any]]): The date and time of obtaining the product.
        acquiredFrom: (Optional[Union[List[Union[str, Any]], str, Any]]): The organization or person from which the product was acquired.
    ...
    acquiredFrom: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
