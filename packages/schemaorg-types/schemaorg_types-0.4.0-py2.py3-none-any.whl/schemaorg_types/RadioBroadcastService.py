...
class RadioBroadcastService(BaseModel):
    ...
    Attributes:
        ...
        hasBroadcastChannel: (Optional[Union[List[Union[str, Any]], str, Any]]): A broadcast channel of a broadcast service.
        parentService: (Optional[Union[List[Union[str, Any]], str, Any]]): A broadcast service to which the broadcast service may belong to such as regional variations of a national channel.
        broadcastAffiliateOf: (Optional[Union[List[Union[str, Any]], str, Any]]): The media network(s) whose content is broadcast on this station.
        broadcaster: (Optional[Union[List[Union[str, Any]], str, Any]]): The organization owning or operating the broadcast service.
        videoFormat: (Union[List[Union[str, Any]], str, Any]): The type of screening or video broadcast used (e.g. IMAX, 3D, SD, HD, etc.).
        broadcastTimezone: (Union[List[Union[str, Any]], str, Any]): The timezone in [ISO 8601 format](http://en.wikipedia.org/wiki/ISO_8601) for which the service bases its broadcasts.
        broadcastDisplayName: (Union[List[Union[str, Any]], str, Any]): The name displayed in the channel guide. For many US affiliates, it is the network name.
        ...
        area: (Optional[Union[List[Union[str, Any]], str, Any]]): The area within which users can expect to reach the broadcast service.
    ...
    hasBroadcastChannel: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
        description="A broadcast channel of a broadcast service.",
    )
    parentService: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
    ...
    broadcastAffiliateOf: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
        description="The media network(s) whose content is broadcast on this station.",
    )
    broadcaster: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
    ...
    broadcastTimezone: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
    ...
    broadcastDisplayName: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
    ...
    area: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
