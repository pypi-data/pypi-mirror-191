...
class Blog(BaseModel):
    ...
    Attributes:
        ...
        blogPosts: (Optional[Union[List[Union[str, Any]], str, Any]]): Indicates a post that is part of a [[Blog]]. Note that historically, what we term a "Blog" was once known as a "weblog", and that what we term a "BlogPosting" is now often colloquially referred to as a "blog".
        blogPost: (Optional[Union[List[Union[str, Any]], str, Any]]): A posting that is part of this blog.
    ...
    blogPosts: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
    ...
    blogPost: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
