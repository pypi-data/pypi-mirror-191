...
class MedicalSign(BaseModel):
    ...
    Attributes:
        ...
        possibleTreatment: (Optional[Union[List[Union[str, Any]], str, Any]]): A possible treatment to address this condition, sign or symptom.
        identifyingExam: (Optional[Union[List[Union[str, Any]], str, Any]]): A physical examination that can identify this sign.
        identifyingTest: (Optional[Union[List[Union[str, Any]], str, Any]]): A diagnostic test that can identify this sign.
    ...
    identifyingExam: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
        description="A physical examination that can identify this sign.",
    )
    identifyingTest: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
