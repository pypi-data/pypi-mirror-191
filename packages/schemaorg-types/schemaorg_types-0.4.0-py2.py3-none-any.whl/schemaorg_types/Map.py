...
class Map(BaseModel):
    ...
    Attributes:
        ...
        mapType: (Optional[Union[List[Union[str, Any]], str, Any]]): Indicates the kind of Map, from the MapCategoryType Enumeration.
    ...
    mapType: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
