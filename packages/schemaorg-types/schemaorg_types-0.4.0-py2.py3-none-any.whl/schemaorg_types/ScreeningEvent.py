...
class ScreeningEvent(BaseModel):
    ...
    Attributes:
        ...
        workPresented: (Optional[Union[List[Union[str, Any]], str, Any]]): The movie presented during this event.
    ...
    workPresented: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
