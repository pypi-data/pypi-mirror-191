...
class CourseInstance(BaseModel):
    ...
    Attributes:
        ...
        courseWorkload: (Union[List[Union[str, Any]], str, Any]): The amount of work expected of students taking the course, often provided as a figure per week or per month, and may be broken down by type. For example, "2 hours of lectures, 1 hour of lab work and 3 hours of independent study per week".
        courseMode: (Union[List[Union[str, AnyUrl, Any]], str, AnyUrl, Any]): The medium or means of delivery of the course instance or the mode of study, either as a text label (e.g. "online", "onsite" or "blended"; "synchronous" or "asynchronous"; "full-time" or "part-time") or as a URL reference to a term from a controlled vocabulary (e.g. https://ceds.ed.gov/element/001311#Asynchronous).
        instructor: (Optional[Union[List[Union[str, Any]], str, Any]]): A person assigned to instruct or provide instructional assistance for the [[CourseInstance]].
    ...
    courseWorkload: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
    ...
    courseMode: Union[List[Union[str, AnyUrl, Any]], str, AnyUrl, Any] = Field(
        default=None,
    ...
    instructor: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
