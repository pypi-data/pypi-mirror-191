...
class HyperToc(BaseModel):
    ...
    Attributes:
        ...
        associatedMedia: (Optional[Union[List[Union[str, Any]], str, Any]]): A media object that encodes this CreativeWork. This property is a synonym for encoding.
        tocEntry: (Optional[Union[List[Union[str, Any]], str, Any]]): Indicates a [[HyperTocEntry]] in a [[HyperToc]].
    ...
    tocEntry: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
