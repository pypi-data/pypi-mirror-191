...
class ArchiveComponent(BaseModel):
    ...
    Attributes:
        ...
        holdingArchive: (Optional[Union[List[Union[str, Any]], str, Any]]): [[ArchiveOrganization]] that holds, keeps or maintains the [[ArchiveComponent]].
        itemLocation: (Union[List[Union[str, Any]], str, Any]): Current location of the item.
    ...
    holdingArchive: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
        description="[[ArchiveOrganization]] that holds, keeps or maintains the [[ArchiveComponent]].",
    )
    itemLocation: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
