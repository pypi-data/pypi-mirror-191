...
class Nerve(BaseModel):
    ...
    Attributes:
        ...
        nerveMotor: (Optional[Union[List[Union[str, Any]], str, Any]]): The neurological pathway extension that involves muscle control.
        branch: (Optional[Union[List[Union[str, Any]], str, Any]]): The branches that delineate from the nerve bundle. Not to be confused with [[branchOf]].
        sourcedFrom: (Optional[Union[List[Union[str, Any]], str, Any]]): The neurological pathway that originates the neurons.
        sensoryUnit: (Optional[Union[List[Union[str, Any]], str, Any]]): The neurological pathway extension that inputs and sends information to the brain or spinal cord.
