...
class LendAction(BaseModel):
    ...
    Attributes:
        ...
        borrower: (Optional[Union[List[Union[str, Any]], str, Any]]): A sub property of participant. The person that borrows the object being lent.
    ...
    borrower: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
