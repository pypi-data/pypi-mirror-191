...
class MusicComposition(BaseModel):
    ...
    Attributes:
        ...
        iswcCode: (Union[List[Union[str, Any]], str, Any]): The International Standard Musical Work Code for the composition.
        lyrics: (Optional[Union[List[Union[str, Any]], str, Any]]): The words in the song.
        musicalKey: (Union[List[Union[str, Any]], str, Any]): The key, mode, or scale this composition uses.
        includedComposition: (Optional[Union[List[Union[str, Any]], str, Any]]): Smaller compositions included in this work (e.g. a movement in a symphony).
        recordedAs: (Optional[Union[List[Union[str, Any]], str, Any]]): An audio recording of the work.
        ...
        musicCompositionForm: (Union[List[Union[str, Any]], str, Any]): The type of composition (e.g. overture, sonata, symphony, etc.).
        firstPerformance: (Optional[Union[List[Union[str, Any]], str, Any]]): The date and place the work was first performed.
        lyricist: (Optional[Union[List[Union[str, Any]], str, Any]]): The person who wrote the words.
        musicArrangement: (Optional[Union[List[Union[str, Any]], str, Any]]): An arrangement derived from the composition.
    ...
    iswcCode: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
        description="The International Standard Musical Work Code for the composition.",
    )
    lyrics: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
        description="The words in the song.",
    )
    musicalKey: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
        description="The key, mode, or scale this composition uses.",
    )
    includedComposition: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
        description="Smaller compositions included in this work (e.g. a movement in a symphony).",
    )
    recordedAs: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
    ...
    musicCompositionForm: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
        description="The type of composition (e.g. overture, sonata, symphony, etc.).",
    )
    firstPerformance: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
        description="The date and place the work was first performed.",
    )
    lyricist: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
        description="The person who wrote the words.",
    )
    musicArrangement: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
