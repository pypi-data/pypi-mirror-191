...
class MusicRelease(BaseModel):
    ...
    Attributes:
        ...
        tracks: (Optional[Union[List[Union[str, Any]], str, Any]]): A music recording (track)&#x2014;usually a single song.
        track: (Optional[Union[List[Union[str, Any]], str, Any]]): A music recording (track)&#x2014;usually a single song. If an ItemList is given, the list should contain items of type MusicRecording.
        numTracks: (Optional[Union[List[Union[str, int, Any]], str, int, Any]]): The number of tracks in this album or playlist.
        releaseOf: (Optional[Union[List[Union[str, Any]], str, Any]]): The album this is a release of.
        musicReleaseFormat: (Optional[Union[List[Union[str, Any]], str, Any]]): Format of this release (the type of recording media used, i.e. compact disc, digital media, LP, etc.).
        ...
        recordLabel: (Optional[Union[List[Union[str, Any]], str, Any]]): The label that issued the release.
        catalogNumber: (Union[List[Union[str, Any]], str, Any]): The catalog number for the release.
        creditedTo: (Optional[Union[List[Union[str, Any]], str, Any]]): The group the release is credited to if different than the byArtist. For example, Red and Blue is credited to "Stefani Germanotta Band", but by Lady Gaga.
    ...
    tracks: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
        description="A music recording (track)&#x2014;usually a single song.",
    )
    track: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
    ...
    numTracks: Optional[Union[List[Union[str, int, Any]], str, int, Any]] = Field(
        default=None,
        description="The number of tracks in this album or playlist.",
    )
    releaseOf: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
        description="The album this is a release of.",
    )
    musicReleaseFormat: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
    ...
    recordLabel: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
        description="The label that issued the release.",
    )
    catalogNumber: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
        description="The catalog number for the release.",
    )
    creditedTo: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
