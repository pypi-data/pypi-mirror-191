...
class Physician(BaseModel):
    ...
    Attributes:
        ...
        hospitalAffiliation: (Optional[Union[List[Union[str, Any]], str, Any]]): A hospital with which the physician or office is affiliated.
        medicalSpecialty: (Optional[Union[List[Union[str, Any]], str, Any]]): A medical specialty of the provider.
    ...
    hospitalAffiliation: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
