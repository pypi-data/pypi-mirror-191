...
class CookAction(BaseModel):
    ...
    Attributes:
        ...
        foodEvent: (Optional[Union[List[Union[str, Any]], str, Any]]): A sub property of location. The specific food event where the action occurred.
        recipe: (Optional[Union[List[Union[str, Any]], str, Any]]): A sub property of instrument. The recipe/instructions used to perform the action.
        foodEstablishment: (Optional[Union[List[Union[str, Any]], str, Any]]): A sub property of location. The specific food establishment where the action occurred.
