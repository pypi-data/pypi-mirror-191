...
class MusicAlbum(BaseModel):
    ...
    Attributes:
        ...
        albumReleaseType: (Optional[Union[List[Union[str, Any]], str, Any]]): The kind of release which this album is: single, EP or album.
        albumRelease: (Optional[Union[List[Union[str, Any]], str, Any]]): A release of this album.
        byArtist: (Optional[Union[List[Union[str, Any]], str, Any]]): The artist that performed this album or recording.
        albumProductionType: (Optional[Union[List[Union[str, Any]], str, Any]]): Classification of the album by its type of content: soundtrack, live album, studio album, etc.
    ...
    albumReleaseType: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
        description="The kind of release which this album is: single, EP or album.",
    )
    albumRelease: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
        description="A release of this album.",
    )
    byArtist: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
        description="The artist that performed this album or recording.",
    )
    albumProductionType: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
