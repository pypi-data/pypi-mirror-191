...
class TrainTrip(BaseModel):
    ...
    Attributes:
        ...
        arrivalPlatform: (Union[List[Union[str, Any]], str, Any]): The platform where the train arrives.
        departurePlatform: (Union[List[Union[str, Any]], str, Any]): The platform from which the train departs.
        arrivalStation: (Optional[Union[List[Union[str, Any]], str, Any]]): The station where the train trip ends.
        trainName: (Union[List[Union[str, Any]], str, Any]): The name of the train (e.g. The Orient Express).
        trainNumber: (Union[List[Union[str, Any]], str, Any]): The unique identifier for the train.
        departureStation: (Optional[Union[List[Union[str, Any]], str, Any]]): The station from which the train departs.
    ...
    arrivalPlatform: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
        description="The platform where the train arrives.",
    )
    departurePlatform: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
        description="The platform from which the train departs.",
    )
    arrivalStation: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
        description="The station where the train trip ends.",
    )
    trainName: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
        description="The name of the train (e.g. The Orient Express).",
    )
    trainNumber: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
        description="The unique identifier for the train.",
    )
    departureStation: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
