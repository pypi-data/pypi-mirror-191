...
class MathSolver(BaseModel):
    ...
    Attributes:
        ...
        mathExpression: (Union[List[Union[str, Any]], str, Any]): A mathematical expression (e.g. 'x^2-3x=0') that may be solved for a specific variable, simplified, or transformed. This can take many formats, e.g. LaTeX, Ascii-Math, or math as you would write with a keyboard.
    ...
    mathExpression: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
