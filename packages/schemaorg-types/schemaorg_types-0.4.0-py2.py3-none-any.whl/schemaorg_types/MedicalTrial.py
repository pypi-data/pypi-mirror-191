...
class MedicalTrial(BaseModel):
    ...
    Attributes:
        ...
        trialDesign: (Optional[Union[List[Union[str, Any]], str, Any]]): Specifics about the trial design (enumerated).
    ...
    trialDesign: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
