...
class ReplaceAction(BaseModel):
    ...
    Attributes:
        ...
        replacee: (Optional[Union[List[Union[str, Any]], str, Any]]): A sub property of object. The object that is being replaced.
        replacer: (Optional[Union[List[Union[str, Any]], str, Any]]): A sub property of object. The object that replaces.
    ...
    replacee: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
        description="A sub property of object. The object that is being replaced.",
    )
    replacer: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
