...
class RentalCarReservation(BaseModel):
    """A reservation for a rental car.Note: This type is for information about actual reservations, e.g. in confirmation emails or HTML pages with individual confirmations of reservations.
    ...
    Attributes:
        ...
        pickupTime: (Optional[Union[List[Union[datetime, str, Any]], datetime, str, Any]]): When a taxi will pick up a passenger or a rental car can be picked up.
        pickupLocation: (Optional[Union[List[Union[str, Any]], str, Any]]): Where a taxi will pick up a passenger or a rental car can be picked up.
        dropoffLocation: (Optional[Union[List[Union[str, Any]], str, Any]]): Where a rental car can be dropped off.
        dropoffTime: (Optional[Union[List[Union[datetime, str, Any]], datetime, str, Any]]): When a rental car can be dropped off.
    ...
    pickupLocation: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
        description="Where a taxi will pick up a passenger or a rental car can be picked up.",
    )
    dropoffLocation: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
