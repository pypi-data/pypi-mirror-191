...
class Claim(BaseModel):
    ...
    Attributes:
        ...
        claimInterpreter: (Optional[Union[List[Union[str, Any]], str, Any]]): For a [[Claim]] interpreted from [[MediaObject]] content    sed to indicate a claim contained, implied or refined from the content of a [[MediaObject]].
        appearance: (Optional[Union[List[Union[str, Any]], str, Any]]): Indicates an occurrence of a [[Claim]] in some [[CreativeWork]].
        firstAppearance: (Optional[Union[List[Union[str, Any]], str, Any]]): Indicates the first known occurrence of a [[Claim]] in some [[CreativeWork]].
    ...
    claimInterpreter: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
    ...
    appearance: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
        description="Indicates an occurrence of a [[Claim]] in some [[CreativeWork]].",
    )
    firstAppearance: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
