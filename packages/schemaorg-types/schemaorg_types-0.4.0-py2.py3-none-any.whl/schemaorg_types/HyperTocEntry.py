...
class HyperTocEntry(BaseModel):
    ...
    Attributes:
        ...
        associatedMedia: (Optional[Union[List[Union[str, Any]], str, Any]]): A media object that encodes this CreativeWork. This property is a synonym for encoding.
        utterances: (Union[List[Union[str, Any]], str, Any]): Text of an utterances (spoken words, lyrics etc.) that occurs at a certain section of a media object, represented as a [[HyperTocEntry]].
        tocContinuation: (Optional[Union[List[Union[str, Any]], str, Any]]): A [[HyperTocEntry]] can have a [[tocContinuation]] indicated, which is another [[HyperTocEntry]] that would be the default next item to play or render.
    ...
    utterances: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
    ...
    tocContinuation: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
