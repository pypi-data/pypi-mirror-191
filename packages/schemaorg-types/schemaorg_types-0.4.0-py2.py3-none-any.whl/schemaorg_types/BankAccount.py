...
class BankAccount(BaseModel):
    ...
    Attributes:
        ...
        accountMinimumInflow: (Optional[Union[List[Union[str, Any]], str, Any]]): A minimum amount that has to be paid in every month.
        accountOverdraftLimit: (Optional[Union[List[Union[str, Any]], str, Any]]): An overdraft is an extension of credit from a lending institution when an account reaches zero. An overdraft allows the individual to continue withdrawing money even if the account has no funds in it. Basically the bank allows people to borrow a set amount of money.
        bankAccountType: (Union[List[Union[str, AnyUrl, Any]], str, AnyUrl, Any]): The type of a bank account.
    ...
    accountMinimumInflow: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
        description="A minimum amount that has to be paid in every month.",
    )
    accountOverdraftLimit: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
    ...
    bankAccountType: Union[List[Union[str, AnyUrl, Any]], str, AnyUrl, Any] = Field(
        default=None,
