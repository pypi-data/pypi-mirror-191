...
class ReplyAction(BaseModel):
    ...
    Attributes:
        ...
        resultComment: (Optional[Union[List[Union[str, Any]], str, Any]]): A sub property of result. The Comment created or sent as a result of this action.
    ...
    resultComment: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
