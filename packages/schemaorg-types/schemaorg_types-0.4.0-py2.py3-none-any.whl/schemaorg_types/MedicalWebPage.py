...
class MedicalWebPage(BaseModel):
    """A web page that provides medical information.
    ...
    Attributes:
        ...
        medicalAudience: (Optional[Union[List[Union[str, Any]], str, Any]]): Medical audience for page.
        aspect: (Union[List[Union[str, Any]], str, Any]): An aspect of medical practice that is considered on the page, such as 'diagnosis', 'treatment', 'causes', 'prognosis', 'etiology', 'epidemiology', etc.
    ...
    medicalAudience: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
        description="Medical audience for page.",
    )
    aspect: Union[List[Union[str, Any]], str, Any] = Field(
        default=None,
