...
class MusicGroup(BaseModel):
    ...
    Attributes:
        ...
        album: (Optional[Union[List[Union[str, Any]], str, Any]]): A music album.
        ...
        albums: (Optional[Union[List[Union[str, Any]], str, Any]]): A collection of music albums.
        genre: (Union[List[Union[str, AnyUrl, Any]], str, AnyUrl, Any]): Genre of the creative work, broadcast channel or group.
        musicGroupMember: (Optional[Union[List[Union[str, Any]], str, Any]]): A member of a music group&#x2014;for example, John, Paul, George, or Ringo.
    ...
    album: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
    ...
    albums: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
    ...
    musicGroupMember: Optional[Union[List[Union[str, Any]], str, Any]] = Field(
        default=None,
