...
class glab(mem):
    ...
    def download(self, file_path=None,download_to=None):
        ...
        raw_file = self.project.files.get(file_path=file_path, ref=self.branch).decode()
    ...
    def upload(self, file_path=None,path_in_repo=None):
        ...
        if path_in_repo in self: #Update
            f = project.files.get(file_path=path_in_repo, ref=self.branch)
