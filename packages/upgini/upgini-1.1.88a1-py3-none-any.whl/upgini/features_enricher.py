...
class FeaturesEnricher(TransformerMixin):
    ...
    def _prepare_data_for_metrics(
        ...
        X_sorted, y_sorted = self._sort_by_keys(X_sampled, y_sampled, date_column)
        enriched_X_sorted, enriched_y_sorted = self._sort_by_keys(enriched_X, y_sampled, date_column)
        ...
        for idx, eval_tuple in eval_set_sampled_dict.items():
            ...
            eval_X_sorted, eval_y_sorted = self._sort_by_keys(eval_X_sampled, eval_y_sampled, date_column)
