...
class WaveformEnvelope:
    ...
    def __init__(self, fname, tap_function, beats = []):
        ...
        self.signal_plot = figure(width=600, height=350,
...
class Time_Waveform:
    def __init__(self, time_range=46):
        ...
        self.signal_plot = figure(width=600, height=200,
                                  title="Signal",
...
class Spectrum:
    def __init__(self):
        ...
        self.spectrum_plot = figure(width=600, height=200,
...
class CircularEq:
    def __init__(self):
        ...
        self.eq_plot = figure(width=400, height=400,
...
class Centroid:
    def __init__(self):
        ...
        self.centroid_plot = figure(width=800, height=200,
