...
class ShopifyApp:
    ...
    def inventory_table(self, status: Optional[str] = None,
        ...
        Arguments
        ---------
        status: str, optional [active, archived, draft, None]
            Return products that match the status. None returns all products.
        ...
        if status is not None or status == 'all':
            products = products.loc[products['status'] == status]
