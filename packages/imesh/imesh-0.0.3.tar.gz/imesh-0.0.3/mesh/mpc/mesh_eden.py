...
from mesh.kinds import Reference, Service, Environ, MeshFlag, Event, Registration, Metadata, Topic, Versions
...
class MeshEden(Eden, RuntimeHook, Subscriber):
    ...
    def new_registration(self, metadata: Metadata, attachments: Dict[str, str]) -> Registration:
