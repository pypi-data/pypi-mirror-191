# perllib module for pythonizer, generated by makelib.py on Fri Feb 10 17:41:16 2023
#
...
TRACE_RUN = 0
AUTODIE = 0
_PYTHONIZER_KEYWORDS = {'argparse','keys','staticmethod','re','os','upper','list','vars','atexit','if','await','stat','enumerate','pop','values','any','class','print','all','assert','close','object','exec','in','rfind','traceback','Array','float','bool','lower','iter','issubclass','raise','break','bytes','compile','copy','globals','inspect','def','chr','rstrip','finally','Hash','anext','classmethod','abs','len','callable','ord','min','math','reversed','io','divmod','ArrayHash','hex','round','pass','or','bin','global','builtins','extend','find','fileinput','breakpoint','open','map','getopt','bytearray','hasattr','type','property','subprocess','repr','sys','and','for','pow','tuple','as','next','locals','lambda','filter','async','oct','int','del','calendar','range','not','complex','delattr','None','itertools','warnings','elif','hash','while','random','codecs','pdb','frozenset','casefold','eval','sorted','input','from','zip','sum','id','yield','else','try','insert','with','update','dataclasses','super','getattr','perllib','help','memoryview','glob','types','True','get','ascii','collections.abc','set','functools','fcntl','tm_py','slice','setattr','wantarray','import','dict','signal','str','return','struct','aiter','is','isinstance','dir','format','tempfile','continue','except','False','nonlocal','abc','max'}
OS_ERROR = ''
...
_TIE_MAP = {'EXISTS': '__contains__','UNTIE': '__untie__','STORE': '__setitem__','FETCHSIZE': '__len__','SCALAR': '__len__','FETCH': '__getitem__','PUSH': 'append','DESTROY': '__del__','DELETE': '__delitem__','CLEAR': 'clear'}
LIST_SEPARATOR = ' '
