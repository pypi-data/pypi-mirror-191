...
mapping = {
    ...
    'BGStatsTeampleFive': assets/'teapmleFive'/'talants'/'BG.png',
    'NAME_BANNERTeampleFive': assets/'teapmleFive'/'talants'/'NAME_BANNER.png',

    '1_stars_frame': assets/'teapmleFive'/'stars'/'1_stars_frame.png',
    '2_stars_frame': assets/'teapmleFive'/'stars'/'2_stars_frame.png',
    '3_stars_frame': assets/'teapmleFive'/'stars'/'3_stars_frame.png',
    '4_stars_frame': assets/'teapmleFive'/'stars'/'4_stars_frame.png',
    '5_stars_frame': assets/'teapmleFive'/'stars'/'5_stars_frame.png',

    '1_stars_light': assets/'teapmleFive'/'stars'/'1_stars_light.png',
    '2_stars_light': assets/'teapmleFive'/'stars'/'2_stars_light.png',
    '3_stars_light': assets/'teapmleFive'/'stars'/'3_stars_light.png',
    '4_stars_light': assets/'teapmleFive'/'stars'/'4_stars_light.png',
    '5_stars_light': assets/'teapmleFive'/'stars'/'5_stars_light.png',
