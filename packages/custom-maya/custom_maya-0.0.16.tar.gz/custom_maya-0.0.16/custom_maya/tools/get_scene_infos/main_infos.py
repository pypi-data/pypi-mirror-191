...
from custom_maya import SceneDetails, async_scene, CustomSceneFunction


def get_template_abs_path(template_relative_path='templates'):
    templates_path = os.path.abspath(template_relative_path)
...
class PerSceneInfo(SceneDetails):
    ...
    def output(self, data):
        # 加载模板文件的目录
        file_loader = FileSystemLoader(get_template_abs_path())
