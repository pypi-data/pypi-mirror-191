...
impl Project {
  fn new_from_env() -> Self {
    ...
    Project {
      ...
      documentation: "https://media-cloud-ai.gitlab.io/sdks/py_mcai_worker_sdk/mcai_worker_sdk"
        .to_string(),
...
fn main() {
  ...
  if let Ok(feat) = env::var("CARGO_FEATURE_MEDIA") {
    if feat == "1" {
      ...
      project.documentation = format!("{}_media/v{}", project.documentation, project.version)
    }
  } else {
    project.documentation = format!("{}/v{}", project.documentation, project.version)
  }
