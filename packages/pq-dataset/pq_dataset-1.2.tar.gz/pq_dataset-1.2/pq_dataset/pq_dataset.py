...
# from pq_dataset.logging.logger_setup import logging_setup
...
class PQDataset:
    ...
    def __post_init__(self):
        ...
        self.logger.info(f'Initializing PQDataset from file: {self.input_file}')
        ...
        self.logger.info(f'Done preparing data from {self.input_file}. You can access the dataframe by appending .data to the object that you created - i.e. barnbg.data')
    ...
    def identify_relevante_data_ftp(self, 
        ...
        if include_calculated_from_report:
            used_calc_vars = extract_calculated_from_report_spec(self.input_path, include_calculated_from_report, self.analysis_id, self.var_overview)
