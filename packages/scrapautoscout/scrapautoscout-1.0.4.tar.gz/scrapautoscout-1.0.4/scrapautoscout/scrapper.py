...
def get_all_ids_for_search_url(search_url: str, max_pages: int, last_page_articles: int):
    ...
    dir_cache = os.path.join(os.getcwd(), 'cache/get_all_ids_for_search_url')
...
def read_ids_json_files_from_cache():
    ...
    path_to_json = os.path.join(os.getcwd(), '/cache/get_all_ids_for_search_url/')
    json_files = [pos_json for pos_json in os.listdir(path_to_json) if pos_json.endswith('.json')]

    dir_get_content = os.path.join(os.getcwd(), '/cache/get_content_id')
