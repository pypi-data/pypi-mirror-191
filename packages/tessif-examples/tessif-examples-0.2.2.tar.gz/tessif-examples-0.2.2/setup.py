...
['tessif_examples',
 ...
 'tessif_examples.data.examples',
 'tessif_examples.data.examples.application',
 'tessif_examples.data.examples.application.verification_scenarios',
 'tessif_examples.data.examples.application.verification_scenarios._Backup',
 'tessif_examples.data.examples.application.verification_scenarios.source',
 'tessif_examples.data.examples.application.verification_scenarios.source.expansion',
 'tessif_examples.data.examples.application.verification_scenarios.source.linear',
 'tessif_examples.data.examples.application.verification_scenarios.source.milp',
 'tessif_examples.data.examples.data',
 'tessif_examples.data.examples.data.calliope',
 'tessif_examples.data.examples.data.calliope.mwe',
 'tessif_examples.data.examples.data.fine',
 'tessif_examples.data.examples.data.omf',
 'tessif_examples.data.examples.data.pypsa',
 'tessif_examples.data.examples.data.tsf',
 'tessif_examples.data.examples.data.tsf.cfg',
 'tessif_examples.data.examples.data.tsf.cfg.flat',
 'tessif_examples.data.examples.data.tsf.py_mapping',
 'tessif_examples.data.frused',
 'tessif_examples.data.frused.hooks',
 'tessif_examples.data.model',
 'tessif_examples.data.write',
 'tessif_examples.scenarios']

package_data = \
{'': ['*'],
 'tessif_examples.data.examples.data.calliope': ['chp_expansion/*',
                                                 'chp_expansion/model_config/*',
                                                 'chp_expansion/timeseries_data/*',
                                                 'fpwe/*',
                                                 'fpwe/model_config/*',
                                                 'fpwe/timeseries_data/*',
                                                 'timeseries_data/*'],
 'tessif_examples.data.examples.data.calliope.mwe': ['model_config/*',
                                                     'timeseries_data/*'],
 'tessif_examples.data.examples.data.omf': ['xlsx/*'],
 'tessif_examples.data.examples.data.tsf': ['hdf5/*',
                                            'load_profiles/*',
                                            'xml/*'],
 'tessif_examples.data.examples.data.tsf.cfg': ['flat_old/*', 'nested/*'],
 'tessif_examples.data.examples.data.tsf.cfg.flat': ['basic/*', 'objectives/*'],
 'tessif_examples.data.write': ['fine/chp_example/*',
                                'fine/double_chp_objective/*',
                                'fine/emission_objective/*',
                                'fine/expansion_example/*',
                                'fine/multi_commodity/*',
                                'fine/mwe/*',
                                'fine/one_year_example/*',
                                'fine/single_chp_obj/*',
                                'fine/storage_example/*',
                                'fine/tsa_one_year_example/*',
                                'pypsa/*',
                                'pypsa/emission_objective/*',
                                'pypsa/mwe/*',
                                'tsf/hhes/*',
                                'tsf/two_transformers_grid/*']}

install_requires = \
['numpy', 'pandas', 'requests>=2.27.1,<3.0.0', 'tessif>=0,<1']
