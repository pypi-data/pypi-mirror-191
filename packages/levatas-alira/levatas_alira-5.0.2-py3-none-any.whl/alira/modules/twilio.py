...
from alira.modules.module import ConnectionError
...
class Twilio(Notification):
    ...
    def run(self, instance: Instance, **kwargs):
        try:
            logging.info("Running twilio mapping function...")
            super().run(instance, **kwargs)
        except ConnectionError as e:
            raise e
        except Exception as e:
            message = f"Error while executing twilio mapping function for pipeline {self.pipeline_id}"
