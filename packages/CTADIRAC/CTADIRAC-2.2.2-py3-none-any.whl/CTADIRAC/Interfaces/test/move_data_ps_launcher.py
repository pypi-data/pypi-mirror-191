...
def build_moving_step(DL0_data_set, name_tag=''):
  ...
  prod_step_1.Name = 'Moving_Prod3b_to_tape'
  DIRAC.gLogger.notice('\tBuilding moving step: %s' % prod_step_1.Name)
  prod_step_1.Type = 'Replication'
...
if __name__ == '__main__':
  ...
  prod_name = "Prod_Move_Prod3b_test01"
