...
def gnuplusplus(): return native_find_version("g++", "g++ --version", __extrace_fn_fristrow_lastspace)
def gnuplusplus(): return native_find_version("gcc", "gcc --version", __extrace_fn_fristrow_lastspace)
