...
class ExperimentTextEntry(ExperimentEntry):
    """
    An experiment entry type that contains a large block of text.
    """
    record_id: Optional[int]
...
class ExperimentTempDataEntry(ExperimentEntry):
    """
    An experiment entry type that displays custom data retrieved through a custom plugin to display data
