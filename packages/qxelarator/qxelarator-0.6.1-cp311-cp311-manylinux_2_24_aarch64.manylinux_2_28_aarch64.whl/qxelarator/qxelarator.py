...
def execute_string(s, iterations=1):
    return _qxelarator.execute_string(s, iterations)

def execute_file(filePath, iterations=1):
    return _qxelarator.execute_file(filePath, iterations)
