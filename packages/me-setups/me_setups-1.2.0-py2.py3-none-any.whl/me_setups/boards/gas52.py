...
class Gas52Board:
    ...
    def __init__(
        ...
        self.mcus = self._generate_mcus(mcus, mcu_type)
        self.mcs = None
        self._log_folder: pathlib.Path | None = None
    ...
    def _generate_mcus(
        ...
        return [
            self._generate_mcu(mcu_name, mcu_port, mcu_type)
    ...
    @log_folder.setter
    def log_folder(self, log_folder: pathlib.Path) -> None:
        self._log_folder = log_folder
        for conn in self.conns:
            conn.config_serial_log_file(log_folder / f"{conn.name}.log")
