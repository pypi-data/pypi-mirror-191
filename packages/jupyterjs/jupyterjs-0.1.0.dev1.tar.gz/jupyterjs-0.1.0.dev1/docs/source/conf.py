...
# -*- coding: utf-8 -*-
#
# jupyterjs documentation build configuration file
#
...
_version_py = os.path.join(repo, 'jupyterjs', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'jupyterjsdoc'
...
latex_documents = [
    (master_doc, 'jupyterjs.tex', 'jupyterjs Documentation',
     'AY', 'manual'),
]
