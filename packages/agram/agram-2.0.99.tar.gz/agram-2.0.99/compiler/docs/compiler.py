...
FUNCTIONS_PATH = "agram/raw/functions"
TYPES_PATH = "agram/raw/types"
BASE_PATH = "agram/raw/base"
...
def generate(source_path, base):
                ...
                with open(DESTINATION + "/" + full_path, "w", encoding="utf-8") as f:
                    f.write(
                        page_template.format(
                            ...
                            full_class_path="agram.raw.{}".format(
    ...
    for k, v in sorted(all_entities.items()):
        ...
        if k != base:
            ...
            module = "agram.raw.{}.{}".format(base, k)
        else:
        ...
        for k, v in categories.items():
            ...
            for method in methods:
                with open(root + "/{}.rst".format(method), "w") as f2:
                    ...
                    f2.write(title + "\n" + "=" * len(title) + "\n\n")
                    f2.write(".. automethod:: agram.Client.{}()".format(method))
            ...
            for func in functions:
                with open(root + "/{}.rst".format(func), "w") as f2:
                    ...
                    f2.write(title + "\n" + "=" * len(title) + "\n\n")
                    f2.write(".. autofunction:: agram.{}()".format(func))
        ...
        for k, v in categories.items():
            ...
            for type in types:
                with open(root + "/{}.rst".format(type), "w") as f2:
                    ...
                    f2.write(title + "\n" + "=" * len(title) + "\n\n")
                    f2.write(".. autoclass:: agram.types.{}()\n".format(type))
        ...
        for k, v in categories.items():
            ...
            for bm in bound_methods:
                with open(root + "/{}.rst".format(bm), "w") as f2:
                    ...
                    f2.write(title + "\n" + "=" * len(title) + "\n\n")
                    f2.write(".. automethod:: agram.types.{}()".format(bm))
