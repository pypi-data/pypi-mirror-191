...
DESTINATION_PATH = Path("agram/raw")
NOTICE_PATH = "NOTICE"
...
def get_docstring_arg_type(t: str):
    if t in CORE_TYPES:
        ...
        return "Any object from :obj:`~agram.raw.types`"
    elif t == "!X":
        return "Any function from :obj:`~agram.raw.functions`"
    elif t.lower().startswith("vector"):
        return "List of " + get_docstring_arg_type(t.split("<", 1)[1][:-1])
    else:
        return f":obj:`{t} <agram.raw.base.{t}>`"
...
def start(format: bool = False):
    ...
    for qualtype in types_to_constructors:
        ...
        docstring += f"\n\n    Constructors:\n" \
                     ...
                     f"        .. currentmodule:: agram.raw.types\n\n" \
                     f"        .. autosummary::\n" \
                     f"            :nosignatures:\n\n" \
                     f"            {items}"
        ...
        if references:
            docstring += f"\n\n    Functions:\n        This object can be returned by " \
                         ...
                         f"        .. currentmodule:: agram.raw.functions\n\n" \
                         f"        .. autosummary::\n" \
                         f"            :nosignatures:\n\n" \
                         f"            " + references
    ...
    for c in combinators:
        ...
        if c.section == "types":
            ...
            docstring += f"\n    Constructor of :obj:`~agram.raw.base.{c.qualtype}`."
        else:
    ...
    with open(DESTINATION_PATH / "all.py", "w", encoding="utf-8") as f:
        ...
        for c in combinators:
            f.write(f'\n    {c.id}: "agram.raw.{c.section}.{c.qualname}",')

        f.write('\n    0xbc799737: "agram.raw.core.BoolFalse",')
        f.write('\n    0x997275b5: "agram.raw.core.BoolTrue",')
        f.write('\n    0x1cb5c415: "agram.raw.core.Vector",')
        f.write('\n    0x73f1f8dc: "agram.raw.core.MsgContainer",')
        f.write('\n    0xae500895: "agram.raw.core.FutureSalts",')
        f.write('\n    0x0949d9dc: "agram.raw.core.FutureSalt",')
        f.write('\n    0x3072cfa1: "agram.raw.core.GzipPacked",')
        f.write('\n    0x5bb8e511: "agram.raw.core.Message",')
