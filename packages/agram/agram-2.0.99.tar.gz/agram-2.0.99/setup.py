...
with open("agram/__init__.py", encoding="utf-8") as f:
...
setup(
    ...
    url="https://github.com/XTIORY",
    download_url="https://github.com/XTIORY/Agram/releases/latest",
    author="Dan",
    author_email="dan@agram.org",
    license="LGPLv3",
    classifiers=[
    ...
    project_urls={
        "Tracker": "https://github.com/XTIORY/agram/issues",
        "Community": "https://t.me/XTIORY",
        "Source": "https://github.com/XTIORY/Agram",
        "Documentation": "https://selamarket.shop",
    },
    python_requires="~=3.7",
    package_data={
        "agram": ["py.typed"],
