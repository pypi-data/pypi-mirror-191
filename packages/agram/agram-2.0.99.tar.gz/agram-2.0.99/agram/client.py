...
import agram
from agram import __version__, __license__
from agram import enums
from agram import raw
from agram import utils
from agram.crypto import aes
from agram.errors import CDNFileHashMismatch
from agram.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    BadRequest
)
from agram.handlers.handler import Handler
from agram.methods import Methods
from agram.session import Auth, Session
from agram.storage import FileStorage, MemoryStorage
from agram.types import User, TermsOfService
from agram.utils import ainput
...
class Client(Methods):
    """agram Client, the main means for interacting with Telegram.
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~agram.Client.export_session_string` before stopping the client to get a session string you can
        ...
        workdir (``str``, *optional*):
            ...
            The working directory is the location in the filesystem where agram will store the session files.
    ...
    APP_VERSION = f"agram {__version__}"
    ...
    async def authorize(self) -> User:
        ...
        print(f"Welcome to agram (version {__version__})")
        print(f"agram is free software and comes with ABSOLUTELY NO WARRANTY. Licensed\n"
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~agram.enums.ParseMode`):
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError("The API key is required for new authorizations. "
                                     "More info: https://docs.agram.org/start/auth")
