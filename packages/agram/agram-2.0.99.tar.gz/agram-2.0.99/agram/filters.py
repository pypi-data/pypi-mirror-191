...
from agram.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "agram.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~agram.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from.
            For example, in a :obj:`~agram.handlers.MessageHandler` the *update* argument will be a :obj:`~agram.types.Message`; in a :obj:`~agram.handlers.CallbackQueryHandler` the *update* will be a :obj:`~agram.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~agram.filters.command` or :meth:`~agram.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~agram.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~agram.types.Document` objects."""
...
"""Filter messages that contain :obj:`~agram.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~agram.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~agram.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~agram.types.Game` objects."""
...
"""Filter messages that contain :obj:`~agram.types.Video` objects."""
...
"""Filter messages that contain :obj:`~agram.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~agram.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~agram.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~agram.types.Location` objects."""
...
"""Filter messages that contain :obj:`~agram.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~agram.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~agram.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~agram.types.Message`.
    ...
    async def func(flt, client: agram.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~agram.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~agram.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~agram.types.InlineQuery`: The filter will match ``query``.
