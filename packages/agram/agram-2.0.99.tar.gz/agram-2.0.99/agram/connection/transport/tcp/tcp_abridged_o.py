...
class TCPAbridgedO(TCP):
    ...
    async def send(self, data: bytes, *args):
        ...
        payload = await self.loop.run_in_executor(agram.crypto_executor, aes.ctr256_encrypt, data, *self.encrypt)
    ...
    async def recv(self, length: int = 0) -> Optional[bytes]:
        ...
        return await self.loop.run_in_executor(agram.crypto_executor, aes.ctr256_decrypt, data, *self.decrypt)
