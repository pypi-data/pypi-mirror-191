...
from agram.connection import Connection
from agram.crypto import aes, rsa, prime
from agram.errors import SecurityCheckMismatch
from agram.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "agram.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
