...
class UserStatusHandler(Handler):
    ...
    It is intended to be used with :meth:`~agram.Client.add_handler`.

    For a nicer way to register this handler, have a look at the :meth:`~agram.Client.on_user_status` decorator.
