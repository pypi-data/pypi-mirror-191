...
class BotCommandScope(Object):
    ...
    - :obj:`~agram.types.BotCommandScopeDefault`
    - :obj:`~agram.types.BotCommandScopeAllPrivateChats`
    - :obj:`~agram.types.BotCommandScopeAllGroupChats`
    - :obj:`~agram.types.BotCommandScopeAllChatAdministrators`
    - :obj:`~agram.types.BotCommandScopeChat`
    - :obj:`~agram.types.BotCommandScopeChatAdministrators`
    - :obj:`~agram.types.BotCommandScopeChatMember`
    ...
    **Commands in group and supergroup chats**
    ...
    async def write(self, client: "agram.Client") -> "raw.base.BotCommandScope":
