...
class InlineKeyboardButton(Object):
    ...
    Parameters:
        ...
        web_app (:obj:`~agram.types.WebAppInfo`, *optional*):
            ...
            method :meth:`~agram.Client.answer_web_app_query`. Available only in private chats between a user and the
            bot.

        login_url (:obj:`~agram.types.LoginUrl`, *optional*):
        ...
        callback_game (:obj:`~agram.types.CallbackGame`, *optional*):
