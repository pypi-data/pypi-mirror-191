...
class MenuButton(Object):
    ...
    - :obj:`~agram.types.MenuButtonCommands`
    - :obj:`~agram.types.MenuButtonWebApp`
    - :obj:`~agram.types.MenuButtonDefault`

    If a menu button other than :obj:`~agram.types.MenuButtonDefault` is set for a private chat, then it is applied
    ...
    async def write(self, client: "agram.Client") -> "raw.base.BotMenuButton":
