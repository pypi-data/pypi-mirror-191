...
import agram
from agram import raw, enums
from agram import types
from agram import utils
from agram.errors import MessageIdsEmpty, PeerIdInvalid
from agram.parser import utils as parser_utils, Parser
...
class Message(Object, Update):
    ...
    Parameters:
        ...
        from_user (:obj:`~agram.types.User`, *optional*):
            Sender, empty for messages sent to channels.

        sender_chat (:obj:`~agram.types.Chat`, *optional*):
        ...
        chat (:obj:`~agram.types.Chat`, *optional*):
            Conversation the message belongs to.

        forward_from (:obj:`~agram.types.User`, *optional*):
        ...
        forward_from_chat (:obj:`~agram.types.Chat`, *optional*):
        ...
        reply_to_message (:obj:`~agram.types.Message`, *optional*):
        ...
        service (:obj:`~agram.enums.MessageServiceType`, *optional*):
        ...
        media (:obj:`~agram.enums.MessageMediaType`, *optional*):
        ...
        entities (List of :obj:`~agram.types.MessageEntity`, *optional*):
            For text messages, special entities like usernames, URLs, bot commands, etc. that appear in the text.

        caption_entities (List of :obj:`~agram.types.MessageEntity`, *optional*):
            For messages with a caption, special entities like usernames, URLs, bot commands, etc. that appear
            in the caption.

        audio (:obj:`~agram.types.Audio`, *optional*):
            Message is an audio file, information about the file.

        document (:obj:`~agram.types.Document`, *optional*):
            Message is a general file, information about the file.

        photo (:obj:`~agram.types.Photo`, *optional*):
            Message is a photo, information about the photo.

        sticker (:obj:`~agram.types.Sticker`, *optional*):
            Message is a sticker, information about the sticker.

        animation (:obj:`~agram.types.Animation`, *optional*):
            Message is an animation, information about the animation.

        game (:obj:`~agram.types.Game`, *optional*):
            Message is a game, information about the game.

        video (:obj:`~agram.types.Video`, *optional*):
            Message is a video, information about the video.

        voice (:obj:`~agram.types.Voice`, *optional*):
            Message is a voice message, information about the file.

        video_note (:obj:`~agram.types.VideoNote`, *optional*):
        ...
        contact (:obj:`~agram.types.Contact`, *optional*):
            Message is a shared contact, information about the contact.

        location (:obj:`~agram.types.Location`, *optional*):
            Message is a shared location, information about the location.

        venue (:obj:`~agram.types.Venue`, *optional*):
            Message is a venue, information about the venue.

        web_page (:obj:`~agram.types.WebPage`, *optional*):
            Message was sent with a webpage preview.

        poll (:obj:`~agram.types.Poll`, *optional*):
            Message is a native poll, information about the poll.

        dice (:obj:`~agram.types.Dice`, *optional*):
            A dice containing a value that is randomly generated by Telegram.

        new_chat_members (List of :obj:`~agram.types.User`, *optional*):
            New members that were added to the group or supergroup and information about them
            (the bot itself may be one of these members).

        left_chat_member (:obj:`~agram.types.User`, *optional*):
            A member was removed from the group, information about them (this member may be the bot itself).

        new_chat_title (``str``, *optional*):
            A chat title was changed to this value.

        new_chat_photo (:obj:`~agram.types.Photo`, *optional*):
        ...
        pinned_message (:obj:`~agram.types.Message`, *optional*):
            Specified message was pinned.
            Note that the Message object in this field will not contain further reply_to_message fields even if it
            is itself a reply.

        game_high_score (:obj:`~agram.types.GameHighScore`, *optional*):
	...
	forwards (``int``, *optional*):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the text of this message. Only applicable when using :obj:`Filters.regex <agram.Filters.regex>`.

        command (List of ``str``, *optional*):
            A list containing the command and its arguments, if any.
            E.g.: "/start 1 2 3" would produce ["start", "1", "2", "3"].
            Only applicable when using :obj:`~agram.filters.command`.

        video_chat_scheduled (:obj:`~agram.types.VideoChatScheduled`, *optional*):
            Service message: voice chat scheduled.

        video_chat_started (:obj:`~agram.types.VideoChatStarted`, *optional*):
            Service message: the voice chat started.

        video_chat_ended (:obj:`~agram.types.VideoChatEnded`, *optional*):
            Service message: the voice chat has ended.

        video_chat_members_invited (:obj:`~agram.types.VoiceChatParticipantsInvited`, *optional*):
            Service message: new members were invited to the voice chat.

        web_app_data (:obj:`~agram.types.WebAppData`, *optional*):
            Service message: web app data sent to the bot.

        reply_markup (:obj:`~agram.types.InlineKeyboardMarkup` | :obj:`~agram.types.ReplyKeyboardMarkup` | :obj:`~agram.types.ReplyKeyboardRemove` | :obj:`~agram.types.ForceReply`, *optional*):
            Additional interface options. An object for an inline keyboard, custom reply keyboard,
            instructions to remove reply keyboard or to force a reply from the user.

        reactions (List of :obj:`~agram.types.Reaction`):
    ...
    async def get_media_group(self) -> List["types.Message"]:
        """Bound method *get_media_group* of :obj:`~agram.types.Message`.
        ...
        Returns:
            List of :obj:`~agram.types.Message`: On success, a list of messages of the media group is returned.
    ...
    async def reply_text(
        ...
        """Bound method *reply_text* of :obj:`~agram.types.Message`.
        ...
        Parameters:
            ...
            parse_mode (:obj:`~agram.enums.ParseMode`, *optional*):
                By default, texts are parsed using both Markdown and HTML styles.
                You can combine both syntaxes together.

            entities (List of :obj:`~agram.types.MessageEntity`):
    ...
    async def reply_animation(
        ...
        """Bound method *reply_animation* :obj:`~agram.types.Message`.
        ...
        Parameters:
            ...
            caption_entities (List of :obj:`~agram.types.MessageEntity`):
        ...
        Returns:
            On success, the sent :obj:`~agram.types.Message` is returned.
            In case the upload is deliberately stopped with :meth:`~agram.Client.stop_transmission`, None is returned
            instead.
    ...
    async def reply_audio(
        ...
        """Bound method *reply_audio* of :obj:`~agram.types.Message`.
    ...
    async def reply_cached_media(
        ...
        """Bound method *reply_cached_media* of :obj:`~agram.types.Message`.
    ...
    async def reply_chat_action(self, action: "enums.ChatAction") -> bool:
        """Bound method *reply_chat_action* of :obj:`~agram.types.Message`.

        Use as a shortcut for:

        .. code-block:: python

            from agram import enums
        ...
        Parameters:
            action (:obj:`~agram.enums.ChatAction`):
    ...
    async def reply_contact(
        ...
        """Bound method *reply_contact* of :obj:`~agram.types.Message`.
    ...
    async def reply_document(
        ...
        """Bound method *reply_document* of :obj:`~agram.types.Message`.
    ...
    async def reply_game(
        ...
        """Bound method *reply_game* of :obj:`~agram.types.Message`.
        ...
        Parameters:
            ...
            reply_markup (:obj:`~agram.types.InlineKeyboardMarkup`, *optional*):
    ...
    async def reply_inline_bot_result(
        ...
        """Bound method *reply_inline_bot_result* of :obj:`~agram.types.Message`.
    ...
    async def reply_location(
        ...
        """Bound method *reply_location* of :obj:`~agram.types.Message`.
    ...
    async def reply_media_group(
        ...
        """Bound method *reply_media_group* of :obj:`~agram.types.Message`.
        ...
        Parameters:
            media (``list``):
                A list containing either :obj:`~agram.types.InputMediaPhoto` or
                :obj:`~agram.types.InputMediaVideo` objects
        ...
        Returns:
            On success, a :obj:`~agram.types.Messages` object is returned containing all the
    ...
    async def reply_photo(
        ...
        """Bound method *reply_photo* of :obj:`~agram.types.Message`.
    ...
    async def reply_poll(
        ...
        """Bound method *reply_poll* of :obj:`~agram.types.Message`.
        ...
        Parameters:
            ...
            type (:obj`~agram.enums.PollType`, *optional*):
                Poll type, :obj:`~agram.enums.PollType.QUIZ` or :obj:`~agram.enums.PollType.REGULAR`.
                Defaults to :obj:`~agram.enums.PollType.REGULAR`.
            ...
            explanation_parse_mode (:obj:`~agram.enums.ParseMode`, *optional*):
                By default, texts are parsed using both Markdown and HTML styles.
                You can combine both syntaxes together.

            explanation_entities (List of :obj:`~agram.types.MessageEntity`):
    ...
    async def reply_sticker(
        ...
        """Bound method *reply_sticker* of :obj:`~agram.types.Message`.
    ...
    async def reply_venue(
        ...
        """Bound method *reply_venue* of :obj:`~agram.types.Message`.
    ...
    async def reply_video(
        ...
        """Bound method *reply_video* of :obj:`~agram.types.Message`.
    ...
    async def reply_video_note(
        ...
        """Bound method *reply_video_note* of :obj:`~agram.types.Message`.
    ...
    async def reply_voice(
        ...
        """Bound method *reply_voice* of :obj:`~agram.types.Message`.
    ...
    async def edit_text(
        ...
        """Bound method *edit_text* of :obj:`~agram.types.Message`.
        ...
        Returns:
            On success, the edited :obj:`~agram.types.Message` is returned.
    ...
    async def edit_caption(
        ...
        """Bound method *edit_caption* of :obj:`~agram.types.Message`.
    ...
    async def edit_media(
        ...
        """Bound method *edit_media* of :obj:`~agram.types.Message`.
        ...
        Parameters:
            media (:obj:`~agram.types.InputMedia`):
    ...
    async def edit_reply_markup(self, reply_markup: "types.InlineKeyboardMarkup" = None) -> "Message":
        """Bound method *edit_reply_markup* of :obj:`~agram.types.Message`.
        ...
        Parameters:
            reply_markup (:obj:`~agram.types.InlineKeyboardMarkup`):
                An InlineKeyboardMarkup object.

        Returns:
            On success, if edited message is sent by the bot, the edited
            :obj:`~agram.types.Message` is returned, otherwise True is returned.
    ...
    async def forward(
        ...
        """Bound method *forward* of :obj:`~agram.types.Message`.
    ...
    async def copy(
        ...
        """Bound method *copy* of :obj:`~agram.types.Message`.
        ...
        Returns:
            :obj:`~agram.types.Message`: On success, the copied message is returned.
    ...
    async def delete(self, revoke: bool = True):
        """Bound method *delete* of :obj:`~agram.types.Message`.
    ...
    async def click(self, x: Union[int, str] = 0, y: int = None, quote: bool = None, timeout: int = 10):
        """Bound method *click* of :obj:`~agram.types.Message`.
        ...
        Returns:
            -   The result of :meth:`~agram.Client.request_callback_answer` in case of inline callback button clicks.
    ...
    async def react(self, emoji: str = "", big: bool = False) -> bool:
        """Bound method *react* of :obj:`~agram.types.Message`.
    ...
    async def retract_vote(
        ...
        """Bound method *retract_vote* of :obj:`~agram.types.Message`.
        ...
        Returns:
            :obj:`~agram.types.Poll`: On success, the poll with the retracted vote is returned.
    ...
    async def download(
        ...
        """Bound method *download* of :obj:`~agram.types.Message`.
    ...
    async def vote(
        ...
        """Bound method *vote* of :obj:`~agram.types.Message`.
        ...
        Returns:
            :obj:`~agram.types.Poll`: On success, the poll with the chosen option is returned.
    ...
    async def pin(self, disable_notification: bool = False, both_sides: bool = False) -> "types.Message":
        """Bound method *pin* of :obj:`~agram.types.Message`.
        ...
        Returns:
            :obj:`~agram.types.Message`: On success, the service message is returned.
    ...
    async def unpin(self) -> bool:
        """Bound method *unpin* of :obj:`~agram.types.Message`.
