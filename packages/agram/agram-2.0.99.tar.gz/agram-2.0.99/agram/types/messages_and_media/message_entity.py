...
class MessageEntity(Object):
    ...
    Parameters:
        type (:obj:`~agram.enums.MessageEntityType`):
            Type of the entity.
        ...
        url (``str``, *optional*):
            For :obj:`~agram.enums.MessageEntityType.TEXT_LINK` only, url that will be opened after user taps on the text.

        user (:obj:`~agram.types.User`, *optional*):
            For :obj:`~agram.enums.MessageEntityType.TEXT_MENTION` only, the mentioned user.

        language (``str``, *optional*):
            For "pre" only, the programming language of the entity text.

        custom_emoji_id (``int``, *optional*):
            For :obj:`~agram.enums.MessageEntityType.CUSTOM_EMOJI` only, unique identifier of the custom emoji.
            Use :meth:`~agram.Client.get_custom_emoji_stickers` to get full information about the sticker.
    """
