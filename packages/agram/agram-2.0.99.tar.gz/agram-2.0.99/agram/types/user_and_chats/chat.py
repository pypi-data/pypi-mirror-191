...
class Chat(Object):
    ...
    Parameters:
        ...
        photo (:obj:`~agram.types.ChatPhoto`, *optional*):
            Chat photo. Suitable for downloads only.

        bio (``str``, *optional*):
            Bio of the other party in a private chat.
            Returned only in :meth:`~agram.Client.get_chat`.
        ...
        restrictions (List of :obj:`~agram.types.Restriction`, *optional*):
            The list of reasons why this chat might be unavailable to some users.
            This field is available only in case *is_restricted* is True.

        permissions (:obj:`~agram.types.ChatPermissions` *optional*):
            Default chat member permissions, for groups and supergroups.

        distance (``int``, *optional*):
            Distance in meters of this group chat from your location.
            Returned only in :meth:`~agram.Client.get_nearby_chats`.

        linked_chat (:obj:`~agram.types.Chat`, *optional*):
            The linked discussion group (in case of channels) or the linked channel (in case of supergroups).
            Returned only in :meth:`~agram.Client.get_chat`.

        send_as_chat (:obj:`~agram.types.Chat`, *optional*):
            The default "send_as" chat.
            Returned only in :meth:`~agram.Client.get_chat`.

        available_reactions (:obj:`~agram.types.ChatReactions`, *optional*):
    ...
    async def archive(self):
        """Bound method *archive* of :obj:`~agram.types.Chat`.
    ...
    async def unarchive(self):
        """Bound method *unarchive* of :obj:`~agram.types.Chat`.
    ...
    async def set_title(self, title: str) -> bool:
        """Bound method *set_title* of :obj:`~agram.types.Chat`.
    ...
    async def set_description(self, description: str) -> bool:
        """Bound method *set_description* of :obj:`~agram.types.Chat`.
    ...
    async def set_photo(
        ...
        *,
        ...
        """Bound method *set_photo* of :obj:`~agram.types.Chat`.
        ...
        Parameters:
            photo (``str`` | ``BinaryIO``, *optional*):
                New chat photo. You can pass a :obj:`~agram.types.Photo` file_id, a file path to upload a new photo
                from your local machine or a binary file-like object with its attribute
                ".name" set for in-memory uploads.

            video (``str`` | ``BinaryIO``, *optional*):
                New chat video. You can pass a :obj:`~agram.types.Video` file_id, a file path to upload a new video
                from your local machine or a binary file-like object with its attribute
                ".name" set for in-memory uploads.
    ...
    async def ban_member(
        ...
        """Bound method *ban_member* of :obj:`~agram.types.Chat`.
        ...
        Returns:
            :obj:`~agram.types.Message` | ``bool``: On success, a service message will be returned (when applicable), otherwise, in
    ...
    async def unban_member(
        ...
        """Bound method *unban_member* of :obj:`~agram.types.Chat`.
    ...
    async def restrict_member(
        ...
        Parameters:
            ...
            permissions (:obj:`~agram.types.ChatPermissions`):
        ...
        Returns:
            :obj:`~agram.types.Chat`: On success, a chat object is returned.
    ...
    async def promote_member(
        ...
        """Bound method *promote_member* of :obj:`~agram.types.Chat`.
        ...
        Parameters:
            ...
            privileges (:obj:`~agram.types.ChatPrivileges`, *optional*):
                New user privileges.
    ...
    async def join(self):
        """Bound method *join* of :obj:`~agram.types.Chat`.
    ...
    async def leave(self):
        """Bound method *leave* of :obj:`~agram.types.Chat`.
    ...
    async def export_invite_link(self):
        """Bound method *export_invite_link* of :obj:`~agram.types.Chat`.
    ...
    async def get_member(
        ...
        """Bound method *get_member* of :obj:`~agram.types.Chat`.
        ...
        Returns:
            :obj:`~agram.types.ChatMember`: On success, a chat member is returned.
        """
    ...
    def get_members(
        ...
        """Bound method *get_members* of :obj:`~agram.types.Chat`.
        ...
        Parameters:
            query (``str``, *optional*):
                ...
                A query string is applicable only for :obj:`~agram.enums.ChatMembersFilter.SEARCH`,
                :obj:`~agram.enums.ChatMembersFilter.BANNED` and :obj:`~agram.enums.ChatMembersFilter.RESTRICTED`
                filters only.

            limit (``int``, *optional*):
                Limits the number of members to be retrieved.

            filter (:obj:`~agram.enums.ChatMembersFilter`, *optional*):
                Filter used to select the kind of members you want to retrieve. Only applicable for supergroups
                and channels.

        Returns:
            ``Generator``: On success, a generator yielding :obj:`~agram.types.ChatMember` objects is returned.
        """
    ...
    async def add_members(
        ...
        """Bound method *add_members* of :obj:`~agram.types.Chat`.
    ...
    async def mark_unread(self, ) -> bool:
        """Bound method *mark_unread* of :obj:`~agram.types.Chat`.
    ...
    async def set_protected_content(self, enabled: bool) -> bool:
        """Bound method *set_protected_content* of :obj:`~agram.types.Chat`.
    ...
    async def unpin_all_messages(self) -> bool:
        """Bound method *unpin_all_messages* of :obj:`~agram.types.Chat`.
