...
class ChatJoinRequest(Object, Update):
    ...
    Parameters:
        ...
        invite_link (:obj:`~agram.types.ChatInviteLink`, *optional*):
    ...
    async def approve(self) -> bool:
        """Bound method *approve* of :obj:`~agram.types.ChatJoinRequest`.
    ...
    async def decline(self) -> bool:
        """Bound method *decline* of :obj:`~agram.types.ChatJoinRequest`.
