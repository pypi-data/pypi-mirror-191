...
class User(Object, Update):
    ...
    Parameters:
        ...
        status (:obj:`~agram.enums.UserStatus`, *optional*):
            User's last seen & online status. ``None``, for bots.

        last_online_date (:py:obj:`~datetime.datetime`, *optional*):
            Last online date of a user. Only available in case status is :obj:`~agram.enums.UserStatus.OFFLINE`.

        next_offline_date (:py:obj:`~datetime.datetime`, *optional*):
            Date when a user will automatically go offline. Only available in case status is :obj:`~agram.enums.UserStatus.ONLINE`.
        ...
        emoji_status (:obj:`~agram.types.EmojiStatus`, *optional*):
            Emoji status.
    ...
    async def archive(self):
        """Bound method *archive* of :obj:`~agram.types.User`.
    ...
    async def unarchive(self):
        """Bound method *unarchive* of :obj:`~agram.types.User`.
    ...
    def block(self):
        """Bound method *block* of :obj:`~agram.types.User`.
    ...
    def unblock(self):
        """Bound method *unblock* of :obj:`~agram.types.User`.
    ...
    def get_common_chats(self):
        """Bound method *get_common_chats* of :obj:`~agram.types.User`.
