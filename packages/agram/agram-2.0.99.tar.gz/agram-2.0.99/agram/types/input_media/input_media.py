...
class InputMedia(Object):
    ...
    - :obj:`~agram.types.InputMediaAnimation`
    - :obj:`~agram.types.InputMediaDocument`
    - :obj:`~agram.types.InputMediaAudio`
    - :obj:`~agram.types.InputMediaPhoto`
    - :obj:`~agram.types.InputMediaVideo`
    """
