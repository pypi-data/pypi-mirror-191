...
class GetBotCommands:
    async def get_bot_commands(
        ...
        Parameters:
            scope (:obj:`~agram.types.BotCommandScope`, *optional*):
                An object describing the scope of users for which the commands are relevant.
                Defaults to :obj:`~agram.types.BotCommandScopeDefault`.
        ...
        Returns:
            List of :obj:`~agram.types.BotCommand`: On success, the list of bot commands is returned.
