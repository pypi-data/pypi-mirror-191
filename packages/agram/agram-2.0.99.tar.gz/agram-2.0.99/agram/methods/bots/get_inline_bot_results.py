...
from agram.errors import UnknownError
...
class GetInlineBotResults:
    async def get_inline_bot_results(
        ...
        You can then send a result using :meth:`~agram.Client.send_inline_bot_result`
        ...
        Returns:
            :obj:`BotResults <agram.api.types.messages.BotResults>`: On Success.
        ...
        Example:
            .. code-block:: python
                ...
                results = await app.get_inline_bot_results("agrambot")
                print(results)
        """
