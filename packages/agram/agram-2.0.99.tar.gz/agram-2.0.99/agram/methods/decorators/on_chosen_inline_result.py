...
import agram
from agram.filters import Filter
...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        This does the same thing as :meth:`~agram.Client.add_handler` using the
        :obj:`~agram.handlers.ChosenInlineResultHandler`.

        Parameters:
            filters (:obj:`~agram.filters`, *optional*):
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, agram.Client):
                self.add_handler(agram.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        agram.handlers.ChosenInlineResultHandler(func, self),
