...
class OnChatMemberUpdated:
    def on_chat_member_updated(
        ...
        :obj:`~agram.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, agram.Client):
                self.add_handler(agram.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        agram.handlers.ChatMemberUpdatedHandler(func, self),
