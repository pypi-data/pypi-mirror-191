...
class OnChatJoinRequest:
    def on_chat_join_request(
        ...
        :obj:`~agram.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, agram.Client):
                self.add_handler(agram.handlers.ChatJoinRequestHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        agram.handlers.ChatJoinRequestHandler(func, self),
