...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~agram.types.InputMediaPhoto`, :obj:`~agram.types.InputMediaVideo`, :obj:`~agram.types.InputMediaAudio` and :obj:`~agram.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~agram.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from agram.types import InputMediaPhoto, InputMediaVideo
