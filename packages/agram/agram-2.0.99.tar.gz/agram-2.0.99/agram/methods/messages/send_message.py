...
import agram
from agram import raw, utils, enums
...
class SendMessage:
    async def send_message(
        ...
        Returns:
            :obj:`~agram.types.Message`: On success, the sent text message is returned.

        Example:
            .. code-block:: python

                # Simple example
                await app.send_message("me", "Message sent with **agram**!")

                # Disable web page previews
                await app.send_message("me", "https://docs.agram.org",
                ...
                await app.send_message(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [InlineKeyboardButton("Docs", url="https://docs.agram.org")]
                        ]))
        """
