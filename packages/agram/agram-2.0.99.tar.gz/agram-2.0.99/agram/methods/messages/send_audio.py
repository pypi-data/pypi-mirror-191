...
import agram
from agram import StopTransmission, enums
from agram import raw
from agram import types
from agram import utils
from agram.errors import FilePartMissing
from agram.file_id import FileType
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~agram.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~agram.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~agram.Client.stop_transmission`, None is returned.
