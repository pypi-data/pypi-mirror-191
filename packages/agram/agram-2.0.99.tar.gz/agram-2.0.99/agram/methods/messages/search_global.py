...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~agram.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~agram.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~agram.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "agram". Get the first 50 results
                async for message in app.search_global("agram", limit=50):
                    print(message.text)
