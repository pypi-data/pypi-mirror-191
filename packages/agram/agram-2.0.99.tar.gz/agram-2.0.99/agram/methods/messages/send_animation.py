...
class SendAnimation:
    async def send_animation(
        ...
        Returns:
            :obj:`~agram.types.Message` | ``None``: On success, the sent animation message is returned, otherwise,
            in case the upload is deliberately stopped with :meth:`~agram.Client.stop_transmission`, None is
            returned.
