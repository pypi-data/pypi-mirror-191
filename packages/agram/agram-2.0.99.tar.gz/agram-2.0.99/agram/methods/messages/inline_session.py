...
from agram.errors import AuthBytesInvalid
from agram.session import Session
from agram.session.auth import Auth


async def get_session(client: "agram.Client", dc_id: int):
