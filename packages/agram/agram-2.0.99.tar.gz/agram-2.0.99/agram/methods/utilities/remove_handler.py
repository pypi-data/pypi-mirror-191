...
import agram
from agram.handlers import DisconnectHandler
...
class RemoveHandler:
    def remove_handler(
        ...
        :meth:`~agram.Client.add_handler` method, a tuple of *(handler, group)*, and pass it directly.
        ...
        Example:
            .. code-block:: python
                ...
                from agram.handlers import MessageHandler
