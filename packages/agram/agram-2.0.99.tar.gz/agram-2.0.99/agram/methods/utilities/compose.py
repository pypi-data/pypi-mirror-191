...
async def compose(
    clients: List["agram.Client"],
    sequential: bool = False
):
    """Run multiple clients at once.

    This method can be used to run multiple clients at once and can be found directly in the ``agram`` package.

    If you want to run a single client, you can use Client's bound method :meth:`~agram.Client.run`.

    Parameters:
        clients (List of :obj:`~agram.Client`):
    ...
    Example:
        .. code-block:: python
            ...
            import asyncio
            from agram import Client, compose
