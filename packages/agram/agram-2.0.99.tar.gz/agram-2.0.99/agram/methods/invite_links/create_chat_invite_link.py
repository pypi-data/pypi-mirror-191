...
class CreateChatInviteLink:
    async def create_chat_invite_link(
        ...
        The link can be revoked using the method :meth:`~agram.Client.revoke_chat_invite_link`.
        ...
        Returns:
            :obj:`~agram.types.ChatInviteLink`: On success, the new invite link is returned.
