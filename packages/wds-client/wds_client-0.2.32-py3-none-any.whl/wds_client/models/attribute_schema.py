...
class AttributeSchema(object):
    ...
    def datatype(self, datatype):
        ...
        allowed_values = ["boolean", "date", "datetime", "string", "json", "long", "double", "relation", "file", "array_of_boolean", "array_of_string", "array_of_number", "array_of_date", "array_of_datetime", "array_of_relation", "array_of_file"]  # noqa: E501
