    ...
    def attempt_to_resolve_jobs(self, inprocess_jobs, current_time):
        for job_doc in inprocess_jobs:
            ...
            if (parent_ref is None and child_job_spawning_status != 'unfinished'):
                print("Child_job_spawning_status...", flush=True)
                print(child_job_spawning_status, flush=True)
                ...
                print("job_finished", flush=True)
                print(str(job_finished), flush=True)
                print("total_child_job_count", flush=True)
                print(str(total_child_job_count), flush=True)
                print("failed_job_count", flush=True)
                print(str(failed_job_count), flush=True)
                print("_max_child_errors", flush=True)
                print(str(_max_child_errors), flush=True)
