...
class Cam3d(CamstimSyncShared):
    ...
    @classmethod
    def is_ready_to_start(cls) -> bool:
        return cls.get_state() != ["READY", "CAMERAS_CLOSED"]
    ...
    def finalize(cls) -> None:
        ...
        while (
            ...
            or not (data := cls.get_latest_data('*'))
        ):
            time.sleep(1)
        cls.data_files.extend(data)
        print(f"{cls.__name__} | Images captured: {cls.data_files}")
