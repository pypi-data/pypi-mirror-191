...
from crop_coach.envs.sample_soil_site_dict import sample_soil_dict, sample_site_dict
...
class WofostEnv(gym.Env):
    ...
    def step(self, action):
        ...
        site_dict, soil_dict,self.crop_name, self.crop_variety,self.files_paths, self.latitude, self.longitude
            )
        ...
        self.state = np.concatenate((self.state, np.array(list(chain.from_iterable([list(site_dict.values()), list(soil_dict.values()), self.state])))))
