...
def calculate_reward(
    ...
    reward = Yield * Costs_dict["Selling"] - (
        Irr_disc_factor * Irr_amount * Irr_freq * Costs_dict["Irrigation"]
        + N_disc_factor * N_amount * Fert_freq * Costs_dict["N"]
        + P_disc_factor * P_amount * Fert_freq * Costs_dict["P"]
        + K_disc_factor * K_amount * Fert_freq * Costs_dict["K"]
    )
