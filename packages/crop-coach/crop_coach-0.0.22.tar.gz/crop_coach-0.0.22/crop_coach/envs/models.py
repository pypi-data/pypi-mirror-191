    ...
    def init_wofost(site_dict, soil_dict,crop_name, crop_variety, files_paths : dict,latitude: float = 51.97, longitude: float = 5.67):
        ...
        if files_paths == None:
            for file in cabo_files:
                ...
                data_["soil"] = read_cabo_file(generate_soil_cab(soil_dict["water_retention_dict"], soil_dict["hydraulic_conductivity_dict"], soil_dict["workability_parameters_dict"]))
        else:
            for file in cabo_files:
