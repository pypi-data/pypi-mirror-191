...
# get the current file dir
  dir_to_save = os.path.join(os.path.dirname(__file__), "step_data")
  with open(dir_to_save+"/step_site.cab", "w") as f:
    ...
    f.write("\n\n")
  return dir_to_save+"/step_site.cab"

# Remove a file
def remove_file():
    dir_to_save = os.path.join(os.path.dirname(__file__), "step_data")
    os.remove(dir_to_save+"/step_site.cab")
