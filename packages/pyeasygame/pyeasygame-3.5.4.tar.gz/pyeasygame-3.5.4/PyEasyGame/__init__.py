...
class Bar:
    def __init__(self,x,y,width,height,health,health_color,background_color=(255,0,0),border_radius=5,border_img=None,draw_bar=True):
        self.x = x
        self.y = y
        self.h = height
    ...
    def draw(self,current_health):
        ...
        if self.draw_bar:
            if self.border_img != None:
                pygame.draw.rect(screen, self.bg_color, (self.x,self.y,self.border_img.get_width(),self.border_img.get_height()))
