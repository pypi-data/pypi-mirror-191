...
class mcpull_fit:
    ...
    #---------------------------------
    def __init__(self, gen=None, fit=None, nsamples=None):
        self._gen_pdf     = gen
    ...
    def _plot_fit(self, pdf, res, ind):
        ...
        plt_path= f'{plt_dir}/fit_{ind:03}.png'
...
class mcpull_plt:
    ...
    def _plot_residual(self, varname, arr_resi):
        ...
        plot_path = f'{plot_dir}/residual.png'
    ...
    def _plot_error(self, varname, arr_error):
        ...
        plot_path = f'{plot_dir}/error.png'
    ...
    def _plot_dist(self, varname, arr_fit_val, ini_val):
        ...
        plot_path = f'{plot_dir}/distribution.png'
