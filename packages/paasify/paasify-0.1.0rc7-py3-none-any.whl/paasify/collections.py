...
def gen_schema_doc(schema_file, dest_dir, filename, config=None):
    ...
    config = get_final_config(**final_config)
...
class CollectionDocumator(PaasifyObj):
    ...
    def generate(
        ...
        jsonnet_list = self.generate_jsonnet(sta, dest_dir)
        app_list = self.generate_apps(dest_dir)
        self.generate_index(dest_dir, app_list=app_list, jsonnet_list=jsonnet_list)
        if mkdocs_config:
            self.generate_mkdoc_config(mkdocs_config)
    ...
    def generate_apps(self, dest_dir):
        "Generate apps doc"
    ...
    def generate_jsonnet(self, sta, dest_dir):
    ...
    def generate_index(self, dest_dir, app_list=None, jsonnet_list=None):
    ...
    def generate_mkdoc_config(self, dest_dir):
        "Generate mkdocs config"

        print("Gen mkdocs", dest_dir)
