...
async def absent(
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_absent:
              gcp.compute.health_check.absent:
                - name: value
                - project: value
    """
    result = {
    ...
    if ctx.get("rerun_data"):
        ...
        result["comment"].append(
            hub.tool.gcp.comment_utils.delete_comment(
                "gcp.compute.health_check", result["old_state"].get("name", None)
            )
        )
        return result
    ...
    get_ret = await hub.exec.gcp.compute.health_check.get(ctx, resource_id=resource_id)
    ...
    delete_ret = await hub.exec.gcp_api.client.compute.health_check.delete(
        ctx,
        resource_id=resource_id,
        request_id=request_id,
        project=project,
...
async def describe(hub, ctx) -> Dict[str, Dict[str, Any]]:
    ...
    Examples:
        .. code-block:: bash
            ...
            $ idem describe gcp_auto.compute.health_check
    """
    result = {}
