    ...
    Args:
        ...
        Examples:
            ...
            .. code-block:: sls
                ...
                resource_is_present:
                  gcp_auto.compute.forwarding_rules.present:
                    - name: value
                    - region: value
                    - project: value
...
async def absent(
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_absent:
              gcp.compute.forwarding_rule.absent:
                - name: value
                - project: value
    """
    result = {
    ...
    if ctx.get("rerun_data"):
        # delete() has been called on some previous iteration, check the operation
        handle_operation_ret = await hub.tool.gcp.operation_utils.handle_operation(
            ctx, ctx.get("rerun_data"), "compute.forwarding_rule"
        )
        ...
        result["comment"].append(
            hub.tool.gcp.comment_utils.delete_comment(
                "gcp.compute.forwarding_rule", result["old_state"].get("name", None)
            )
        )
        return result
    ...
    if not resource_id:
        ...
        resource_id = (ctx.get("old_state") or {}).get(
            ...
            "compute.forwarding_rule", {**locals(), "name": name}
        )

    get_ret = await hub.exec.gcp.compute.forwarding_rule.get(
    ...
    delete_ret = await hub.exec.gcp_api.client.compute.forwarding_rule.delete(
        ctx,
        resource_id=resource_id,
        request_id=request_id,
        project=project,
...
async def describe(hub, ctx) -> Dict[str, Dict[str, Any]]:
    ...
    Examples:
        .. code-block:: bash
            ...
            $ idem describe gcp_auto.compute.forwarding_rule
    """
    result = {}
