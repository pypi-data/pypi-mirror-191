...
class MonolithicResultInfo(Bunch):
    """ MonolithicResultInfo """
...
class MonolithicResultMetrics(Bunch):
    """ PartialResultMetrics """
...
class MonolithicResult(Bunch):
    """
        ...
        info : MonolithicResultInfo object with meta-information about the final result

        labels : numpy array with clustering labels

        """
    def __init__(self, info, metrics, labels):
        if not isinstance(info, MonolithicResultInfo):
            raise RuntimeError('info must be instance of MonolithicResultInfo')
        if not isinstance(metrics, MonolithicResultMetrics):
            raise RuntimeError('info must be instance of MonolithicResultMetrics')
