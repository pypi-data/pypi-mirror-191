...
class Column:
    ...
    def violation_of_type(self, value):
        ...
        if self.data_type.value == DataType.FLOAT.value:
            ...
            return not (isinstance(value, float) or isinstance(value, int) or pandas.api.types.is_numeric_dtype(value))
        if self.data_type.value == DataType.INTEGER.value:
            ...
            if isinstance(value, float) or pandas.api.types.is_float_dtype(value):
                if int(value) == value:
                    value = int(value)
            return not (isinstance(value, int) or pandas.api.types.is_integer_dtype(value))
