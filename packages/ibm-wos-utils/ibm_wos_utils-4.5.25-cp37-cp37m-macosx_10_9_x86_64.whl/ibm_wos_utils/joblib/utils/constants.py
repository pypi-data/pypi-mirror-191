...
WOS_ENV_LOCATION = "$mount_path/py_packages/wos_env/lib/python3.7/site-packages:$mount_path/py_packages/wos_env/lib/python3.8/site-packages:$mount_path/py_packages/wos_env/lib/python3.9/site-packages"
