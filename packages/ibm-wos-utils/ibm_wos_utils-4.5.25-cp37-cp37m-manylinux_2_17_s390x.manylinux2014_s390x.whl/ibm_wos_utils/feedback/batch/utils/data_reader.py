...
class DataReader():
        ...
        if storage_type == StorageType.HIVE.value:
            ...
            if location_type is None or location_type == LocationType.HIVE_METASTORE.value:
                ...
                if not is_skip_header_defined:
                    ...
                    sql_query = "select {}, {}, {}, {}, {} from {}.{}".format(label_col, prediction_col, probability_column, scoring_id_col, timestamp_col,
                        db_name, table_name)
    ...
    def get_sql_query_tbl_properties(self, spark, db_name, table_name, scoring_id_col):
        ...
        if ("skip.header.line.count" in property_keys):
            ...
            sql_query = "select {}, {}, {}, {}, {} from {}.{} where NVL({}, \"{}\") != \"{}\"".format(self.label_col, self.prediction_col, self.probability_column , self.scoring_id_col, self.scoring_timestamp_col, db_name,
