...
try:
    ...
    def Write(Data, ChannelMap=None, System=None): print(Msg)
    def Read(Samples, ChannelMap=None, System=None): print(Msg)
    def ReadWrite(Data, System=None, OutMap=None, InMap=None): print(Msg)
    Avail = False
