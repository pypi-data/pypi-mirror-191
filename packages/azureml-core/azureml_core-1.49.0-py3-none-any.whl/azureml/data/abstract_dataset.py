    ...
    def _load(path: str, workspace):
        ...
        with open(local_yaml_path, "r") as stream:
            try:
                ...
                raise UserErrorException("MLTable yaml is invalid")
                ...
                if ex.error_code and ex.error_code == "ScriptExecution.StreamAccess.Validation":
                    _get_logger().warning(f'Failed to load mltable. Validation Error Code: {ex.validation_error_code};'
