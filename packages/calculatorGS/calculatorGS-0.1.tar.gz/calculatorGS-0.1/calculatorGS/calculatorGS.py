...
class Calculator:
    ...
    def __init__(self, memory: int | float = 0.0, precision: int = 1):
        # Run validations to received arguments
        assert (
            precision >= 0
        ), f"The precision of the calculator display can only be a non-negative integer."
    ...
    def display(self):
        ...
        print(f"Current calculator value: {self.__memory: .{self.precision}f}")
