...
def get_config(args):
    ...
    reg_mag_mask = read_msg(socket, "r", 5)  # Magnetometer bitmask
    ...
    cfg.set("default", "use_magnetometer", hex(reg_mag_mask))
...
def set_config(args):
    ...
    mag_mask = int(cfg.get("default", "use_magnetometer"), 0) & 0xFFFF
