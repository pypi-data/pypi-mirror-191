...
SERVICE_NAME = afilter_pb2.DESCRIPTOR.services_by_name['Filter'].full_name
...
class HealthServicer(object):
    ...
    def __init__(self,
        ...
        self._server_status = {"afilter": afilter_pb2.HealthCheckResponse.SERVING}
    ...
    def Check(self, request, context):
        with self._lock:
            ...
            if status is None:
                ...
                return afilter_pb2.HealthCheckResponse()
            else:
                return afilter_pb2.HealthCheckResponse(status=status)
        ...
        with self._lock:
            if self._gracefully_shutting_down:
                ...
                for service in self._server_status:
                    self.set(service,
                                afilter_pb2.HealthCheckResponse.NOT_SERVING)  # pylint: disable=no-member
