...
def _connection_factory(connection_name: str, parameter_as_json: bool, use_all_jars: bool) -> BaseConnection:
    ...
    connections_factory = {
        "jdbc": "looqbox.database.objects.connection_jdbc.JDBCConnection",
        "mongo_db": "looqbox.database.objects.connection_mongo.MongoConnection",
        "big_query": "looqbox.database.objects.connection_big_query.BigQueryConnection"
    }
