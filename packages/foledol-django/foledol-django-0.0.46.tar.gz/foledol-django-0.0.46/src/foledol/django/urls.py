...
urlpatterns = [
    ...
    url(r'form_templates', form_templates.form_template_list, name='form_templates'),
    url(r'form_template_create/', form_template.form_template_create, name='form_template_create'),
    url(r'form_template_update/(?P<pk>\d+)', form_template.form_template_update, name='form_template_update'),
    url(r'form_template_delete/(?P<pk>\d+)', form_template.form_template_delete, name='form_template_delete'),

    url(r'form_template_items', form_template_items.form_template_item_list, name='form_template_items'),
    url(r'form_template_item_create/', form_template_item.form_template_item_create, name='form_template_item_create'),
    url(r'form_template_item_update/(?P<pk>\d+)', form_template_item.form_template_item_update, name='form_template_item_update'),
    url(r'form_template_item_delete/(?P<pk>\d+)', form_template_item.form_template_item_delete, name='form_template_item_delete'),
]
