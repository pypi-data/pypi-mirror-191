...
def prepare_toolbox(wg: WorkGraph, contractors: List[Contractor],
...
def init_worker(fitness_constructor, genetic_args: tuple):  # serialized):
    ...
    toolbox = prepare_toolbox(*genetic_args)
    # construct fitness
