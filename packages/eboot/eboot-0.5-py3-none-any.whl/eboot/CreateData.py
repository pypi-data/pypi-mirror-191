...
def Create(option):
    ...
    if not os.path.isfile(os.path.join(out_path, 'globals.xml')) and os.path.isfile(os.path.join(src_path, global_xml)):
        shutil.copyfile(os.path.join(src_path, global_xml),
                        os.path.join(out_path, 'globals.xml'))
    if not os.path.isfile(os.path.join(out_path, 'system.xml')) and os.path.isfile(os.path.join(src_path, system_xml)):
