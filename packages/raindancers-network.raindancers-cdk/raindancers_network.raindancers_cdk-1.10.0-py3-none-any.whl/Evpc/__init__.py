...
@jsii.data_type(
    jsii_type="raindancers-network.CidrType",
    jsii_struct_bases=[],
...
class CidrType:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CidrType.__init__)
            check_type(argname="argument cidr", value=cidr, expected_type=type_hints["cidr"])
            check_type(argname="argument description", value=description, expected_type=type_hints["description"])
        self._values: typing.Dict[str, typing.Any] = {
            "cidr": cidr,
...
class FQDNStatefulRule(
    ...
    def __init__(
        ...
        *,
        ...
        destination: typing.Union[builtins.str, "PrefixList"],
        dest_port: builtins.str,
        direction: Direction,
        protocol: "FWProtocol",
        source: typing.Union[builtins.str, "PrefixList"],
...
class PrefixList(
    ...
    def __init__(
        ...
        *,
        ...
        entries: typing.Sequence[typing.Union[CidrType, typing.Dict[str, typing.Any]]],
...
class ReferenceSets(
    metaclass=jsii.JSIIMeta,
    jsii_type="raindancers-network.ReferenceSets",
):
    '''
    :stability: experimental
    '''

    def __init__(self, *, prefixlists: typing.Sequence[PrefixList]) -> None:
        '''
        :param prefixlists: 

        :stability: experimental
        '''
        props = ReferenceSetsProps(prefixlists=prefixlists)

        jsii.create(self.__class__, self, [props])

    @builtins.property
    @jsii.member(jsii_name="ipSetReference")
    def ip_set_reference(self) -> typing.List[PrefixListSetInterface]:
        '''
        :stability: experimental
        '''
        return typing.cast(typing.List[PrefixListSetInterface], jsii.get(self, "ipSetReference"))


@jsii.data_type(
    jsii_type="raindancers-network.ReferenceSetsProps",
    jsii_struct_bases=[],
    name_mapping={"prefixlists": "prefixlists"},
)
class ReferenceSetsProps:
    def __init__(self, *, prefixlists: typing.Sequence[PrefixList]) -> None:
        '''
        :param prefixlists: 
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ReferenceSetsProps.__init__)
            check_type(argname="argument prefixlists", value=prefixlists, expected_type=type_hints["prefixlists"])
        self._values: typing.Dict[str, typing.Any] = {
            "prefixlists": prefixlists,
        }

    @builtins.property
    def prefixlists(self) -> typing.List[PrefixList]:
        '''
        :stability: experimental
        '''
        result = self._values.get("prefixlists")
        assert result is not None, "Required property 'prefixlists' is missing"
        return typing.cast(typing.List[PrefixList], result)
    ...
    def __repr__(self) -> str:
        return "ReferenceSetsProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class SuricataRuleGroup(
    ...
    def __init__(
        ...
        *,
        ...
        rules_database: StatefulRuleDatabase,
        suricata_rules: typing.Sequence[FQDNStatefulRule],
        description: typing.Optional[builtins.str] = None,
        reference_sets: typing.Optional[ReferenceSets] = None,
    ) -> None:
        '''
        :param scope: -
        :param id: -
...
class SuricataRuleGroupProps:
    ...
    @builtins.property
    def suricata_rules(self) -> typing.List[FQDNStatefulRule]:
        '''
        :stability: experimental
        '''
        result = self._values.get("suricata_rules")
        assert result is not None, "Required property 'suricata_rules' is missing"
        return typing.cast(typing.List[FQDNStatefulRule], result)
    ...
    @builtins.property
    def reference_sets(self) -> typing.Optional[ReferenceSets]:
        '''
        :stability: experimental
        '''
        result = self._values.get("reference_sets")
        return typing.cast(typing.Optional[ReferenceSets], result)
...
class SuricataRuleProps:
    ...
    @builtins.property
    def destination(self) -> typing.Union[builtins.str, PrefixList]:
        '''
        :stability: experimental
        '''
        result = self._values.get("destination")
        assert result is not None, "Required property 'destination' is missing"
        return typing.cast(typing.Union[builtins.str, PrefixList], result)
    ...
    @builtins.property
    def source(self) -> typing.Union[builtins.str, PrefixList]:
        '''
        :stability: experimental
        '''
