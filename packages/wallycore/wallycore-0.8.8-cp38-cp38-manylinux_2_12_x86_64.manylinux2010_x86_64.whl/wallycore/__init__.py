...
WALLY_MINISCRIPT_WITNESS_SCRIPT = _wallycore.WALLY_MINISCRIPT_WITNESS_SCRIPT
...
def descriptor_to_script_get_maximum_length(descriptor, flags):
    return _wallycore.descriptor_to_script_get_maximum_length(descriptor, flags)
