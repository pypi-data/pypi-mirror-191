...
setup(
    ...
    #Ahora vendria el comando, para subir los paquete que esten en sdist
    #python -m twine upload -r testpypi dist/*
    #diciendole de python twine upload de subir in en -r que correnponde al repositorio todo los paquetes que esten en dist/*
)