...
from mxpit.Soundcls.macls.data_utils.augmentor.volume_perturb import VolumePerturbAugmentor
from mxpit.Soundcls.macls.data_utils.augmentor.shift_perturb import ShiftPerturbAugmentor
from mxpit.Soundcls.macls.data_utils.augmentor.speed_perturb import SpeedPerturbAugmentor
from mxpit.Soundcls.macls.data_utils.augmentor.noise_perturb import NoisePerturbAugmentor
from mxpit.Soundcls.macls.data_utils.augmentor.spec_augment import SpecAugmentor
from mxpit.Soundcls.macls.data_utils.augmentor.spec_sub import SpecSubAugmentor
from mxpit.Soundcls.macls.data_utils.augmentor.resample import ResampleAugmentor
from mxpit.Soundcls.macls.utils.logger import setup_logger
...
class AugmentationPipeline(object):
    ...
    def _parse_pipeline_from(self, config_json, aug_type):
        ...
        try:
            configs = []
            configs_temp = [{"type": "noise","aug_type": "audio","params": {
                        "min_snr_dB": 10,
                        "max_snr_dB": 50,
                        "repetition": 2,
