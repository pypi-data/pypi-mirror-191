...
def Edit_Controls_Page(self_class, built_in_widgets, its_new=True, number_on_list=0, class_type=None):
    ...
    #? if the control support sub-controls/sub-content
    if "sub_controls_support" in GET_CONTROL_EDIT_CONTROLERS:
        self_class.widgets_page.clean()
        Widgets_Page(self_class.widgets_page, built_in_widgets, {}, self_class.ewp, self_class, True, arrangement_set)
