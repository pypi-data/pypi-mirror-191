...
def create_redshift_systems(
    ...
    redshift_systems = [
        System(
            ...
            description=f"M3LD Sandbox Generated Description for Redshift Cluster: {cluster['ClusterIdentifier']}",
...
def create_rds_systems(
    ...
    rds_cluster_systems = [
        System(
            ...
            description=f"M3LD Sandbox Generated Description for RDS Cluster: {cluster['DBClusterIdentifier']}",
    ...
    rds_instances_systems = [
        System(
            ...
            description=f"M3LD Sandbox Generated Description for RDS Instance: {instance['DBInstanceIdentifier']}",
...
def create_tagging_dynamodb_system(
    ...
    if resource_name.startswith("table/"):
        ...
        system = System(
            ...
            name=table_name,
            description=f"M3LD Sandbox Generated Description for DynamoDb table: {table_name}",
...
def create_tagging_s3_system(
    ...
    system = System(
        ...
        name=bucket_name,
        description=f"M3LD Sandbox Generated Description for S3 bucket: {bucket_name}",
