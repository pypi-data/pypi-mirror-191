...
from cortex_core._ethics_checks import EthicsManager, EthicsTypeEnum
from cortex_core._drift_checks import DriftManager, DriftTypeEnum


class Model(pyfunc.PythonModel):
    """
    Base class for machine learning models. Not used directly.
    """


    def __init__(self, params, model_id, api_url, headers):
        self.params = params
