...
class FCOSReidHeadFocalSubTriQueue3PRW(AnchorFreeHeadReid):
    ...
    def __init__(self,
                 ...
                 label_norm=False,  ####
                 unlabel_full=False,  # ÊÇ·ñÓÃ256dÆ¥Åä
                 unlabel_weight=10,  ####
                 temperature=10,  ####
                 is_test=False,
                 loss_oim_reduction='mean',
                 **kwargs):
    ...
    def loss(self,
        ...
        if num_pos > 0:
            ...
            unlabeled_matching_scores *= self.unlabel_weight
