...
class FPNDcnLconv3_Attribute(nn.Module):
    ...
    def __init__(self,
        ...
        super(FPNDcnLconv3_Attribute, self).__init__()
        ...
        bbox_roi_extractor = dict(
            ...
            roi_layer=dict(type="RoIAlign", out_size=self.roi_align_outsize, sample_num=0),
            out_channels=roi_outchannels,
            aggregation='concat',
    ...
    @auto_fp16()
    def forward(self, inputs, gt_bboxes=None):
        """Forward function."""
        # pdb.set_trace()
        ...
        #outs len=4,前3个shape=[bbox_num, 256*3,14,14],[bbox_num, 256*2,14,14],[bbox_num, 256*1,14,14],
        # 第4个是[bbox_num, 2048,14,14]
