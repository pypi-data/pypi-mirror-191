...
class SingleTwoStageDetectorNAEContrastDomain(BaseContrastDetector):
    ...
    def __init__(self,
                 ...
                 pretrained=None):
        super(SingleTwoStageDetectorNAEContrastDomain, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        ...
        Args:
            pretrained (str, optional): Path to pre-trained weights.
                Defaults to None.
        """
        super(SingleTwoStageDetectorNAEContrastDomain, self).init_weights(pretrained)
        # pdb.set_trace()
        ...
        if self.with_rpn and len(det_data_id) > 0:
            ...
            if self.det_num_domain>1:
                ...
                if self.only_detection_imglevel_da:
                    ...
                    loss_img_align = self.da_heads(xb_det, gt_domain_ids_det,instance_level_feats_det,
                                                   # instance_level_feats_pids_det
                                                   )
