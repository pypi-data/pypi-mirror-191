...
def pass_int_or_float(argument):
    """
...
class Calculator:
    ...
    def plus(self, argument: float):
        ...
        self.memory += pass_int_or_float(argument)
    ...
    def multiply(self, argument: float):
        ...
        self.memory = self.memory * pass_int_or_float(argument)

    def divide(self, argument: float):
        # Validates the argument before the memory is divided by it
        if isclose(0, pass_int_or_float(argument)):
